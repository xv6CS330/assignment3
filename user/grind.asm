...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      9e:	34e50513          	addi	a0,a0,846 # 13e8 <malloc+0xe8>
      a2:	00001097          	auipc	ra,0x1
      a6:	e2c080e7          	jalr	-468(ra) # ece <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	33e50513          	addi	a0,a0,830 # 13e8 <malloc+0xe8>
      b2:	00001097          	auipc	ra,0x1
      b6:	e24080e7          	jalr	-476(ra) # ed6 <chdir>
      ba:	cd11                	beqz	a0,d6 <go+0x5e>
    printf("grind: chdir grindir failed\n");
      bc:	00001517          	auipc	a0,0x1
      c0:	33450513          	addi	a0,a0,820 # 13f0 <malloc+0xf0>
      c4:	00001097          	auipc	ra,0x1
      c8:	17e080e7          	jalr	382(ra) # 1242 <printf>
    exit(1);
      cc:	4505                	li	a0,1
  ...
  chdir("/");
      ...
      da:	33a50513          	addi	a0,a0,826 # 1410 <malloc+0x110>
  ...
  while(1){
    ...
    if((iters % 500) == 0)
      ...
      ea:	33a98993          	addi	s3,s3,826 # 1420 <malloc+0x120>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001997          	auipc	s3,0x1
      f4:	32898993          	addi	s3,s3,808 # 1418 <malloc+0x118>
    iters++;
      f8:	4485                	li	s1,1
  int fd = -1;
      fa:	597d                	li	s2,-1
     ...
     100:	604a0a13          	addi	s4,s4,1540 # 1700 <buf.1266>
     104:	a825                	j	13c <go+0xc4>
      close(open("grindir/../a", O_CREATE|O_RDWR));
     106:	20200593          	li	a1,514
     10a:	00001517          	auipc	a0,0x1
     10e:	31e50513          	addi	a0,a0,798 # 1428 <malloc+0x128>
    ...
    if(what == 1){
     ...
     2a2:	40258593          	addi	a1,a1,1026 # 16a0 <malloc+0x3a0>
     ...
     2c6:	3e650513          	addi	a0,a0,998 # 16a8 <malloc+0x3a8>
     2ca:	00001097          	auipc	ra,0x1
     2ce:	f78080e7          	jalr	-136(ra) # 1242 <printf>
        exit(1);
     2d2:	4505                	li	a0,1
     ...
     2e4:	15850513          	addi	a0,a0,344 # 1438 <malloc+0x138>
     ...
     36c:	0f050513          	addi	a0,a0,240 # 1458 <malloc+0x158>
     ...
     38e:	0de50513          	addi	a0,a0,222 # 1468 <malloc+0x168>
     ...
     3c6:	06650513          	addi	a0,a0,102 # 1428 <malloc+0x128>
     3ca:	00001097          	auipc	ra,0x1
     3ce:	b04080e7          	jalr	-1276(ra) # ece <mkdir>
      close(open("a/../a/./a", O_CREATE|O_RDWR));
     3d2:	20200593          	li	a1,514
     3d6:	00001517          	auipc	a0,0x1
     3da:	0aa50513          	addi	a0,a0,170 # 1480 <malloc+0x180>
     ...
     4b8:	03450513          	addi	a0,a0,52 # 14e8 <malloc+0x1e8>
     4bc:	00001097          	auipc	ra,0x1
     4c0:	d86080e7          	jalr	-634(ra) # 1242 <printf>
        exit(1);
     4c4:	4505                	li	a0,1
     ...
     506:	fe650513          	addi	a0,a0,-26 # 14e8 <malloc+0x1e8>
     50a:	00001097          	auipc	ra,0x1
     50e:	d38080e7          	jalr	-712(ra) # 1242 <printf>
        exit(1);
     512:	4505                	li	a0,1
     ...
     518:	952080e7          	jalr	-1710(ra) # e66 <exit>
      sbrk(6011);
     51c:	6505                	lui	a0,0x1
     51e:	77b50513          	addi	a0,a0,1915 # 177b <buf.1266+0x7b>
     ...
     566:	f9e50513          	addi	a0,a0,-98 # 1500 <malloc+0x200>
     ...
     592:	f3a50513          	addi	a0,a0,-198 # 14c8 <malloc+0x1c8>
     ...
     5b4:	f3850513          	addi	a0,a0,-200 # 14e8 <malloc+0x1e8>
     5b8:	00001097          	auipc	ra,0x1
     5bc:	c8a080e7          	jalr	-886(ra) # 1242 <printf>
        exit(1);
     5c0:	4505                	li	a0,1
     ...
     5ce:	f4650513          	addi	a0,a0,-186 # 1510 <malloc+0x210>
     5d2:	00001097          	auipc	ra,0x1
     5d6:	c70080e7          	jalr	-912(ra) # 1242 <printf>
        exit(1);
     5da:	4505                	li	a0,1
     ...
     61c:	ed050513          	addi	a0,a0,-304 # 14e8 <malloc+0x1e8>
     620:	00001097          	auipc	ra,0x1
     624:	c22080e7          	jalr	-990(ra) # 1242 <printf>
        exit(1);
     628:	4505                	li	a0,1
     ...
     678:	eb450513          	addi	a0,a0,-332 # 1528 <malloc+0x228>
     67c:	00001097          	auipc	ra,0x1
     680:	bc6080e7          	jalr	-1082(ra) # 1242 <printf>
        exit(1);
     684:	4505                	li	a0,1
     ...
     6a4:	ea058593          	addi	a1,a1,-352 # 1540 <malloc+0x240>
     ...
     6e0:	e6c50513          	addi	a0,a0,-404 # 1548 <malloc+0x248>
     6e4:	00001097          	auipc	ra,0x1
     6e8:	b5e080e7          	jalr	-1186(ra) # 1242 <printf>
     6ec:	b7f9                	j	6ba <go+0x642>
          printf("grind: pipe read failed\n");
     6ee:	00001517          	auipc	a0,0x1
     6f2:	e7a50513          	addi	a0,a0,-390 # 1568 <malloc+0x268>
     6f6:	00001097          	auipc	ra,0x1
     6fa:	b4c080e7          	jalr	-1204(ra) # 1242 <printf>
     6fe:	bfd1                	j	6d2 <go+0x65a>
        printf("grind: fork failed\n");
     700:	00001517          	auipc	a0,0x1
     704:	de850513          	addi	a0,a0,-536 # 14e8 <malloc+0x1e8>
     708:	00001097          	auipc	ra,0x1
     70c:	b3a080e7          	jalr	-1222(ra) # 1242 <printf>
        exit(1);
     710:	4505                	li	a0,1
     ...
     7a6:	d4650513          	addi	a0,a0,-698 # 14e8 <malloc+0x1e8>
     7aa:	00001097          	auipc	ra,0x1
     7ae:	a98080e7          	jalr	-1384(ra) # 1242 <printf>
        exit(1);
     7b2:	4505                	li	a0,1
     ...
     7c0:	dcc50513          	addi	a0,a0,-564 # 1588 <malloc+0x288>
     7c4:	00000097          	auipc	ra,0x0
     7c8:	6f2080e7          	jalr	1778(ra) # eb6 <unlink>
      int fd1 = open("c", O_CREATE|O_RDWR);
     7cc:	20200593          	li	a1,514
     7d0:	00001517          	auipc	a0,0x1
     7d4:	db850513          	addi	a0,a0,-584 # 1588 <malloc+0x288>
     ...
     7ec:	d5858593          	addi	a1,a1,-680 # 1540 <malloc+0x240>
     ...
     832:	d5a50513          	addi	a0,a0,-678 # 1588 <malloc+0x288>
     836:	00000097          	auipc	ra,0x0
     83a:	680080e7          	jalr	1664(ra) # eb6 <unlink>
     83e:	b0d5                	j	122 <go+0xaa>
        printf("grind: create c failed\n");
     840:	00001517          	auipc	a0,0x1
     844:	d5050513          	addi	a0,a0,-688 # 1590 <malloc+0x290>
     848:	00001097          	auipc	ra,0x1
     84c:	9fa080e7          	jalr	-1542(ra) # 1242 <printf>
        exit(1);
     850:	4505                	li	a0,1
     ...
     85e:	d4e50513          	addi	a0,a0,-690 # 15a8 <malloc+0x2a8>
     862:	00001097          	auipc	ra,0x1
     866:	9e0080e7          	jalr	-1568(ra) # 1242 <printf>
        exit(1);
     86a:	4505                	li	a0,1
     ...
     878:	d4c50513          	addi	a0,a0,-692 # 15c0 <malloc+0x2c0>
     87c:	00001097          	auipc	ra,0x1
     880:	9c6080e7          	jalr	-1594(ra) # 1242 <printf>
        exit(1);
     884:	4505                	li	a0,1
     ...
     894:	d4850513          	addi	a0,a0,-696 # 15d8 <malloc+0x2d8>
     898:	00001097          	auipc	ra,0x1
     89c:	9aa080e7          	jalr	-1622(ra) # 1242 <printf>
        exit(1);
     8a0:	4505                	li	a0,1
     ...
     8ae:	d5650513          	addi	a0,a0,-682 # 1600 <malloc+0x300>
     8b2:	00001097          	auipc	ra,0x1
     8b6:	990080e7          	jalr	-1648(ra) # 1242 <printf>
        exit(1);
     8ba:	4505                	li	a0,1
     ...
     8c8:	c6458593          	addi	a1,a1,-924 # 1528 <malloc+0x228>
     8cc:	4509                	li	a0,2
     8ce:	00001097          	auipc	ra,0x1
     8d2:	946080e7          	jalr	-1722(ra) # 1214 <fprintf>
        exit(1);
     8d6:	4505                	li	a0,1
     ...
     8e4:	c4858593          	addi	a1,a1,-952 # 1528 <malloc+0x228>
     8e8:	4509                	li	a0,2
     8ea:	00001097          	auipc	ra,0x1
     8ee:	92a080e7          	jalr	-1750(ra) # 1214 <fprintf>
        exit(1);
     8f2:	4505                	li	a0,1
     ...
     940:	cec58593          	addi	a1,a1,-788 # 1628 <malloc+0x328>
     944:	4509                	li	a0,2
     946:	00001097          	auipc	ra,0x1
     94a:	8ce080e7          	jalr	-1842(ra) # 1214 <fprintf>
          exit(1);
     94e:	4505                	li	a0,1
     ...
     9b4:	b3858593          	addi	a1,a1,-1224 # 14e8 <malloc+0x1e8>
     9b8:	4509                	li	a0,2
     9ba:	00001097          	auipc	ra,0x1
     9be:	85a080e7          	jalr	-1958(ra) # 1214 <fprintf>
        exit(3);
     9c2:	450d                	li	a0,3
     ...
     a00:	c2c58593          	addi	a1,a1,-980 # 1628 <malloc+0x328>
     a04:	4509                	li	a0,2
     a06:	00001097          	auipc	ra,0x1
     a0a:	80e080e7          	jalr	-2034(ra) # 1214 <fprintf>
          exit(4);
     a0e:	4511                	li	a0,4
     ...
     a44:	be858593          	addi	a1,a1,-1048 # 1628 <malloc+0x328>
     a48:	4509                	li	a0,2
     a4a:	00000097          	auipc	ra,0x0
     a4e:	7ca080e7          	jalr	1994(ra) # 1214 <fprintf>
          exit(5);
     a52:	4515                	li	a0,5
     ...
     a6c:	c1078793          	addi	a5,a5,-1008 # 1678 <malloc+0x378>
     a70:	faf43423          	sd	a5,-88(s0)
     a74:	fa043823          	sd	zero,-80(s0)
        exec("/cat", args);
     a78:	fa840593          	addi	a1,s0,-88
     a7c:	00001517          	auipc	a0,0x1
     a80:	c0450513          	addi	a0,a0,-1020 # 1680 <malloc+0x380>
     a84:	00000097          	auipc	ra,0x0
     a88:	41a080e7          	jalr	1050(ra) # e9e <exec>
        fprintf(2, "grind: cat: not found\n");
     a8c:	00001597          	auipc	a1,0x1
     a90:	bfc58593          	addi	a1,a1,-1028 # 1688 <malloc+0x388>
     a94:	4509                	li	a0,2
     a96:	00000097          	auipc	ra,0x0
     a9a:	77e080e7          	jalr	1918(ra) # 1214 <fprintf>
        exit(6);
     a9e:	4519                	li	a0,6
     ...
     aac:	a4058593          	addi	a1,a1,-1472 # 14e8 <malloc+0x1e8>
     ab0:	4509                	li	a0,2
     ab2:	00000097          	auipc	ra,0x0
     ab6:	762080e7          	jalr	1890(ra) # 1214 <fprintf>
        exit(7);
     aba:	451d                	li	a0,7
...
iter()
{
  ...
  unlink("a");
     ...
     ad4:	9f850513          	addi	a0,a0,-1544 # 14c8 <malloc+0x1c8>
     ad8:	00000097          	auipc	ra,0x0
     adc:	3de080e7          	jalr	990(ra) # eb6 <unlink>
  unlink("b");
     ae0:	00001517          	auipc	a0,0x1
     ae4:	99850513          	addi	a0,a0,-1640 # 1478 <malloc+0x178>
  ...
  if(pid1 == 0){
    ...
    rand_next = 31;
     ...
     b06:	bef73723          	sd	a5,-1042(a4) # 16f0 <rand_next>
    go(0);
     b0a:	4501                	li	a0,0
    ...
    printf("grind: fork failed\n");
     ...
     b18:	9d450513          	addi	a0,a0,-1580 # 14e8 <malloc+0x1e8>
     b1c:	00000097          	auipc	ra,0x0
     b20:	726080e7          	jalr	1830(ra) # 1242 <printf>
    exit(1);
     b24:	4505                	li	a0,1
  ...
  if(pid2 == 0){
    ...
    rand_next = 7177;
     b3e:	6789                	lui	a5,0x2
     b40:	c0978793          	addi	a5,a5,-1015 # 1c09 <__BSS_END__+0x111>
     b44:	00001717          	auipc	a4,0x1
     b48:	baf73623          	sd	a5,-1108(a4) # 16f0 <rand_next>
    go(1);
     b4c:	4505                	li	a0,1
    ...
    printf("grind: fork failed\n");
     ...
     b5a:	99250513          	addi	a0,a0,-1646 # 14e8 <malloc+0x1e8>
     b5e:	00000097          	auipc	ra,0x0
     b62:	6e4080e7          	jalr	1764(ra) # 1242 <printf>
    exit(1);
     b66:	4505                	li	a0,1
...
0000000000000f4e <barrier_alloc>:
...
putc(int fd, char c)
{
     ...
     f72:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
     f76:	4605                	li	a2,1
     f78:	fef40593          	addi	a1,s0,-17
     f7c:	00000097          	auipc	ra,0x0
     f80:	f0a080e7          	jalr	-246(ra) # e86 <write>
}
...
0000000000000f8c <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
     f8c:	7139                	addi	sp,sp,-64
     f8e:	fc06                	sd	ra,56(sp)
     f90:	f822                	sd	s0,48(sp)
     f92:	f426                	sd	s1,40(sp)
  ...
  neg = 0;
  if(sgn && xx < 0){
     f9c:	c299                	beqz	a3,fa2 <printint+0x16>
     f9e:	0805c863          	bltz	a1,102e <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
     fa2:	2581                	sext.w	a1,a1
  neg = 0;
     fa4:	4881                	li	a7,0
     fa6:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
     fac:	2601                	sext.w	a2,a2
     fae:	00000517          	auipc	a0,0x0
     fb2:	72a50513          	addi	a0,a0,1834 # 16d8 <digits>
     fb6:	883a                	mv	a6,a4
     fb8:	2705                	addiw	a4,a4,1
     fba:	02c5f7bb          	remuw	a5,a1,a2
     fbe:	1782                	slli	a5,a5,0x20
     fc0:	9381                	srli	a5,a5,0x20
     fc2:	97aa                	add	a5,a5,a0
     fc4:	0007c783          	lbu	a5,0(a5)
     fc8:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
     fcc:	0005879b          	sext.w	a5,a1
     fd0:	02c5d5bb          	divuw	a1,a1,a2
     fd4:	0685                	addi	a3,a3,1
     fd6:	fec7f0e3          	bgeu	a5,a2,fb6 <printint+0x2a>
  if(neg)
     fda:	00088b63          	beqz	a7,ff0 <printint+0x64>
    buf[i++] = '-';
     fde:	fd040793          	addi	a5,s0,-48
     fe2:	973e                	add	a4,a4,a5
     fe4:	02d00793          	li	a5,45
     fe8:	fef70823          	sb	a5,-16(a4)
     fec:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
     ff0:	02e05863          	blez	a4,1020 <printint+0x94>
     ff4:	fc040793          	addi	a5,s0,-64
     ff8:	00e78933          	add	s2,a5,a4
     ffc:	fff78993          	addi	s3,a5,-1
    1000:	99ba                	add	s3,s3,a4
    1002:	377d                	addiw	a4,a4,-1
    1004:	1702                	slli	a4,a4,0x20
    1006:	9301                	srli	a4,a4,0x20
    1008:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    100c:	fff94583          	lbu	a1,-1(s2)
    1010:	8526                	mv	a0,s1
    1012:	00000097          	auipc	ra,0x0
    1016:	f58080e7          	jalr	-168(ra) # f6a <putc>
  while(--i >= 0)
    101a:	197d                	addi	s2,s2,-1
    101c:	ff3918e3          	bne	s2,s3,100c <printint+0x80>
}
    ...
    102c:	8082                	ret
    x = -xx;
    102e:	40b005bb          	negw	a1,a1
    neg = 1;
    1032:	4885                	li	a7,1
    x = -xx;
    1034:	bf8d                	j	fa6 <printint+0x1a>

0000000000001036 <vprintf>:
}
...
{
    1036:	7119                	addi	sp,sp,-128
    1038:	fc86                	sd	ra,120(sp)
    103a:	f8a2                	sd	s0,112(sp)
    103c:	f4a6                	sd	s1,104(sp)
    103e:	f0ca                	sd	s2,96(sp)
    1040:	ecce                	sd	s3,88(sp)
    1042:	e8d2                	sd	s4,80(sp)
    1044:	e4d6                	sd	s5,72(sp)
    1046:	e0da                	sd	s6,64(sp)
    1048:	fc5e                	sd	s7,56(sp)
    104a:	f862                	sd	s8,48(sp)
    104c:	f466                	sd	s9,40(sp)
    104e:	f06a                	sd	s10,32(sp)
    1050:	ec6e                	sd	s11,24(sp)
  ...
  for(i = 0; fmt[i]; i++){
    ...
    1058:	18090f63          	beqz	s2,11f6 <vprintf+0x1c0>
    105c:	8aaa                	mv	s5,a0
    105e:	8b32                	mv	s6,a2
    1060:	00158493          	addi	s1,a1,1
  state = 0;
    1064:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    1066:	02500a13          	li	s4,37
      if(c == 'd'){
    106a:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    106e:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    1072:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    1076:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    107a:	00000b97          	auipc	s7,0x0
    107e:	65eb8b93          	addi	s7,s7,1630 # 16d8 <digits>
    1082:	a839                	j	10a0 <vprintf+0x6a>
        putc(fd, c);
    1084:	85ca                	mv	a1,s2
    1086:	8556                	mv	a0,s5
    1088:	00000097          	auipc	ra,0x0
    108c:	ee2080e7          	jalr	-286(ra) # f6a <putc>
    1090:	a019                	j	1096 <vprintf+0x60>
    } else if(state == '%'){
    1092:	01498f63          	beq	s3,s4,10b0 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    1096:	0485                	addi	s1,s1,1
    1098:	fff4c903          	lbu	s2,-1(s1)
    109c:	14090d63          	beqz	s2,11f6 <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    10a0:	0009079b          	sext.w	a5,s2
    if(state == 0){
    10a4:	fe0997e3          	bnez	s3,1092 <vprintf+0x5c>
      if(c == '%'){
    10a8:	fd479ee3          	bne	a5,s4,1084 <vprintf+0x4e>
        state = '%';
    10ac:	89be                	mv	s3,a5
    10ae:	b7e5                	j	1096 <vprintf+0x60>
      if(c == 'd'){
    10b0:	05878063          	beq	a5,s8,10f0 <vprintf+0xba>
      } else if(c == 'l') {
    10b4:	05978c63          	beq	a5,s9,110c <vprintf+0xd6>
      } else if(c == 'x') {
    10b8:	07a78863          	beq	a5,s10,1128 <vprintf+0xf2>
      } else if(c == 'p') {
    10bc:	09b78463          	beq	a5,s11,1144 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    10c0:	07300713          	li	a4,115
    10c4:	0ce78663          	beq	a5,a4,1190 <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    10c8:	06300713          	li	a4,99
    10cc:	0ee78e63          	beq	a5,a4,11c8 <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    10d0:	11478863          	beq	a5,s4,11e0 <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    10dc:	e92080e7          	jalr	-366(ra) # f6a <putc>
        putc(fd, c);
    10e0:	85ca                	mv	a1,s2
    10e2:	8556                	mv	a0,s5
    10e4:	00000097          	auipc	ra,0x0
    10e8:	e86080e7          	jalr	-378(ra) # f6a <putc>
      }
      state = 0;
    10ec:	4981                	li	s3,0
    10ee:	b765                	j	1096 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    ...
    1102:	e8e080e7          	jalr	-370(ra) # f8c <printint>
    1106:	8b4a                	mv	s6,s2
      state = 0;
    1108:	4981                	li	s3,0
    110a:	b771                	j	1096 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    111e:	e72080e7          	jalr	-398(ra) # f8c <printint>
    1122:	8b4a                	mv	s6,s2
      state = 0;
    1124:	4981                	li	s3,0
    1126:	bf85                	j	1096 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    ...
    113a:	e56080e7          	jalr	-426(ra) # f8c <printint>
    113e:	8b4a                	mv	s6,s2
      state = 0;
    1140:	4981                	li	s3,0
    1142:	bf91                	j	1096 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    1144:	008b0793          	addi	a5,s6,8
    1148:	f8f43423          	sd	a5,-120(s0)
    114c:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    1150:	03000593          	li	a1,48
    1154:	8556                	mv	a0,s5
    1156:	00000097          	auipc	ra,0x0
    115a:	e14080e7          	jalr	-492(ra) # f6a <putc>
  putc(fd, 'x');
    115e:	85ea                	mv	a1,s10
    1160:	8556                	mv	a0,s5
    1162:	00000097          	auipc	ra,0x0
    1166:	e08080e7          	jalr	-504(ra) # f6a <putc>
    116a:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    116c:	03c9d793          	srli	a5,s3,0x3c
    1170:	97de                	add	a5,a5,s7
    1172:	0007c583          	lbu	a1,0(a5)
    1176:	8556                	mv	a0,s5
    1178:	00000097          	auipc	ra,0x0
    117c:	df2080e7          	jalr	-526(ra) # f6a <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    1180:	0992                	slli	s3,s3,0x4
    1182:	397d                	addiw	s2,s2,-1
    1184:	fe0914e3          	bnez	s2,116c <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    1188:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    118c:	4981                	li	s3,0
    118e:	b721                	j	1096 <vprintf+0x60>
        s = va_arg(ap, char*);
    1190:	008b0993          	addi	s3,s6,8
    1194:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    1198:	02090163          	beqz	s2,11ba <vprintf+0x184>
        while(*s != 0){
    119c:	00094583          	lbu	a1,0(s2)
    11a0:	c9a1                	beqz	a1,11f0 <vprintf+0x1ba>
          putc(fd, *s);
    11a2:	8556                	mv	a0,s5
    11a4:	00000097          	auipc	ra,0x0
    11a8:	dc6080e7          	jalr	-570(ra) # f6a <putc>
          s++;
    11ac:	0905                	addi	s2,s2,1
        while(*s != 0){
    11ae:	00094583          	lbu	a1,0(s2)
    11b2:	f9e5                	bnez	a1,11a2 <vprintf+0x16c>
        s = va_arg(ap, char*);
    11b4:	8b4e                	mv	s6,s3
      state = 0;
    11b6:	4981                	li	s3,0
    11b8:	bdf9                	j	1096 <vprintf+0x60>
          s = "(null)";
    11ba:	00000917          	auipc	s2,0x0
    11be:	51690913          	addi	s2,s2,1302 # 16d0 <malloc+0x3d0>
        while(*s != 0){
    11c2:	02800593          	li	a1,40
    11c6:	bff1                	j	11a2 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    11c8:	008b0913          	addi	s2,s6,8
    11cc:	000b4583          	lbu	a1,0(s6)
    11d0:	8556                	mv	a0,s5
    11d2:	00000097          	auipc	ra,0x0
    11d6:	d98080e7          	jalr	-616(ra) # f6a <putc>
    11da:	8b4a                	mv	s6,s2
      state = 0;
    11dc:	4981                	li	s3,0
    11de:	bd65                	j	1096 <vprintf+0x60>
        putc(fd, c);
    11e0:	85d2                	mv	a1,s4
    11e2:	8556                	mv	a0,s5
    11e4:	00000097          	auipc	ra,0x0
    11e8:	d86080e7          	jalr	-634(ra) # f6a <putc>
      state = 0;
    11ec:	4981                	li	s3,0
    11ee:	b565                	j	1096 <vprintf+0x60>
        s = va_arg(ap, char*);
    11f0:	8b4e                	mv	s6,s3
      state = 0;
    11f2:	4981                	li	s3,0
    11f4:	b54d                	j	1096 <vprintf+0x60>
    }
  }
}
    11f6:	70e6                	ld	ra,120(sp)
    11f8:	7446                	ld	s0,112(sp)
    11fa:	74a6                	ld	s1,104(sp)
    11fc:	7906                	ld	s2,96(sp)
    11fe:	69e6                	ld	s3,88(sp)
    1200:	6a46                	ld	s4,80(sp)
    1202:	6aa6                	ld	s5,72(sp)
    1204:	6b06                	ld	s6,64(sp)
    1206:	7be2                	ld	s7,56(sp)
    1208:	7c42                	ld	s8,48(sp)
    120a:	7ca2                	ld	s9,40(sp)
    120c:	7d02                	ld	s10,32(sp)
    120e:	6de2                	ld	s11,24(sp)
    1210:	6109                	addi	sp,sp,128
    1212:	8082                	ret
...
fprintf(int fd, const char *fmt, ...)
{
  ...
  vprintf(fd, fmt, ap);
    ...
    1236:	e04080e7          	jalr	-508(ra) # 1036 <vprintf>
}
...
printf(const char *fmt, ...)
{
  ...
  vprintf(1, fmt, ap);
    ...
    126c:	dce080e7          	jalr	-562(ra) # 1036 <vprintf>
}
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    1286:	4767b783          	ld	a5,1142(a5) # 16f8 <freep>
    128a:	a805                	j	12ba <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    128c:	4618                	lw	a4,8(a2)
    128e:	9db9                	addw	a1,a1,a4
    1290:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    1294:	6398                	ld	a4,0(a5)
    1296:	6318                	ld	a4,0(a4)
    1298:	fee53823          	sd	a4,-16(a0)
    129c:	a091                	j	12e0 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    129e:	ff852703          	lw	a4,-8(a0)
    12a2:	9e39                	addw	a2,a2,a4
    12a4:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    12a6:	ff053703          	ld	a4,-16(a0)
    12aa:	e398                	sd	a4,0(a5)
    12ac:	a099                	j	12f2 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    12ae:	6398                	ld	a4,0(a5)
    12b0:	00e7e463          	bltu	a5,a4,12b8 <free+0x40>
    12b4:	00e6ea63          	bltu	a3,a4,12c8 <free+0x50>
{
    12b8:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    12ba:	fed7fae3          	bgeu	a5,a3,12ae <free+0x36>
    12be:	6398                	ld	a4,0(a5)
    12c0:	00e6e463          	bltu	a3,a4,12c8 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    12c4:	fee7eae3          	bltu	a5,a4,12b8 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    12c8:	ff852583          	lw	a1,-8(a0)
    12cc:	6390                	ld	a2,0(a5)
    12ce:	02059713          	slli	a4,a1,0x20
    12d2:	9301                	srli	a4,a4,0x20
    12d4:	0712                	slli	a4,a4,0x4
    12d6:	9736                	add	a4,a4,a3
    12d8:	fae60ae3          	beq	a2,a4,128c <free+0x14>
    bp->s.ptr = p->s.ptr;
    12dc:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    12e0:	4790                	lw	a2,8(a5)
    12e2:	02061713          	slli	a4,a2,0x20
    12e6:	9301                	srli	a4,a4,0x20
    12e8:	0712                	slli	a4,a4,0x4
    12ea:	973e                	add	a4,a4,a5
    12ec:	fae689e3          	beq	a3,a4,129e <free+0x26>
  } else
    p->s.ptr = bp;
    12f0:	e394                	sd	a3,0(a5)
  freep = p;
    12f2:	00000717          	auipc	a4,0x0
    12f6:	40f73323          	sd	a5,1030(a4) # 16f8 <freep>
}
...
malloc(uint nbytes)
{
    1300:	7139                	addi	sp,sp,-64
    1302:	fc06                	sd	ra,56(sp)
    1304:	f822                	sd	s0,48(sp)
    1306:	f426                	sd	s1,40(sp)
    1308:	f04a                	sd	s2,32(sp)
    130a:	ec4e                	sd	s3,24(sp)
    130c:	e852                	sd	s4,16(sp)
    130e:	e456                	sd	s5,8(sp)
    1310:	e05a                	sd	s6,0(sp)
    1312:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1314:	02051493          	slli	s1,a0,0x20
    1318:	9081                	srli	s1,s1,0x20
    131a:	04bd                	addi	s1,s1,15
    131c:	8091                	srli	s1,s1,0x4
    131e:	0014899b          	addiw	s3,s1,1
    1322:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    1324:	00000517          	auipc	a0,0x0
    1328:	3d453503          	ld	a0,980(a0) # 16f8 <freep>
    132c:	c515                	beqz	a0,1358 <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1332:	02977f63          	bgeu	a4,s1,1370 <malloc+0x70>
    1336:	8a4e                	mv	s4,s3
    1338:	0009871b          	sext.w	a4,s3
    133c:	6685                	lui	a3,0x1
    133e:	00d77363          	bgeu	a4,a3,1344 <malloc+0x44>
    1342:	6a05                	lui	s4,0x1
    1344:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    134c:	00000917          	auipc	s2,0x0
    1350:	3ac90913          	addi	s2,s2,940 # 16f8 <freep>
  if(p == (char*)-1)
    1354:	5afd                	li	s5,-1
    1356:	a88d                	j	13c8 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    1358:	00000797          	auipc	a5,0x0
    135c:	79078793          	addi	a5,a5,1936 # 1ae8 <base>
    1360:	00000717          	auipc	a4,0x0
    1364:	38f73c23          	sd	a5,920(a4) # 16f8 <freep>
    1368:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    136a:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    136e:	b7e1                	j	1336 <malloc+0x36>
      if(p->s.size == nunits)
    1370:	02e48b63          	beq	s1,a4,13a6 <malloc+0xa6>
        p->s.size -= nunits;
    ...
    1382:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    1386:	00000717          	auipc	a4,0x0
    138a:	36a73923          	sd	a0,882(a4) # 16f8 <freep>
      return (void*)(p + 1);
    ...
    13aa:	bff1                	j	1386 <malloc+0x86>
  hp->s.size = nu;
    13ac:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    13b0:	0541                	addi	a0,a0,16
    13b2:	00000097          	auipc	ra,0x0
    13b6:	ec6080e7          	jalr	-314(ra) # 1278 <free>
  return freep;
    13ba:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    13be:	d971                	beqz	a0,1392 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    13c0:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    13c2:	4798                	lw	a4,8(a5)
    13c4:	fa9776e3          	bgeu	a4,s1,1370 <malloc+0x70>
    if(p == freep)
    13c8:	00093703          	ld	a4,0(s2)
    13cc:	853e                	mv	a0,a5
    13ce:	fef719e3          	bne	a4,a5,13c0 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    13d2:	8552                	mv	a0,s4
    13d4:	00000097          	auipc	ra,0x0
    13d8:	b1a080e7          	jalr	-1254(ra) # eee <sbrk>
  if(p == (char*)-1)
    13dc:	fd5518e3          	bne	a0,s5,13ac <malloc+0xac>
        return 0;
    13e0:	4501                	li	a0,0
    13e2:	bf45                	j	1392 <malloc+0x92>
