...
0000000000000388 <barrier_alloc>:
...
putc(int fd, char c)
{
 ...
 3ba:	f0a080e7          	jalr	-246(ra) # 2c0 <write>
}
...
free(void *ap)
{
 ...
 6c0:	1847b783          	ld	a5,388(a5) # 840 <freep>
 ...
 6ee:	00e6ea63          	bltu	a3,a4,702 <free+0x50>
{
 ...
 730:	10f73a23          	sd	a5,276(a4) # 840 <freep>
}
 734:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 762:	0e253503          	ld	a0,226(a0) # 840 <freep>
 ...
 78a:	0ba90913          	addi	s2,s2,186 # 840 <freep>
  if(p == (char*)-1)
 78e:	5afd                	li	s5,-1
 790:	a88d                	j	802 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 792:	00000797          	auipc	a5,0x0
 796:	0b678793          	addi	a5,a5,182 # 848 <base>
 79a:	00000717          	auipc	a4,0x0
 79e:	0af73323          	sd	a5,166(a4) # 840 <freep>
 7a2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7c4:	08a73023          	sd	a0,128(a4) # 840 <freep>
      return (void*)(p + 1);
 ...
 812:	b1a080e7          	jalr	-1254(ra) # 328 <sbrk>
  if(p == (char*)-1)
