...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	dc250513          	addi	a0,a0,-574 # 5e00 <malloc+0xec>
      46:	00006097          	auipc	ra,0x6
      4a:	c16080e7          	jalr	-1002(ra) # 5c5c <printf>
      exit(1);
      4e:	4505                	li	a0,1
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	71078793          	addi	a5,a5,1808 # 9768 <uninit>
      60:	0000c697          	auipc	a3,0xc
      64:	e1868693          	addi	a3,a3,-488 # be78 <buf>
    if(uninit[i] != '\0'){
      ...
      74:	8082                	ret
{
      ...
      84:	da050513          	addi	a0,a0,-608 # 5e20 <malloc+0x10c>
      88:	00006097          	auipc	ra,0x6
      8c:	bd4080e7          	jalr	-1068(ra) # 5c5c <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	d9050513          	addi	a0,a0,-624 # 5e38 <malloc+0x124>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	d9250513          	addi	a0,a0,-622 # 5e58 <malloc+0x144>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	d5a50513          	addi	a0,a0,-678 # 5e40 <malloc+0x12c>
      ee:	00006097          	auipc	ra,0x6
      f2:	b6e080e7          	jalr	-1170(ra) # 5c5c <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	d6650513          	addi	a0,a0,-666 # 5e68 <malloc+0x154>
     10a:	00006097          	auipc	ra,0x6
     10e:	b52080e7          	jalr	-1198(ra) # 5c5c <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	d6450513          	addi	a0,a0,-668 # 5e90 <malloc+0x17c>
     134:	00005097          	auipc	ra,0x5
     138:	75e080e7          	jalr	1886(ra) # 5892 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	d5050513          	addi	a0,a0,-688 # 5e90 <malloc+0x17c>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	d4c58593          	addi	a1,a1,-692 # 5ea0 <malloc+0x18c>
     15c:	00005097          	auipc	ra,0x5
     160:	706080e7          	jalr	1798(ra) # 5862 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	d2850513          	addi	a0,a0,-728 # 5e90 <malloc+0x17c>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	d2c58593          	addi	a1,a1,-724 # 5ea8 <malloc+0x194>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	cfc50513          	addi	a0,a0,-772 # 5e90 <malloc+0x17c>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	ce650513          	addi	a0,a0,-794 # 5eb0 <malloc+0x19c>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	a8a080e7          	jalr	-1398(ra) # 5c5c <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	c5c50513          	addi	a0,a0,-932 # 5ed8 <malloc+0x1c4>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	c48a8a93          	addi	s5,s5,-952 # 5ed8 <malloc+0x1c4>
      int cc = write(fd, buf, sz);
     298:	0000ca17          	auipc	s4,0xc
     29c:	be0a0a13          	addi	s4,s4,-1056 # be78 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2a0:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	bd650513          	addi	a0,a0,-1066 # 5ee8 <malloc+0x1d4>
     31a:	00006097          	auipc	ra,0x6
     31e:	942080e7          	jalr	-1726(ra) # 5c5c <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     338:	bd450513          	addi	a0,a0,-1068 # 5f08 <malloc+0x1f4>
     33c:	00006097          	auipc	ra,0x6
     340:	920080e7          	jalr	-1760(ra) # 5c5c <printf>
        exit(1);
     344:	4505                	li	a0,1
...
000000000000034e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     374:	bb0a0a13          	addi	s4,s4,-1104 # 5f20 <malloc+0x20c>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     420:	b0c50513          	addi	a0,a0,-1268 # 5f28 <malloc+0x214>
     424:	00006097          	auipc	ra,0x6
     428:	838080e7          	jalr	-1992(ra) # 5c5c <printf>
      exit(1);
     42c:	4505                	li	a0,1
     ...
     43e:	b0650513          	addi	a0,a0,-1274 # 5f40 <malloc+0x22c>
     442:	00006097          	auipc	ra,0x6
     446:	81a080e7          	jalr	-2022(ra) # 5c5c <printf>
      exit(1);
     44a:	4505                	li	a0,1
     ...
     45c:	b1850513          	addi	a0,a0,-1256 # 5f70 <malloc+0x25c>
     460:	00005097          	auipc	ra,0x5
     464:	7fc080e7          	jalr	2044(ra) # 5c5c <printf>
      exit(1);
     468:	4505                	li	a0,1
     ...
     476:	b2e50513          	addi	a0,a0,-1234 # 5fa0 <malloc+0x28c>
     47a:	00005097          	auipc	ra,0x5
     47e:	7e2080e7          	jalr	2018(ra) # 5c5c <printf>
      exit(1);
     482:	4505                	li	a0,1
     ...
     494:	b2050513          	addi	a0,a0,-1248 # 5fb0 <malloc+0x29c>
     498:	00005097          	auipc	ra,0x5
     49c:	7c4080e7          	jalr	1988(ra) # 5c5c <printf>
      exit(1);
     4a0:	4505                	li	a0,1
...
00000000000004aa <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d2:	b12a0a13          	addi	s4,s4,-1262 # 5fe0 <malloc+0x2cc>
    n = write(fds[1], "x", 1);
     4d6:	00006a97          	auipc	s5,0x6
     4da:	9d2a8a93          	addi	s5,s5,-1582 # 5ea8 <malloc+0x194>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     580:	a6c50513          	addi	a0,a0,-1428 # 5fe8 <malloc+0x2d4>
     584:	00005097          	auipc	ra,0x5
     588:	6d8080e7          	jalr	1752(ra) # 5c5c <printf>
      exit(1);
     58c:	4505                	li	a0,1
     ...
     59e:	a6650513          	addi	a0,a0,-1434 # 6000 <malloc+0x2ec>
     5a2:	00005097          	auipc	ra,0x5
     5a6:	6ba080e7          	jalr	1722(ra) # 5c5c <printf>
      exit(1);
     5aa:	4505                	li	a0,1
     ...
     5b8:	9ec50513          	addi	a0,a0,-1556 # 5fa0 <malloc+0x28c>
     5bc:	00005097          	auipc	ra,0x5
     5c0:	6a0080e7          	jalr	1696(ra) # 5c5c <printf>
      exit(1);
     5c4:	4505                	li	a0,1
     ...
     5d2:	a6250513          	addi	a0,a0,-1438 # 6030 <malloc+0x31c>
     5d6:	00005097          	auipc	ra,0x5
     5da:	686080e7          	jalr	1670(ra) # 5c5c <printf>
      exit(1);
     5de:	4505                	li	a0,1
     ...
     5f0:	a5c50513          	addi	a0,a0,-1444 # 6048 <malloc+0x334>
     5f4:	00005097          	auipc	ra,0x5
     5f8:	668080e7          	jalr	1640(ra) # 5c5c <printf>
      exit(1);
     5fc:	4505                	li	a0,1
...
0000000000000606 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     646:	85e58593          	addi	a1,a1,-1954 # 5ea0 <malloc+0x18c>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     662:	83250513          	addi	a0,a0,-1998 # 5e90 <malloc+0x17c>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     68e:	80650513          	addi	a0,a0,-2042 # 5e90 <malloc+0x17c>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a2:	7f250513          	addi	a0,a0,2034 # 5e90 <malloc+0x17c>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e0:	9fc58593          	addi	a1,a1,-1540 # 60d8 <malloc+0x3c4>
     6e4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     722:	77250513          	addi	a0,a0,1906 # 5e90 <malloc+0x17c>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     766:	91650513          	addi	a0,a0,-1770 # 6078 <malloc+0x364>
     76a:	00005097          	auipc	ra,0x5
     76e:	4f2080e7          	jalr	1266(ra) # 5c5c <printf>
    exit(1);
     772:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     782:	91a50513          	addi	a0,a0,-1766 # 6098 <malloc+0x384>
     786:	00005097          	auipc	ra,0x5
     78a:	4d6080e7          	jalr	1238(ra) # 5c5c <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     78e:	8652                	mv	a2,s4
     790:	85d6                	mv	a1,s5
     792:	00006517          	auipc	a0,0x6
     796:	91650513          	addi	a0,a0,-1770 # 60a8 <malloc+0x394>
     79a:	00005097          	auipc	ra,0x5
     79e:	4c2080e7          	jalr	1218(ra) # 5c5c <printf>
    exit(1);
     7a2:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b2:	91a50513          	addi	a0,a0,-1766 # 60c8 <malloc+0x3b4>
     7b6:	00005097          	auipc	ra,0x5
     7ba:	4a6080e7          	jalr	1190(ra) # 5c5c <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7be:	8652                	mv	a2,s4
     7c0:	85d6                	mv	a1,s5
     7c2:	00006517          	auipc	a0,0x6
     7c6:	8e650513          	addi	a0,a0,-1818 # 60a8 <malloc+0x394>
     7ca:	00005097          	auipc	ra,0x5
     7ce:	492080e7          	jalr	1170(ra) # 5c5c <printf>
    exit(1);
     7d2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e4:	90050513          	addi	a0,a0,-1792 # 60e0 <malloc+0x3cc>
     7e8:	00005097          	auipc	ra,0x5
     7ec:	474080e7          	jalr	1140(ra) # 5c5c <printf>
    exit(1);
     7f0:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     802:	90250513          	addi	a0,a0,-1790 # 6100 <malloc+0x3ec>
     806:	00005097          	auipc	ra,0x5
     80a:	456080e7          	jalr	1110(ra) # 5c5c <printf>
    exit(1);
     80e:	4505                	li	a0,1
...
0000000000000818 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     836:	8ee50513          	addi	a0,a0,-1810 # 6120 <malloc+0x40c>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     84e:	8fe98993          	addi	s3,s3,-1794 # 6148 <malloc+0x434>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     852:	00006a97          	auipc	s5,0x6
     856:	92ea8a93          	addi	s5,s5,-1746 # 6180 <malloc+0x46c>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89c:	88850513          	addi	a0,a0,-1912 # 6120 <malloc+0x40c>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8b6:	5c658593          	addi	a1,a1,1478 # be78 <buf>
  ...
  if(unlink("small") < 0){
     ...
     8d8:	84c50513          	addi	a0,a0,-1972 # 6120 <malloc+0x40c>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     902:	82a50513          	addi	a0,a0,-2006 # 6128 <malloc+0x414>
     906:	00005097          	auipc	ra,0x5
     90a:	356080e7          	jalr	854(ra) # 5c5c <printf>
    exit(1);
     90e:	4505                	li	a0,1
     ...
     920:	83c50513          	addi	a0,a0,-1988 # 6158 <malloc+0x444>
     924:	00005097          	auipc	ra,0x5
     928:	338080e7          	jalr	824(ra) # 5c5c <printf>
      exit(1);
     92c:	4505                	li	a0,1
     ...
     93e:	85650513          	addi	a0,a0,-1962 # 6190 <malloc+0x47c>
     942:	00005097          	auipc	ra,0x5
     946:	31a080e7          	jalr	794(ra) # 5c5c <printf>
      exit(1);
     94a:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95a:	86250513          	addi	a0,a0,-1950 # 61b8 <malloc+0x4a4>
     95e:	00005097          	auipc	ra,0x5
     962:	2fe080e7          	jalr	766(ra) # 5c5c <printf>
    exit(1);
     966:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     976:	86650513          	addi	a0,a0,-1946 # 61d8 <malloc+0x4c4>
     97a:	00005097          	auipc	ra,0x5
     97e:	2e2080e7          	jalr	738(ra) # 5c5c <printf>
    exit(1);
     982:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     992:	86250513          	addi	a0,a0,-1950 # 61f0 <malloc+0x4dc>
     996:	00005097          	auipc	ra,0x5
     99a:	2c6080e7          	jalr	710(ra) # 5c5c <printf>
    exit(1);
     99e:	4505                	li	a0,1
...
00000000000009a8 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c4:	85050513          	addi	a0,a0,-1968 # 6210 <malloc+0x4fc>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9d8:	4a490913          	addi	s2,s2,1188 # be78 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a16:	7fe50513          	addi	a0,a0,2046 # 6210 <malloc+0x4fc>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2a:	45290913          	addi	s2,s2,1106 # be78 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a5e:	7be50513          	addi	a0,a0,1982 # 6218 <malloc+0x504>
     a62:	00005097          	auipc	ra,0x5
     a66:	1fa080e7          	jalr	506(ra) # 5c5c <printf>
    exit(1);
     a6a:	4505                	li	a0,1
     ...
     a7c:	7c050513          	addi	a0,a0,1984 # 6238 <malloc+0x524>
     a80:	00005097          	auipc	ra,0x5
     a84:	1dc080e7          	jalr	476(ra) # 5c5c <printf>
      exit(1);
     a88:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a98:	7cc50513          	addi	a0,a0,1996 # 6260 <malloc+0x54c>
     a9c:	00005097          	auipc	ra,0x5
     aa0:	1c0080e7          	jalr	448(ra) # 5c5c <printf>
    exit(1);
     aa4:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ac4:	75050513          	addi	a0,a0,1872 # 6210 <malloc+0x4fc>
     ...
     af0:	79450513          	addi	a0,a0,1940 # 6280 <malloc+0x56c>
     af4:	00005097          	auipc	ra,0x5
     af8:	168080e7          	jalr	360(ra) # 5c5c <printf>
        exit(1);
     afc:	4505                	li	a0,1
     ...
     b0e:	79e50513          	addi	a0,a0,1950 # 62a8 <malloc+0x594>
     b12:	00005097          	auipc	ra,0x5
     b16:	14a080e7          	jalr	330(ra) # 5c5c <printf>
      exit(1);
     b1a:	4505                	li	a0,1
     ...
     b2c:	79850513          	addi	a0,a0,1944 # 62c0 <malloc+0x5ac>
     b30:	00005097          	auipc	ra,0x5
     b34:	12c080e7          	jalr	300(ra) # 5c5c <printf>
      exit(1);
     b38:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b48:	7a450513          	addi	a0,a0,1956 # 62e8 <malloc+0x5d4>
     b4c:	00005097          	auipc	ra,0x5
     b50:	110080e7          	jalr	272(ra) # 5c5c <printf>
    exit(1);
     b54:	4505                	li	a0,1
...
0000000000000b5e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b76:	78e50513          	addi	a0,a0,1934 # 6300 <malloc+0x5ec>
  ...
  write(fd, "hello", SZ);
     ...
     b8e:	7a658593          	addi	a1,a1,1958 # 6330 <malloc+0x61c>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     baa:	75a50513          	addi	a0,a0,1882 # 6300 <malloc+0x5ec>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc0:	74450513          	addi	a0,a0,1860 # 6300 <malloc+0x5ec>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd6:	72e50513          	addi	a0,a0,1838 # 6300 <malloc+0x5ec>
  ...
  write(fd1, "yyy", 3);
     ...
     bea:	79258593          	addi	a1,a1,1938 # 6378 <malloc+0x664>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c06:	27658593          	addi	a1,a1,630 # be78 <buf>
     c0a:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c52:	6b250513          	addi	a0,a0,1714 # 6300 <malloc+0x5ec>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c72:	6a250513          	addi	a0,a0,1698 # 6310 <malloc+0x5fc>
     c76:	00005097          	auipc	ra,0x5
     c7a:	fe6080e7          	jalr	-26(ra) # 5c5c <printf>
    exit(1);
     c7e:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c8e:	6ae50513          	addi	a0,a0,1710 # 6338 <malloc+0x624>
     c92:	00005097          	auipc	ra,0x5
     c96:	fca080e7          	jalr	-54(ra) # 5c5c <printf>
    exit(1);
     c9a:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     caa:	6b250513          	addi	a0,a0,1714 # 6358 <malloc+0x644>
     cae:	00005097          	auipc	ra,0x5
     cb2:	fae080e7          	jalr	-82(ra) # 5c5c <printf>
    exit(1);
     cb6:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc6:	6be50513          	addi	a0,a0,1726 # 6380 <malloc+0x66c>
     cca:	00005097          	auipc	ra,0x5
     cce:	f92080e7          	jalr	-110(ra) # 5c5c <printf>
    exit(1);
     cd2:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce2:	6c250513          	addi	a0,a0,1730 # 63a0 <malloc+0x68c>
     ce6:	00005097          	auipc	ra,0x5
     cea:	f76080e7          	jalr	-138(ra) # 5c5c <printf>
    exit(1);
     cee:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     cfe:	6c650513          	addi	a0,a0,1734 # 63c0 <malloc+0x6ac>
     d02:	00005097          	auipc	ra,0x5
     d06:	f5a080e7          	jalr	-166(ra) # 5c5c <printf>
    exit(1);
     d0a:	4505                	li	a0,1
...
0000000000000d14 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d62:	5d258593          	addi	a1,a1,1490 # 6330 <malloc+0x61c>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d82:	66a58593          	addi	a1,a1,1642 # 63e8 <malloc+0x6d4>
     d86:	00005517          	auipc	a0,0x5
     d8a:	65a50513          	addi	a0,a0,1626 # 63e0 <malloc+0x6cc>
  ...
  unlink("lf1");
     ...
     d9e:	64650513          	addi	a0,a0,1606 # 63e0 <malloc+0x6cc>
     da2:	00005097          	auipc	ra,0x5
     da6:	af0080e7          	jalr	-1296(ra) # 5892 <unlink>
  if(open("lf1", 0) >= 0){
     daa:	4581                	li	a1,0
     dac:	00005517          	auipc	a0,0x5
     db0:	63450513          	addi	a0,a0,1588 # 63e0 <malloc+0x6cc>
  ...
  fd = open("lf2", 0);
     ...
     dc6:	62650513          	addi	a0,a0,1574 # 63e8 <malloc+0x6d4>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     dde:	09e58593          	addi	a1,a1,158 # be78 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     dfe:	5ee58593          	addi	a1,a1,1518 # 63e8 <malloc+0x6d4>
     e02:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e14:	5d850513          	addi	a0,a0,1496 # 63e8 <malloc+0x6d4>
     e18:	00005097          	auipc	ra,0x5
     e1c:	a7a080e7          	jalr	-1414(ra) # 5892 <unlink>
  if(link("lf2", "lf1") >= 0){
     e20:	00005597          	auipc	a1,0x5
     e24:	5c058593          	addi	a1,a1,1472 # 63e0 <malloc+0x6cc>
     e28:	00005517          	auipc	a0,0x5
     e2c:	5c050513          	addi	a0,a0,1472 # 63e8 <malloc+0x6d4>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e40:	5a458593          	addi	a1,a1,1444 # 63e0 <malloc+0x6cc>
     e44:	00005517          	auipc	a0,0x5
     e48:	6ac50513          	addi	a0,a0,1708 # 64f0 <malloc+0x7dc>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6a:	58a50513          	addi	a0,a0,1418 # 63f0 <malloc+0x6dc>
     e6e:	00005097          	auipc	ra,0x5
     e72:	dee080e7          	jalr	-530(ra) # 5c5c <printf>
    exit(1);
     e76:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e86:	58650513          	addi	a0,a0,1414 # 6408 <malloc+0x6f4>
     e8a:	00005097          	auipc	ra,0x5
     e8e:	dd2080e7          	jalr	-558(ra) # 5c5c <printf>
    exit(1);
     e92:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea2:	58250513          	addi	a0,a0,1410 # 6420 <malloc+0x70c>
     ea6:	00005097          	auipc	ra,0x5
     eaa:	db6080e7          	jalr	-586(ra) # 5c5c <printf>
    exit(1);
     eae:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ebe:	58650513          	addi	a0,a0,1414 # 6440 <malloc+0x72c>
     ec2:	00005097          	auipc	ra,0x5
     ec6:	d9a080e7          	jalr	-614(ra) # 5c5c <printf>
    exit(1);
     eca:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     eda:	59a50513          	addi	a0,a0,1434 # 6470 <malloc+0x75c>
     ede:	00005097          	auipc	ra,0x5
     ee2:	d7e080e7          	jalr	-642(ra) # 5c5c <printf>
    exit(1);
     ee6:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef6:	59650513          	addi	a0,a0,1430 # 6488 <malloc+0x774>
     efa:	00005097          	auipc	ra,0x5
     efe:	d62080e7          	jalr	-670(ra) # 5c5c <printf>
    exit(1);
     f02:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f12:	59250513          	addi	a0,a0,1426 # 64a0 <malloc+0x78c>
     f16:	00005097          	auipc	ra,0x5
     f1a:	d46080e7          	jalr	-698(ra) # 5c5c <printf>
    exit(1);
     f1e:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f2e:	59e50513          	addi	a0,a0,1438 # 64c8 <malloc+0x7b4>
     f32:	00005097          	auipc	ra,0x5
     f36:	d2a080e7          	jalr	-726(ra) # 5c5c <printf>
    exit(1);
     f3a:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4a:	5b250513          	addi	a0,a0,1458 # 64f8 <malloc+0x7e4>
     f4e:	00005097          	auipc	ra,0x5
     f52:	d0e080e7          	jalr	-754(ra) # 5c5c <printf>
    exit(1);
     f56:	4505                	li	a0,1
...
0000000000000f60 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb0:	56ca0a13          	addi	s4,s4,1388 # 6518 <malloc+0x804>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1002:	51a50513          	addi	a0,a0,1306 # 6518 <malloc+0x804>
  ...
  for(i = 0; i < N; i++){
    ...
    1072:	4b250513          	addi	a0,a0,1202 # 6520 <malloc+0x80c>
    1076:	00005097          	auipc	ra,0x5
    107a:	be6080e7          	jalr	-1050(ra) # 5c5c <printf>
    exit(1);
    107e:	4505                	li	a0,1
    ...
    1092:	4b250513          	addi	a0,a0,1202 # 6540 <malloc+0x82c>
    1096:	00005097          	auipc	ra,0x5
    109a:	bc6080e7          	jalr	-1082(ra) # 5c5c <printf>
      exit(1);
    109e:	4505                	li	a0,1
    ...
    10ae:	4b650513          	addi	a0,a0,1206 # 6560 <malloc+0x84c>
    10b2:	00005097          	auipc	ra,0x5
    10b6:	baa080e7          	jalr	-1110(ra) # 5c5c <printf>
      exit(1);
    10ba:	4505                	li	a0,1
...
00000000000010c4 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e0:	4a498993          	addi	s3,s3,1188 # 6580 <malloc+0x86c>
    10e4:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111c:	47850513          	addi	a0,a0,1144 # 6590 <malloc+0x87c>
    1120:	00005097          	auipc	ra,0x5
    1124:	b3c080e7          	jalr	-1220(ra) # 5c5c <printf>
      exit(1);
    1128:	4505                	li	a0,1
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1144:	5104b483          	ld	s1,1296(s1) # 8650 <__SDATA_BEGIN__>
...
badarg(char *s)
{
    ...
    117a:	35048493          	addi	s1,s1,848 # c350 <buf+0x4d8>
  for(int i = 0; i < 50000; i++){
    ...
    1188:	cb498993          	addi	s3,s3,-844 # 5e38 <malloc+0x124>
    argv[0] = (char*)0xffffffff;
...
00000000000011b0 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1212:	57a78793          	addi	a5,a5,1402 # 7788 <malloc+0x1a74>
  ...
  if(pid == 0){
    ...
    1248:	51c78793          	addi	a5,a5,1308 # 8760 <big.0>
    124c:	00008697          	auipc	a3,0x8
    1250:	51468693          	addi	a3,a3,1300 # 9760 <__global_pointer$+0x910>
      big[i] = 'x';
    ...
    1266:	4e078f23          	sb	zero,1278(a5) # 9760 <__global_pointer$+0x910>
    char *args2[] = { big, big, big, 0 };
    126a:	00007797          	auipc	a5,0x7
    126e:	f5e78793          	addi	a5,a5,-162 # 81c8 <malloc+0x24b4>
    ...
    1292:	baa50513          	addi	a0,a0,-1110 # 5e38 <malloc+0x124>
    ...
    12aa:	39250513          	addi	a0,a0,914 # 6638 <malloc+0x924>
    12ae:	00005097          	auipc	ra,0x5
    12b2:	9ae080e7          	jalr	-1618(ra) # 5c5c <printf>
      exit(1);
    12b6:	4505                	li	a0,1
    ...
    12ca:	2ea50513          	addi	a0,a0,746 # 65b0 <malloc+0x89c>
    12ce:	00005097          	auipc	ra,0x5
    12d2:	98e080e7          	jalr	-1650(ra) # 5c5c <printf>
    exit(1);
    12d6:	4505                	li	a0,1
    ...
    12ea:	2ea50513          	addi	a0,a0,746 # 65d0 <malloc+0x8bc>
    12ee:	00005097          	auipc	ra,0x5
    12f2:	96e080e7          	jalr	-1682(ra) # 5c5c <printf>
    exit(1);
    12f6:	4505                	li	a0,1
    ...
    130c:	2e850513          	addi	a0,a0,744 # 65f0 <malloc+0x8dc>
    1310:	00005097          	auipc	ra,0x5
    1314:	94c080e7          	jalr	-1716(ra) # 5c5c <printf>
    exit(1);
    1318:	4505                	li	a0,1
    ...
    132c:	2f050513          	addi	a0,a0,752 # 6618 <malloc+0x904>
    1330:	00005097          	auipc	ra,0x5
    1334:	92c080e7          	jalr	-1748(ra) # 5c5c <printf>
    exit(1);
    1338:	4505                	li	a0,1
    ...
    1346:	76e50513          	addi	a0,a0,1902 # 6ab0 <malloc+0xd9c>
    134a:	00005097          	auipc	ra,0x5
    134e:	912080e7          	jalr	-1774(ra) # 5c5c <printf>
    exit(1);
    1352:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1390:	2d450513          	addi	a0,a0,724 # 6660 <malloc+0x94c>
    1394:	00005097          	auipc	ra,0x5
    1398:	8c8080e7          	jalr	-1848(ra) # 5c5c <printf>
    exit(1);
    139c:	4505                	li	a0,1
...
00000000000013a6 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c2:	ad250513          	addi	a0,a0,-1326 # 5e90 <malloc+0x17c>
  ...
  if(pid == 0){
    ...
    13ec:	aa8a0a13          	addi	s4,s4,-1368 # 5e90 <malloc+0x17c>
      int n = write(fd, "1234567890", 10);
    13f0:	00005a97          	auipc	s5,0x5
    13f4:	2d0a8a93          	addi	s5,s5,720 # 66c0 <malloc+0x9ac>
      int fd = open("truncfile", O_WRONLY);
    13f8:	4585                	li	a1,1
    13fa:	8552                	mv	a0,s4
    ...
    1464:	23050513          	addi	a0,a0,560 # 6690 <malloc+0x97c>
    1468:	00004097          	auipc	ra,0x4
    146c:	7f4080e7          	jalr	2036(ra) # 5c5c <printf>
    exit(1);
    1470:	4505                	li	a0,1
    ...
    1480:	22c50513          	addi	a0,a0,556 # 66a8 <malloc+0x994>
    1484:	00004097          	auipc	ra,0x4
    1488:	7d8080e7          	jalr	2008(ra) # 5c5c <printf>
        exit(1);
    148c:	4505                	li	a0,1
    ...
    149e:	23650513          	addi	a0,a0,566 # 66d0 <malloc+0x9bc>
    14a2:	00004097          	auipc	ra,0x4
    14a6:	7ba080e7          	jalr	1978(ra) # 5c5c <printf>
        exit(1);
    14aa:	4505                	li	a0,1
    ...
    14bc:	9d8a0a13          	addi	s4,s4,-1576 # 5e90 <malloc+0x17c>
    int n = write(fd, "xxx", 3);
    14c0:	00005a97          	auipc	s5,0x5
    14c4:	230a8a93          	addi	s5,s5,560 # 66f0 <malloc+0x9dc>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    150e:	98650513          	addi	a0,a0,-1658 # 5e90 <malloc+0x17c>
  ...
  exit(xstatus);
    ...
    152c:	18050513          	addi	a0,a0,384 # 66a8 <malloc+0x994>
    1530:	00004097          	auipc	ra,0x4
    1534:	72c080e7          	jalr	1836(ra) # 5c5c <printf>
      exit(1);
    1538:	4505                	li	a0,1
    ...
    154a:	1b250513          	addi	a0,a0,434 # 66f8 <malloc+0x9e4>
    154e:	00004097          	auipc	ra,0x4
    1552:	70e080e7          	jalr	1806(ra) # 5c5c <printf>
      exit(1);
    1556:	4505                	li	a0,1
...
0000000000001560 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1572:	8ca78793          	addi	a5,a5,-1846 # 5e38 <malloc+0x124>
    1576:	fcf43023          	sd	a5,-64(s0)
    157a:	00005797          	auipc	a5,0x5
    157e:	19e78793          	addi	a5,a5,414 # 6718 <malloc+0xa04>
    1582:	fcf43423          	sd	a5,-56(s0)
    1586:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158a:	00005517          	auipc	a0,0x5
    158e:	19650513          	addi	a0,a0,406 # 6720 <malloc+0xa0c>
  ...
  if(pid == 0) {
    ...
    15bc:	16850513          	addi	a0,a0,360 # 6720 <malloc+0xa0c>
    ...
    15d8:	16c50513          	addi	a0,a0,364 # 6740 <malloc+0xa2c>
    15dc:	00004097          	auipc	ra,0x4
    15e0:	680080e7          	jalr	1664(ra) # 5c5c <printf>
      exit(1);
    15e4:	4505                	li	a0,1
    ...
    15f4:	0a050513          	addi	a0,a0,160 # 6690 <malloc+0x97c>
    15f8:	00004097          	auipc	ra,0x4
    15fc:	664080e7          	jalr	1636(ra) # 5c5c <printf>
     exit(1);
    1600:	4505                	li	a0,1
    ...
    1610:	11c50513          	addi	a0,a0,284 # 6728 <malloc+0xa14>
    1614:	00004097          	auipc	ra,0x4
    1618:	648080e7          	jalr	1608(ra) # 5c5c <printf>
      exit(1);
    161c:	4505                	li	a0,1
    ...
    162e:	80e50513          	addi	a0,a0,-2034 # 5e38 <malloc+0x124>
  ...
  if(xstatus != 0)
    ...
    1662:	0f250513          	addi	a0,a0,242 # 6750 <malloc+0xa3c>
    1666:	00004097          	auipc	ra,0x4
    166a:	5f6080e7          	jalr	1526(ra) # 5c5c <printf>
      exit(1);
    166e:	4505                	li	a0,1
    ...
    167e:	0ee50513          	addi	a0,a0,238 # 6768 <malloc+0xa54>
    1682:	00004097          	auipc	ra,0x4
    1686:	5da080e7          	jalr	1498(ra) # 5c5c <printf>
    168a:	b7d1                	j	164e <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    168c:	4581                	li	a1,0
    168e:	00005517          	auipc	a0,0x5
    1692:	09250513          	addi	a0,a0,146 # 6720 <malloc+0xa0c>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16bc:	b2050513          	addi	a0,a0,-1248 # 61d8 <malloc+0x4c4>
    16c0:	00004097          	auipc	ra,0x4
    16c4:	59c080e7          	jalr	1436(ra) # 5c5c <printf>
    exit(1);
    16c8:	4505                	li	a0,1
    ...
    16d8:	fd450513          	addi	a0,a0,-44 # 66a8 <malloc+0x994>
    16dc:	00004097          	auipc	ra,0x4
    16e0:	580080e7          	jalr	1408(ra) # 5c5c <printf>
    exit(1);
    16e4:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    16f2:	03250513          	addi	a0,a0,50 # 6720 <malloc+0xa0c>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171c:	06850513          	addi	a0,a0,104 # 6780 <malloc+0xa6c>
    1720:	00004097          	auipc	ra,0x4
    1724:	53c080e7          	jalr	1340(ra) # 5c5c <printf>
    exit(1);
    1728:	4505                	li	a0,1
...
000000000000173c <pipe1>:
{
  ...
  if(pid == 0){
    ...
    1788:	6f4a8a93          	addi	s5,s5,1780 # be78 <buf>
      if(cc > sizeof(buf))
    ...
    17a6:	6d670713          	addi	a4,a4,1750 # be78 <buf>
    ...
    17dc:	fc050513          	addi	a0,a0,-64 # 6798 <malloc+0xa84>
    17e0:	00004097          	auipc	ra,0x4
    17e4:	47c080e7          	jalr	1148(ra) # 5c5c <printf>
    exit(1);
    17e8:	4505                	li	a0,1
    ...
    1802:	67ab0b13          	addi	s6,s6,1658 # be78 <buf>
    ...
    1816:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x87>
{
    ...
    1862:	f5250513          	addi	a0,a0,-174 # 67b0 <malloc+0xa9c>
    1866:	00004097          	auipc	ra,0x4
    186a:	3f6080e7          	jalr	1014(ra) # 5c5c <printf>
        exit(1);
    186e:	4505                	li	a0,1
    ...
    187e:	f4e50513          	addi	a0,a0,-178 # 67c8 <malloc+0xab4>
    1882:	00004097          	auipc	ra,0x4
    1886:	3da080e7          	jalr	986(ra) # 5c5c <printf>
}
    ...
    18b0:	f3450513          	addi	a0,a0,-204 # 67e0 <malloc+0xacc>
    18b4:	00004097          	auipc	ra,0x4
    18b8:	3a8080e7          	jalr	936(ra) # 5c5c <printf>
      exit(1);
    18bc:	4505                	li	a0,1
    ...
    18f0:	f1450513          	addi	a0,a0,-236 # 6800 <malloc+0xaec>
    18f4:	00004097          	auipc	ra,0x4
    18f8:	368080e7          	jalr	872(ra) # 5c5c <printf>
    exit(1);
    18fc:	4505                	li	a0,1
...
0000000000001906 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1962:	d3250513          	addi	a0,a0,-718 # 6690 <malloc+0x97c>
    1966:	00004097          	auipc	ra,0x4
    196a:	2f6080e7          	jalr	758(ra) # 5c5c <printf>
      exit(1);
    196e:	4505                	li	a0,1
    ...
    197e:	e9e50513          	addi	a0,a0,-354 # 6818 <malloc+0xb04>
    1982:	00004097          	auipc	ra,0x4
    1986:	2da080e7          	jalr	730(ra) # 5c5c <printf>
        exit(1);
    198a:	4505                	li	a0,1
    ...
    199a:	e9a50513          	addi	a0,a0,-358 # 6830 <malloc+0xb1c>
    199e:	00004097          	auipc	ra,0x4
    19a2:	2be080e7          	jalr	702(ra) # 5c5c <printf>
        exit(1);
    19a6:	4505                	li	a0,1
...
00000000000019ba <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a12:	c8250513          	addi	a0,a0,-894 # 6690 <malloc+0x97c>
    1a16:	00004097          	auipc	ra,0x4
    1a1a:	246080e7          	jalr	582(ra) # 5c5c <printf>
      exit(1);
    1a1e:	4505                	li	a0,1
    ...
    1a36:	c5e50513          	addi	a0,a0,-930 # 6690 <malloc+0x97c>
    1a3a:	00004097          	auipc	ra,0x4
    1a3e:	222080e7          	jalr	546(ra) # 5c5c <printf>
        exit(1);
    1a42:	4505                	li	a0,1
...
0000000000001a54 <forkfork>:
{
    ...
    1ab0:	da450513          	addi	a0,a0,-604 # 6850 <malloc+0xb3c>
    1ab4:	00004097          	auipc	ra,0x4
    1ab8:	1a8080e7          	jalr	424(ra) # 5c5c <printf>
      exit(1);
    1abc:	4505                	li	a0,1
    ...
    1ac2:	d84080e7          	jalr	-636(ra) # 5842 <exit>
{
    ...
    1b08:	d5c50513          	addi	a0,a0,-676 # 6860 <malloc+0xb4c>
    1b0c:	00004097          	auipc	ra,0x4
    1b10:	150080e7          	jalr	336(ra) # 5c5c <printf>
      exit(1);
    1b14:	4505                	li	a0,1
...
0000000000001b1e <reparent2>:
{
  ...
  exit(0);
    ...
    1b56:	f5e50513          	addi	a0,a0,-162 # 6ab0 <malloc+0xd9c>
    1b5a:	00004097          	auipc	ra,0x4
    1b5e:	102080e7          	jalr	258(ra) # 5c5c <printf>
      exit(1);
    1b62:	4505                	li	a0,1
...
0000000000001b86 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf4:	ec050513          	addi	a0,a0,-320 # 6ab0 <malloc+0xd9c>
    1bf8:	00004097          	auipc	ra,0x4
    1bfc:	064080e7          	jalr	100(ra) # 5c5c <printf>
      exit(1);
    1c00:	4505                	li	a0,1
    ...
    1c20:	b0c50513          	addi	a0,a0,-1268 # 6728 <malloc+0xa14>
    1c24:	00004097          	auipc	ra,0x4
    1c28:	038080e7          	jalr	56(ra) # 5c5c <printf>
          exit(1);
    1c2c:	4505                	li	a0,1
    ...
    1c92:	bf250513          	addi	a0,a0,-1038 # 6880 <malloc+0xb6c>
    1c96:	00004097          	auipc	ra,0x4
    1c9a:	fc6080e7          	jalr	-58(ra) # 5c5c <printf>
            exit(1);
    1c9e:	4505                	li	a0,1
    ...
    1cc6:	bd650513          	addi	a0,a0,-1066 # 6898 <malloc+0xb84>
    1cca:	00004097          	auipc	ra,0x4
    1cce:	f92080e7          	jalr	-110(ra) # 5c5c <printf>
        exit(1);
    1cd2:	4505                	li	a0,1
    ...
    1d2c:	b9850513          	addi	a0,a0,-1128 # 68c0 <malloc+0xbac>
    1d30:	00004097          	auipc	ra,0x4
    1d34:	f2c080e7          	jalr	-212(ra) # 5c5c <printf>
        exit(1);
    1d38:	4505                	li	a0,1
...
0000000000001dac <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dcc:	0e050513          	addi	a0,a0,224 # 5ea8 <malloc+0x194>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1df6:	e6d9899b          	addiw	s3,s3,-403 # 41c64e6d <__BSS_END__+0x41c55fe5>
    ...
    1e08:	0a4a8a93          	addi	s5,s5,164 # 5ea8 <malloc+0x194>
      link("cat", "x");
    1e0c:	00005b97          	auipc	s7,0x5
    1e10:	adcb8b93          	addi	s7,s7,-1316 # 68e8 <malloc+0xbd4>
    1e14:	a825                	j	1e4c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1e16:	85a6                	mv	a1,s1
    1e18:	00005517          	auipc	a0,0x5
    1e1c:	87850513          	addi	a0,a0,-1928 # 6690 <malloc+0x97c>
    1e20:	00004097          	auipc	ra,0x4
    1e24:	e3c080e7          	jalr	-452(ra) # 5c5c <printf>
    exit(1);
    1e28:	4505                	li	a0,1
...
0000000000001eae <manywrites>:
{
  ...
  exit(0);
    ...
    1f0a:	baa50513          	addi	a0,a0,-1110 # 6ab0 <malloc+0xd9c>
    1f0e:	00004097          	auipc	ra,0x4
    1f12:	d4e080e7          	jalr	-690(ra) # 5c5c <printf>
      exit(1);
    1f16:	4505                	li	a0,1
    ...
    1f46:	f36b0b13          	addi	s6,s6,-202 # be78 <buf>
    ...
    1fba:	93a50513          	addi	a0,a0,-1734 # 68f0 <malloc+0xbdc>
    1fbe:	00004097          	auipc	ra,0x4
    1fc2:	c9e080e7          	jalr	-866(ra) # 5c5c <printf>
            exit(1);
    1fc6:	4505                	li	a0,1
    ...
    1fda:	f3250513          	addi	a0,a0,-206 # 5f08 <malloc+0x1f4>
    1fde:	00004097          	auipc	ra,0x4
    1fe2:	c7e080e7          	jalr	-898(ra) # 5c5c <printf>
            exit(1);
    1fe6:	4505                	li	a0,1
...
0000000000001ff8 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    2028:	8fc50513          	addi	a0,a0,-1796 # 6920 <malloc+0xc0c>
    202c:	00004097          	auipc	ra,0x4
    2030:	c30080e7          	jalr	-976(ra) # 5c5c <printf>
    exit(1);
    2034:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    208a:	88250513          	addi	a0,a0,-1918 # 6908 <malloc+0xbf4>
    208e:	00004097          	auipc	ra,0x4
    2092:	bce080e7          	jalr	-1074(ra) # 5c5c <printf>
    exit(1);
    2096:	4505                	li	a0,1
    ...
    20a6:	8a650513          	addi	a0,a0,-1882 # 6948 <malloc+0xc34>
    20aa:	00004097          	auipc	ra,0x4
    20ae:	bb2080e7          	jalr	-1102(ra) # 5c5c <printf>
      exit(1);
    20b2:	4505                	li	a0,1
    ...
    20c2:	8a250513          	addi	a0,a0,-1886 # 6960 <malloc+0xc4c>
    20c6:	00004097          	auipc	ra,0x4
    20ca:	b96080e7          	jalr	-1130(ra) # 5c5c <printf>
    exit(1);
    20ce:	4505                	li	a0,1
...
00000000000020d8 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    20f4:	35098993          	addi	s3,s3,848 # c350 <buf+0x4d8>
    20f8:	1003d937          	lui	s2,0x1003d
    20fc:	090e                	slli	s2,s2,0x3
    20fe:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e5f8>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2142:	55250513          	addi	a0,a0,1362 # 6690 <malloc+0x97c>
    2146:	00004097          	auipc	ra,0x4
    214a:	b16080e7          	jalr	-1258(ra) # 5c5c <printf>
      exit(1);
    214e:	4505                	li	a0,1
    ...
    2164:	81850513          	addi	a0,a0,-2024 # 6978 <malloc+0xc64>
    2168:	00004097          	auipc	ra,0x4
    216c:	af4080e7          	jalr	-1292(ra) # 5c5c <printf>
      exit(1);
    2170:	4505                	li	a0,1
...
0000000000002184 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    21e6:	4ae50513          	addi	a0,a0,1198 # 6690 <malloc+0x97c>
    21ea:	00004097          	auipc	ra,0x4
    21ee:	a72080e7          	jalr	-1422(ra) # 5c5c <printf>
      exit(1);
    21f2:	4505                	li	a0,1
    ...
    2212:	78a50513          	addi	a0,a0,1930 # 6998 <malloc+0xc84>
    2216:	00004097          	auipc	ra,0x4
    221a:	a46080e7          	jalr	-1466(ra) # 5c5c <printf>
      exit(1);
    221e:	4505                	li	a0,1
...
0000000000002232 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2242:	77250513          	addi	a0,a0,1906 # 69b0 <malloc+0xc9c>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2274:	74050513          	addi	a0,a0,1856 # 69b0 <malloc+0xc9c>
  ...
  close(fd);
    ...
    229a:	3ca78793          	addi	a5,a5,970 # 8660 <args.1>
    229e:	00006697          	auipc	a3,0x6
    22a2:	4ba68693          	addi	a3,a3,1210 # 8758 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    22a6:	00004717          	auipc	a4,0x4
    22aa:	71a70713          	addi	a4,a4,1818 # 69c0 <malloc+0xcac>
    ...
    22fe:	7a650513          	addi	a0,a0,1958 # 6aa0 <malloc+0xd8c>
    2302:	00004097          	auipc	ra,0x4
    2306:	95a080e7          	jalr	-1702(ra) # 5c5c <printf>
    exit(1);
    230a:	4505                	li	a0,1
    ...
    2322:	7a250513          	addi	a0,a0,1954 # 6ac0 <malloc+0xdac>
    2326:	00004097          	auipc	ra,0x4
    232a:	936080e7          	jalr	-1738(ra) # 5c5c <printf>
    exit(1);
    232e:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2376:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff0178>
    237a:	85a6                	mv	a1,s1
    237c:	00004517          	auipc	a0,0x4
    2380:	76450513          	addi	a0,a0,1892 # 6ae0 <malloc+0xdcc>
    2384:	00004097          	auipc	ra,0x4
    2388:	8d8080e7          	jalr	-1832(ra) # 5c5c <printf>
    exit(1);
    238c:	4505                	li	a0,1
    ...
    239c:	2f850513          	addi	a0,a0,760 # 6690 <malloc+0x97c>
    23a0:	00004097          	auipc	ra,0x4
    23a4:	8bc080e7          	jalr	-1860(ra) # 5c5c <printf>
    exit(1);
    23a8:	4505                	li	a0,1
...
00000000000023bc <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2436:	35678793          	addi	a5,a5,854 # 7788 <malloc+0x1a74>
  ...
  if(ret != -1){
    ...
    2478:	69450513          	addi	a0,a0,1684 # 6b08 <malloc+0xdf4>
    247c:	00003097          	auipc	ra,0x3
    2480:	7e0080e7          	jalr	2016(ra) # 5c5c <printf>
    exit(1);
    2484:	4505                	li	a0,1
    ...
    2496:	11e50513          	addi	a0,a0,286 # 65b0 <malloc+0x89c>
    249a:	00003097          	auipc	ra,0x3
    249e:	7c2080e7          	jalr	1986(ra) # 5c5c <printf>
    exit(1);
    24a2:	4505                	li	a0,1
    ...
    24b4:	12050513          	addi	a0,a0,288 # 65d0 <malloc+0x8bc>
    24b8:	00003097          	auipc	ra,0x3
    24bc:	7a4080e7          	jalr	1956(ra) # 5c5c <printf>
    exit(1);
    24c0:	4505                	li	a0,1
    ...
    24d4:	12050513          	addi	a0,a0,288 # 65f0 <malloc+0x8dc>
    24d8:	00003097          	auipc	ra,0x3
    24dc:	784080e7          	jalr	1924(ra) # 5c5c <printf>
    exit(1);
    24e0:	4505                	li	a0,1
    ...
    24f2:	12a50513          	addi	a0,a0,298 # 6618 <malloc+0x904>
    24f6:	00003097          	auipc	ra,0x3
    24fa:	766080e7          	jalr	1894(ra) # 5c5c <printf>
    exit(1);
    24fe:	4505                	li	a0,1
...
0000000000002508 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    253e:	60e50513          	addi	a0,a0,1550 # 6b48 <malloc+0xe34>
  ...
  if(n >= 0){
    ...
    256e:	5fe50513          	addi	a0,a0,1534 # 6b68 <malloc+0xe54>
    2572:	00003097          	auipc	ra,0x3
    2576:	6ea080e7          	jalr	1770(ra) # 5c5c <printf>
    exit(1);
    257a:	4505                	li	a0,1
    ...
    2588:	58c50513          	addi	a0,a0,1420 # 6b10 <malloc+0xdfc>
    258c:	00003097          	auipc	ra,0x3
    2590:	6d0080e7          	jalr	1744(ra) # 5c5c <printf>
    exit(1);
    2594:	4505                	li	a0,1
    ...
    25a2:	58a50513          	addi	a0,a0,1418 # 6b28 <malloc+0xe14>
    25a6:	00003097          	auipc	ra,0x3
    25aa:	6b6080e7          	jalr	1718(ra) # 5c5c <printf>
    exit(1);
    25ae:	4505                	li	a0,1
    ...
    25bc:	59850513          	addi	a0,a0,1432 # 6b50 <malloc+0xe3c>
    25c0:	00003097          	auipc	ra,0x3
    25c4:	69c080e7          	jalr	1692(ra) # 5c5c <printf>
    exit(1);
    25c8:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    25e0:	56c50513          	addi	a0,a0,1388 # 6b48 <malloc+0xe34>
    25e4:	00003097          	auipc	ra,0x3
    25e8:	2ae080e7          	jalr	686(ra) # 5892 <unlink>
  fd = open("README", O_RDONLY);
    25ec:	4581                	li	a1,0
    25ee:	00004517          	auipc	a0,0x4
    25f2:	9f250513          	addi	a0,a0,-1550 # 5fe0 <malloc+0x2cc>
  ...
  if(n >= 0){
    ...
    261c:	58050513          	addi	a0,a0,1408 # 6b98 <malloc+0xe84>
    2620:	00003097          	auipc	ra,0x3
    2624:	63c080e7          	jalr	1596(ra) # 5c5c <printf>
    exit(1);
    2628:	4505                	li	a0,1
    ...
    2636:	51e50513          	addi	a0,a0,1310 # 6b50 <malloc+0xe3c>
    263a:	00003097          	auipc	ra,0x3
    263e:	622080e7          	jalr	1570(ra) # 5c5c <printf>
    exit(1);
    2642:	4505                	li	a0,1
...
0000000000002660 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    269c:	6705                	lui	a4,0x1
      *b = 99;
    269e:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff1178>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    26b6:	50e50513          	addi	a0,a0,1294 # 6bc0 <malloc+0xeac>
    26ba:	00003097          	auipc	ra,0x3
    26be:	5a2080e7          	jalr	1442(ra) # 5c5c <printf>
    exit(1);
    26c2:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2708:	4dc50513          	addi	a0,a0,1244 # 6be0 <malloc+0xecc>
    270c:	00003097          	auipc	ra,0x3
    2710:	550080e7          	jalr	1360(ra) # 5c5c <printf>
    exit(1);
    2714:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    276c:	4d850513          	addi	a0,a0,1240 # 6c40 <malloc+0xf2c>
    2770:	00003097          	auipc	ra,0x3
    2774:	4ec080e7          	jalr	1260(ra) # 5c5c <printf>
    exit(1);
    2778:	4505                	li	a0,1
    ...
    278e:	47650513          	addi	a0,a0,1142 # 6c00 <malloc+0xeec>
    2792:	00003097          	auipc	ra,0x3
    2796:	4ca080e7          	jalr	1226(ra) # 5c5c <printf>
      exit(1);
    279a:	4505                	li	a0,1
    ...
    27aa:	47a50513          	addi	a0,a0,1146 # 6c20 <malloc+0xf0c>
    27ae:	00003097          	auipc	ra,0x3
    27b2:	4ae080e7          	jalr	1198(ra) # 5c5c <printf>
    exit(1);
    27b6:	4505                	li	a0,1
...
00000000000027e6 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2848:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f1177>
  a = sbrk(0);
    284c:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    28ac:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f1177>
  ...
  if(c != a){
    ...
    28f4:	37050513          	addi	a0,a0,880 # 6c60 <malloc+0xf4c>
    28f8:	00003097          	auipc	ra,0x3
    28fc:	364080e7          	jalr	868(ra) # 5c5c <printf>
    exit(1);
    2900:	4505                	li	a0,1
    ...
    2910:	39c50513          	addi	a0,a0,924 # 6ca8 <malloc+0xf94>
    2914:	00003097          	auipc	ra,0x3
    2918:	348080e7          	jalr	840(ra) # 5c5c <printf>
    exit(1);
    291c:	4505                	li	a0,1
    ...
    2930:	39c50513          	addi	a0,a0,924 # 6cc8 <malloc+0xfb4>
    2934:	00003097          	auipc	ra,0x3
    2938:	328080e7          	jalr	808(ra) # 5c5c <printf>
    exit(1);
    293c:	4505                	li	a0,1
    ...
    2950:	3bc50513          	addi	a0,a0,956 # 6d08 <malloc+0xff4>
    2954:	00003097          	auipc	ra,0x3
    2958:	308080e7          	jalr	776(ra) # 5c5c <printf>
    exit(1);
    295c:	4505                	li	a0,1
    ...
    296c:	3d050513          	addi	a0,a0,976 # 6d38 <malloc+0x1024>
    2970:	00003097          	auipc	ra,0x3
    2974:	2ec080e7          	jalr	748(ra) # 5c5c <printf>
    exit(1);
    2978:	4505                	li	a0,1
    ...
    298c:	3e850513          	addi	a0,a0,1000 # 6d70 <malloc+0x105c>
    2990:	00003097          	auipc	ra,0x3
    2994:	2cc080e7          	jalr	716(ra) # 5c5c <printf>
    exit(1);
    2998:	4505                	li	a0,1
...
00000000000029a2 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    29c6:	3d650513          	addi	a0,a0,982 # 6d98 <malloc+0x1084>
    29ca:	00003097          	auipc	ra,0x3
    29ce:	eb8080e7          	jalr	-328(ra) # 5882 <open>
    29d2:	84aa                	mv	s1,a0
  unlink("sbrk");
    29d4:	00004517          	auipc	a0,0x4
    29d8:	3c450513          	addi	a0,a0,964 # 6d98 <malloc+0x1084>
  ...
  if(pipe((int *) a) != 0){
    ...
    2a2c:	37850513          	addi	a0,a0,888 # 6da0 <malloc+0x108c>
    2a30:	00003097          	auipc	ra,0x3
    2a34:	22c080e7          	jalr	556(ra) # 5c5c <printf>
    exit(1);
    2a38:	4505                	li	a0,1
    ...
    2a48:	37450513          	addi	a0,a0,884 # 6db8 <malloc+0x10a4>
    2a4c:	00003097          	auipc	ra,0x3
    2a50:	210080e7          	jalr	528(ra) # 5c5c <printf>
    exit(1);
    2a54:	4505                	li	a0,1
    ...
    2a64:	d3850513          	addi	a0,a0,-712 # 6798 <malloc+0xa84>
    2a68:	00003097          	auipc	ra,0x3
    2a6c:	1f4080e7          	jalr	500(ra) # 5c5c <printf>
    exit(1);
    2a70:	4505                	li	a0,1
...
0000000000002a7a <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2a8e:	34650513          	addi	a0,a0,838 # 6dd0 <malloc+0x10bc>
  ...
  close(fd);
    ...
    2ad6:	bd650513          	addi	a0,a0,-1066 # 66a8 <malloc+0x994>
    2ada:	00003097          	auipc	ra,0x3
    2ade:	182080e7          	jalr	386(ra) # 5c5c <printf>
    exit(1);
    2ae2:	4505                	li	a0,1
...
0000000000002aec <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2b24:	f9050513          	addi	a0,a0,-112 # 6ab0 <malloc+0xd9c>
    2b28:	00003097          	auipc	ra,0x3
    2b2c:	134080e7          	jalr	308(ra) # 5c5c <printf>
    exit(1);
    2b30:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2b7a:	f3a50513          	addi	a0,a0,-198 # 6ab0 <malloc+0xd9c>
    2b7e:	00003097          	auipc	ra,0x3
    2b82:	0de080e7          	jalr	222(ra) # 5c5c <printf>
    exit(1);
    2b86:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2bb2:	8007879b          	addiw	a5,a5,-2048 # a800 <uninit+0x1098>
    ...
    2bda:	eda50513          	addi	a0,a0,-294 # 6ab0 <malloc+0xd9c>
    2bde:	00003097          	auipc	ra,0x3
    2be2:	07e080e7          	jalr	126(ra) # 5c5c <printf>
    exit(1);
    2be6:	4505                	li	a0,1
...
0000000000002cd6 <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2ce2:	0511                	addi	a0,a0,4 # ffffffff80000004 <__BSS_END__+0xffffffff7fff117c>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2d4e:	d6650513          	addi	a0,a0,-666 # 6ab0 <malloc+0xd9c>
    2d52:	00003097          	auipc	ra,0x3
    2d56:	f0a080e7          	jalr	-246(ra) # 5c5c <printf>
      exit(1);
    2d5a:	4505                	li	a0,1
    ...
    2da2:	09a50513          	addi	a0,a0,154 # 5e38 <malloc+0x124>
    2da6:	faa43c23          	sd	a0,-72(s0)
    2daa:	00003797          	auipc	a5,0x3
    2dae:	0fe78793          	addi	a5,a5,254 # 5ea8 <malloc+0x194>
...
0000000000002dd0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2de0:	1cc50513          	addi	a0,a0,460 # 6fa8 <malloc+0x1294>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2df2:	01250513          	addi	a0,a0,18 # 6e00 <malloc+0x10ec>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2e08:	05450513          	addi	a0,a0,84 # 6e58 <malloc+0x1144>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2e26:	0ae50513          	addi	a0,a0,174 # 6ed0 <malloc+0x11bc>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2e42:	10250513          	addi	a0,a0,258 # 6f40 <malloc+0x122c>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2e54:	14850513          	addi	a0,a0,328 # 6f98 <malloc+0x1284>
  ...
  unlink("12345678901234");
    ...
    2ed2:	f0a50513          	addi	a0,a0,-246 # 6dd8 <malloc+0x10c4>
    2ed6:	00003097          	auipc	ra,0x3
    2eda:	d86080e7          	jalr	-634(ra) # 5c5c <printf>
    exit(1);
    2ede:	4505                	li	a0,1
    ...
    2eee:	f3650513          	addi	a0,a0,-202 # 6e20 <malloc+0x110c>
    2ef2:	00003097          	auipc	ra,0x3
    2ef6:	d6a080e7          	jalr	-662(ra) # 5c5c <printf>
    exit(1);
    2efa:	4505                	li	a0,1
    ...
    2f0a:	f8250513          	addi	a0,a0,-126 # 6e88 <malloc+0x1174>
    2f0e:	00003097          	auipc	ra,0x3
    2f12:	d4e080e7          	jalr	-690(ra) # 5c5c <printf>
    exit(1);
    2f16:	4505                	li	a0,1
    ...
    2f26:	fde50513          	addi	a0,a0,-34 # 6f00 <malloc+0x11ec>
    2f2a:	00003097          	auipc	ra,0x3
    2f2e:	d32080e7          	jalr	-718(ra) # 5c5c <printf>
    exit(1);
    2f32:	4505                	li	a0,1
    ...
    2f42:	02250513          	addi	a0,a0,34 # 6f60 <malloc+0x124c>
    2f46:	00003097          	auipc	ra,0x3
    2f4a:	d16080e7          	jalr	-746(ra) # 5c5c <printf>
    exit(1);
    2f4e:	4505                	li	a0,1
    ...
    2f5e:	05e50513          	addi	a0,a0,94 # 6fb8 <malloc+0x12a4>
    2f62:	00003097          	auipc	ra,0x3
    2f66:	cfa080e7          	jalr	-774(ra) # 5c5c <printf>
    exit(1);
    2f6a:	4505                	li	a0,1
...
0000000000002f74 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2f84:	07050513          	addi	a0,a0,112 # 6ff0 <malloc+0x12dc>
  ...
  if(chdir("iputdir") < 0){
    ...
    2f98:	05c50513          	addi	a0,a0,92 # 6ff0 <malloc+0x12dc>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2fac:	08850513          	addi	a0,a0,136 # 7030 <malloc+0x131c>
  ...
  if(chdir("/") < 0){
    ...
    2fc0:	0a450513          	addi	a0,a0,164 # 7060 <malloc+0x134c>
    ...
    2fe0:	01c50513          	addi	a0,a0,28 # 6ff8 <malloc+0x12e4>
    2fe4:	00003097          	auipc	ra,0x3
    2fe8:	c78080e7          	jalr	-904(ra) # 5c5c <printf>
    exit(1);
    2fec:	4505                	li	a0,1
    ...
    2ffc:	01850513          	addi	a0,a0,24 # 7010 <malloc+0x12fc>
    3000:	00003097          	auipc	ra,0x3
    3004:	c5c080e7          	jalr	-932(ra) # 5c5c <printf>
    exit(1);
    3008:	4505                	li	a0,1
    ...
    3018:	02c50513          	addi	a0,a0,44 # 7040 <malloc+0x132c>
    301c:	00003097          	auipc	ra,0x3
    3020:	c40080e7          	jalr	-960(ra) # 5c5c <printf>
    exit(1);
    3024:	4505                	li	a0,1
    ...
    3034:	03850513          	addi	a0,a0,56 # 7068 <malloc+0x1354>
    3038:	00003097          	auipc	ra,0x3
    303c:	c24080e7          	jalr	-988(ra) # 5c5c <printf>
    exit(1);
    3040:	4505                	li	a0,1
...
000000000000304a <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    3068:	f8c50513          	addi	a0,a0,-116 # 6ff0 <malloc+0x12dc>
    ...
    307c:	f7850513          	addi	a0,a0,-136 # 6ff0 <malloc+0x12dc>
    ...
    3090:	fa450513          	addi	a0,a0,-92 # 7030 <malloc+0x131c>
    ...
    30b0:	5e450513          	addi	a0,a0,1508 # 6690 <malloc+0x97c>
    30b4:	00003097          	auipc	ra,0x3
    30b8:	ba8080e7          	jalr	-1112(ra) # 5c5c <printf>
    exit(1);
    30bc:	4505                	li	a0,1
    ...
    30cc:	f3050513          	addi	a0,a0,-208 # 6ff8 <malloc+0x12e4>
    30d0:	00003097          	auipc	ra,0x3
    30d4:	b8c080e7          	jalr	-1140(ra) # 5c5c <printf>
      exit(1);
    30d8:	4505                	li	a0,1
    ...
    30e8:	f9c50513          	addi	a0,a0,-100 # 7080 <malloc+0x136c>
    30ec:	00003097          	auipc	ra,0x3
    30f0:	b70080e7          	jalr	-1168(ra) # 5c5c <printf>
      exit(1);
    30f4:	4505                	li	a0,1
    ...
    3104:	f4050513          	addi	a0,a0,-192 # 7040 <malloc+0x132c>
    3108:	00003097          	auipc	ra,0x3
    310c:	b54080e7          	jalr	-1196(ra) # 5c5c <printf>
      exit(1);
    3110:	4505                	li	a0,1
...
0000000000003132 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    3142:	f5a50513          	addi	a0,a0,-166 # 7098 <malloc+0x1384>
  ...
  if(chdir("dir0") < 0){
    ...
    3156:	f4650513          	addi	a0,a0,-186 # 7098 <malloc+0x1384>
  ...
  if(chdir("..") < 0){
    ...
    316a:	f5250513          	addi	a0,a0,-174 # 70b8 <malloc+0x13a4>
  ...
  if(unlink("dir0") < 0){
    ...
    317e:	f1e50513          	addi	a0,a0,-226 # 7098 <malloc+0x1384>
    ...
    319e:	e5e50513          	addi	a0,a0,-418 # 6ff8 <malloc+0x12e4>
    31a2:	00003097          	auipc	ra,0x3
    31a6:	aba080e7          	jalr	-1350(ra) # 5c5c <printf>
    exit(1);
    31aa:	4505                	li	a0,1
    ...
    31ba:	eea50513          	addi	a0,a0,-278 # 70a0 <malloc+0x138c>
    31be:	00003097          	auipc	ra,0x3
    31c2:	a9e080e7          	jalr	-1378(ra) # 5c5c <printf>
    exit(1);
    31c6:	4505                	li	a0,1
    ...
    31d6:	eee50513          	addi	a0,a0,-274 # 70c0 <malloc+0x13ac>
    31da:	00003097          	auipc	ra,0x3
    31de:	a82080e7          	jalr	-1406(ra) # 5c5c <printf>
    exit(1);
    31e2:	4505                	li	a0,1
    ...
    31f2:	eea50513          	addi	a0,a0,-278 # 70d8 <malloc+0x13c4>
    31f6:	00003097          	auipc	ra,0x3
    31fa:	a66080e7          	jalr	-1434(ra) # 5c5c <printf>
    exit(1);
    31fe:	4505                	li	a0,1
...
0000000000003208 <subdir>:
{
  ...
  unlink("ff");
    ...
    321a:	00a50513          	addi	a0,a0,10 # 7220 <malloc+0x150c>
    321e:	00002097          	auipc	ra,0x2
    3222:	674080e7          	jalr	1652(ra) # 5892 <unlink>
  if(mkdir("dd") != 0){
    3226:	00004517          	auipc	a0,0x4
    322a:	eca50513          	addi	a0,a0,-310 # 70f0 <malloc+0x13dc>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3242:	ed250513          	addi	a0,a0,-302 # 7110 <malloc+0x13fc>
  ...
  write(fd, "ff", 2);
    ...
    325a:	fca58593          	addi	a1,a1,-54 # 7220 <malloc+0x150c>
  ...
  if(unlink("dd") >= 0){
    ...
    3274:	e8050513          	addi	a0,a0,-384 # 70f0 <malloc+0x13dc>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3288:	ee450513          	addi	a0,a0,-284 # 7168 <malloc+0x1454>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32a0:	ef450513          	addi	a0,a0,-268 # 7190 <malloc+0x147c>
  ...
  write(fd, "FF", 2);
    ...
    32b8:	f0c58593          	addi	a1,a1,-244 # 71c0 <malloc+0x14ac>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    32d4:	ef850513          	addi	a0,a0,-264 # 71c8 <malloc+0x14b4>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    32ec:	b9058593          	addi	a1,a1,-1136 # be78 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3302:	b7a74703          	lbu	a4,-1158(a4) # be78 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    331c:	f0058593          	addi	a1,a1,-256 # 7218 <malloc+0x1504>
    3320:	00004517          	auipc	a0,0x4
    3324:	e7050513          	addi	a0,a0,-400 # 7190 <malloc+0x147c>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3338:	e5c50513          	addi	a0,a0,-420 # 7190 <malloc+0x147c>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    334e:	e4650513          	addi	a0,a0,-442 # 7190 <malloc+0x147c>
  ...
  if(chdir("dd") != 0){
    ...
    3362:	d9250513          	addi	a0,a0,-622 # 70f0 <malloc+0x13dc>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3376:	f3e50513          	addi	a0,a0,-194 # 72b0 <malloc+0x159c>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    338a:	f5a50513          	addi	a0,a0,-166 # 72e0 <malloc+0x15cc>
  ...
  if(chdir("./..") != 0){
    ...
    339e:	f7650513          	addi	a0,a0,-138 # 7310 <malloc+0x15fc>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    33b4:	e6850513          	addi	a0,a0,-408 # 7218 <malloc+0x1504>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    33cc:	ab058593          	addi	a1,a1,-1360 # be78 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    33ee:	da650513          	addi	a0,a0,-602 # 7190 <malloc+0x147c>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3406:	f9e50513          	addi	a0,a0,-98 # 73a0 <malloc+0x168c>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    341e:	fb650513          	addi	a0,a0,-74 # 73d0 <malloc+0x16bc>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3436:	cbe50513          	addi	a0,a0,-834 # 70f0 <malloc+0x13dc>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    344c:	ca850513          	addi	a0,a0,-856 # 70f0 <malloc+0x13dc>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3462:	c9250513          	addi	a0,a0,-878 # 70f0 <malloc+0x13dc>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3476:	fee58593          	addi	a1,a1,-18 # 7460 <malloc+0x174c>
    347a:	00004517          	auipc	a0,0x4
    347e:	f2650513          	addi	a0,a0,-218 # 73a0 <malloc+0x168c>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3492:	fd258593          	addi	a1,a1,-46 # 7460 <malloc+0x174c>
    3496:	00004517          	auipc	a0,0x4
    349a:	f3a50513          	addi	a0,a0,-198 # 73d0 <malloc+0x16bc>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    34ae:	d6e58593          	addi	a1,a1,-658 # 7218 <malloc+0x1504>
    34b2:	00004517          	auipc	a0,0x4
    34b6:	c5e50513          	addi	a0,a0,-930 # 7110 <malloc+0x13fc>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    34ca:	eda50513          	addi	a0,a0,-294 # 73a0 <malloc+0x168c>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    34de:	ef650513          	addi	a0,a0,-266 # 73d0 <malloc+0x16bc>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    34f2:	d2a50513          	addi	a0,a0,-726 # 7218 <malloc+0x1504>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3506:	ece50513          	addi	a0,a0,-306 # 73d0 <malloc+0x16bc>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    351a:	e8a50513          	addi	a0,a0,-374 # 73a0 <malloc+0x168c>
  ...
  if(chdir("dd/ff") == 0){
    ...
    352e:	be650513          	addi	a0,a0,-1050 # 7110 <malloc+0x13fc>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3542:	07250513          	addi	a0,a0,114 # 75b0 <malloc+0x189c>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3556:	cc650513          	addi	a0,a0,-826 # 7218 <malloc+0x1504>
  ...
  if(unlink("dd/ff") != 0){
    ...
    356a:	baa50513          	addi	a0,a0,-1110 # 7110 <malloc+0x13fc>
  ...
  if(unlink("dd") == 0){
    ...
    357e:	b7650513          	addi	a0,a0,-1162 # 70f0 <malloc+0x13dc>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3592:	09250513          	addi	a0,a0,146 # 7620 <malloc+0x190c>
  ...
  if(unlink("dd") < 0){
    ...
    35a6:	b4e50513          	addi	a0,a0,-1202 # 70f0 <malloc+0x13dc>
    ...
    35c8:	b3450513          	addi	a0,a0,-1228 # 70f8 <malloc+0x13e4>
    35cc:	00002097          	auipc	ra,0x2
    35d0:	690080e7          	jalr	1680(ra) # 5c5c <printf>
    exit(1);
    35d4:	4505                	li	a0,1
    ...
    35e4:	b3850513          	addi	a0,a0,-1224 # 7118 <malloc+0x1404>
    35e8:	00002097          	auipc	ra,0x2
    35ec:	674080e7          	jalr	1652(ra) # 5c5c <printf>
    exit(1);
    35f0:	4505                	li	a0,1
    ...
    3600:	b3c50513          	addi	a0,a0,-1220 # 7138 <malloc+0x1424>
    3604:	00002097          	auipc	ra,0x2
    3608:	658080e7          	jalr	1624(ra) # 5c5c <printf>
    exit(1);
    360c:	4505                	li	a0,1
    ...
    361c:	b5850513          	addi	a0,a0,-1192 # 7170 <malloc+0x145c>
    3620:	00002097          	auipc	ra,0x2
    3624:	63c080e7          	jalr	1596(ra) # 5c5c <printf>
    exit(1);
    3628:	4505                	li	a0,1
    ...
    3638:	b6c50513          	addi	a0,a0,-1172 # 71a0 <malloc+0x148c>
    363c:	00002097          	auipc	ra,0x2
    3640:	620080e7          	jalr	1568(ra) # 5c5c <printf>
    exit(1);
    3644:	4505                	li	a0,1
    ...
    3654:	b8850513          	addi	a0,a0,-1144 # 71d8 <malloc+0x14c4>
    3658:	00002097          	auipc	ra,0x2
    365c:	604080e7          	jalr	1540(ra) # 5c5c <printf>
    exit(1);
    3660:	4505                	li	a0,1
    ...
    3670:	b8c50513          	addi	a0,a0,-1140 # 71f8 <malloc+0x14e4>
    3674:	00002097          	auipc	ra,0x2
    3678:	5e8080e7          	jalr	1512(ra) # 5c5c <printf>
    exit(1);
    367c:	4505                	li	a0,1
    ...
    368c:	ba050513          	addi	a0,a0,-1120 # 7228 <malloc+0x1514>
    3690:	00002097          	auipc	ra,0x2
    3694:	5cc080e7          	jalr	1484(ra) # 5c5c <printf>
    exit(1);
    3698:	4505                	li	a0,1
    ...
    36a8:	bac50513          	addi	a0,a0,-1108 # 7250 <malloc+0x153c>
    36ac:	00002097          	auipc	ra,0x2
    36b0:	5b0080e7          	jalr	1456(ra) # 5c5c <printf>
    exit(1);
    36b4:	4505                	li	a0,1
    ...
    36c4:	bb050513          	addi	a0,a0,-1104 # 7270 <malloc+0x155c>
    36c8:	00002097          	auipc	ra,0x2
    36cc:	594080e7          	jalr	1428(ra) # 5c5c <printf>
    exit(1);
    36d0:	4505                	li	a0,1
    ...
    36e0:	bbc50513          	addi	a0,a0,-1092 # 7298 <malloc+0x1584>
    36e4:	00002097          	auipc	ra,0x2
    36e8:	578080e7          	jalr	1400(ra) # 5c5c <printf>
    exit(1);
    36ec:	4505                	li	a0,1
    ...
    36fc:	bc850513          	addi	a0,a0,-1080 # 72c0 <malloc+0x15ac>
    3700:	00002097          	auipc	ra,0x2
    3704:	55c080e7          	jalr	1372(ra) # 5c5c <printf>
    exit(1);
    3708:	4505                	li	a0,1
    ...
    3718:	bdc50513          	addi	a0,a0,-1060 # 72f0 <malloc+0x15dc>
    371c:	00002097          	auipc	ra,0x2
    3720:	540080e7          	jalr	1344(ra) # 5c5c <printf>
    exit(1);
    3724:	4505                	li	a0,1
    ...
    3734:	be850513          	addi	a0,a0,-1048 # 7318 <malloc+0x1604>
    3738:	00002097          	auipc	ra,0x2
    373c:	524080e7          	jalr	1316(ra) # 5c5c <printf>
    exit(1);
    3740:	4505                	li	a0,1
    ...
    3750:	be450513          	addi	a0,a0,-1052 # 7330 <malloc+0x161c>
    3754:	00002097          	auipc	ra,0x2
    3758:	508080e7          	jalr	1288(ra) # 5c5c <printf>
    exit(1);
    375c:	4505                	li	a0,1
    ...
    376c:	be850513          	addi	a0,a0,-1048 # 7350 <malloc+0x163c>
    3770:	00002097          	auipc	ra,0x2
    3774:	4ec080e7          	jalr	1260(ra) # 5c5c <printf>
    exit(1);
    3778:	4505                	li	a0,1
    ...
    3788:	bec50513          	addi	a0,a0,-1044 # 7370 <malloc+0x165c>
    378c:	00002097          	auipc	ra,0x2
    3790:	4d0080e7          	jalr	1232(ra) # 5c5c <printf>
    exit(1);
    3794:	4505                	li	a0,1
    ...
    37a4:	c1050513          	addi	a0,a0,-1008 # 73b0 <malloc+0x169c>
    37a8:	00002097          	auipc	ra,0x2
    37ac:	4b4080e7          	jalr	1204(ra) # 5c5c <printf>
    exit(1);
    37b0:	4505                	li	a0,1
    ...
    37c0:	c2450513          	addi	a0,a0,-988 # 73e0 <malloc+0x16cc>
    37c4:	00002097          	auipc	ra,0x2
    37c8:	498080e7          	jalr	1176(ra) # 5c5c <printf>
    exit(1);
    37cc:	4505                	li	a0,1
    ...
    37dc:	c2850513          	addi	a0,a0,-984 # 7400 <malloc+0x16ec>
    37e0:	00002097          	auipc	ra,0x2
    37e4:	47c080e7          	jalr	1148(ra) # 5c5c <printf>
    exit(1);
    37e8:	4505                	li	a0,1
    ...
    37f8:	c2c50513          	addi	a0,a0,-980 # 7420 <malloc+0x170c>
    37fc:	00002097          	auipc	ra,0x2
    3800:	460080e7          	jalr	1120(ra) # 5c5c <printf>
    exit(1);
    3804:	4505                	li	a0,1
    ...
    3814:	c3050513          	addi	a0,a0,-976 # 7440 <malloc+0x172c>
    3818:	00002097          	auipc	ra,0x2
    381c:	444080e7          	jalr	1092(ra) # 5c5c <printf>
    exit(1);
    3820:	4505                	li	a0,1
    ...
    3830:	c4450513          	addi	a0,a0,-956 # 7470 <malloc+0x175c>
    3834:	00002097          	auipc	ra,0x2
    3838:	428080e7          	jalr	1064(ra) # 5c5c <printf>
    exit(1);
    383c:	4505                	li	a0,1
    ...
    384c:	c5050513          	addi	a0,a0,-944 # 7498 <malloc+0x1784>
    3850:	00002097          	auipc	ra,0x2
    3854:	40c080e7          	jalr	1036(ra) # 5c5c <printf>
    exit(1);
    3858:	4505                	li	a0,1
    ...
    3868:	c5c50513          	addi	a0,a0,-932 # 74c0 <malloc+0x17ac>
    386c:	00002097          	auipc	ra,0x2
    3870:	3f0080e7          	jalr	1008(ra) # 5c5c <printf>
    exit(1);
    3874:	4505                	li	a0,1
    ...
    3884:	c6850513          	addi	a0,a0,-920 # 74e8 <malloc+0x17d4>
    3888:	00002097          	auipc	ra,0x2
    388c:	3d4080e7          	jalr	980(ra) # 5c5c <printf>
    exit(1);
    3890:	4505                	li	a0,1
    ...
    38a0:	c6c50513          	addi	a0,a0,-916 # 7508 <malloc+0x17f4>
    38a4:	00002097          	auipc	ra,0x2
    38a8:	3b8080e7          	jalr	952(ra) # 5c5c <printf>
    exit(1);
    38ac:	4505                	li	a0,1
    ...
    38bc:	c7050513          	addi	a0,a0,-912 # 7528 <malloc+0x1814>
    38c0:	00002097          	auipc	ra,0x2
    38c4:	39c080e7          	jalr	924(ra) # 5c5c <printf>
    exit(1);
    38c8:	4505                	li	a0,1
    ...
    38d8:	c7c50513          	addi	a0,a0,-900 # 7550 <malloc+0x183c>
    38dc:	00002097          	auipc	ra,0x2
    38e0:	380080e7          	jalr	896(ra) # 5c5c <printf>
    exit(1);
    38e4:	4505                	li	a0,1
    ...
    38f4:	c8050513          	addi	a0,a0,-896 # 7570 <malloc+0x185c>
    38f8:	00002097          	auipc	ra,0x2
    38fc:	364080e7          	jalr	868(ra) # 5c5c <printf>
    exit(1);
    3900:	4505                	li	a0,1
    ...
    3910:	c8450513          	addi	a0,a0,-892 # 7590 <malloc+0x187c>
    3914:	00002097          	auipc	ra,0x2
    3918:	348080e7          	jalr	840(ra) # 5c5c <printf>
    exit(1);
    391c:	4505                	li	a0,1
    ...
    392c:	c9050513          	addi	a0,a0,-880 # 75b8 <malloc+0x18a4>
    3930:	00002097          	auipc	ra,0x2
    3934:	32c080e7          	jalr	812(ra) # 5c5c <printf>
    exit(1);
    3938:	4505                	li	a0,1
    ...
    3948:	90c50513          	addi	a0,a0,-1780 # 7250 <malloc+0x153c>
    394c:	00002097          	auipc	ra,0x2
    3950:	310080e7          	jalr	784(ra) # 5c5c <printf>
    exit(1);
    3954:	4505                	li	a0,1
    ...
    3964:	c7850513          	addi	a0,a0,-904 # 75d8 <malloc+0x18c4>
    3968:	00002097          	auipc	ra,0x2
    396c:	2f4080e7          	jalr	756(ra) # 5c5c <printf>
    exit(1);
    3970:	4505                	li	a0,1
    ...
    3980:	c7c50513          	addi	a0,a0,-900 # 75f8 <malloc+0x18e4>
    3984:	00002097          	auipc	ra,0x2
    3988:	2d8080e7          	jalr	728(ra) # 5c5c <printf>
    exit(1);
    398c:	4505                	li	a0,1
    ...
    399c:	c9050513          	addi	a0,a0,-880 # 7628 <malloc+0x1914>
    39a0:	00002097          	auipc	ra,0x2
    39a4:	2bc080e7          	jalr	700(ra) # 5c5c <printf>
    exit(1);
    39a8:	4505                	li	a0,1
    ...
    39b8:	c9450513          	addi	a0,a0,-876 # 7648 <malloc+0x1934>
    39bc:	00002097          	auipc	ra,0x2
    39c0:	2a0080e7          	jalr	672(ra) # 5c5c <printf>
    exit(1);
    39c4:	4505                	li	a0,1
...
00000000000039ce <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    39de:	c8650513          	addi	a0,a0,-890 # 7660 <malloc+0x194c>
  ...
  if(chdir("dots") != 0){
    ...
    39f0:	c7450513          	addi	a0,a0,-908 # 7660 <malloc+0x194c>
  ...
  if(unlink(".") == 0){
    ...
    3a02:	af250513          	addi	a0,a0,-1294 # 64f0 <malloc+0x7dc>
  ...
  if(unlink("..") == 0){
    ...
    3a14:	6a850513          	addi	a0,a0,1704 # 70b8 <malloc+0x13a4>
  ...
  if(chdir("/") != 0){
    ...
    3a26:	63e50513          	addi	a0,a0,1598 # 7060 <malloc+0x134c>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a38:	c9450513          	addi	a0,a0,-876 # 76c8 <malloc+0x19b4>
  ...
  if(unlink("dots/..") == 0){
    ...
    3a4a:	caa50513          	addi	a0,a0,-854 # 76f0 <malloc+0x19dc>
  ...
  if(unlink("dots") != 0){
    ...
    3a5c:	c0850513          	addi	a0,a0,-1016 # 7660 <malloc+0x194c>
    ...
    3a7a:	bf250513          	addi	a0,a0,-1038 # 7668 <malloc+0x1954>
    3a7e:	00002097          	auipc	ra,0x2
    3a82:	1de080e7          	jalr	478(ra) # 5c5c <printf>
    exit(1);
    3a86:	4505                	li	a0,1
    ...
    3a96:	bee50513          	addi	a0,a0,-1042 # 7680 <malloc+0x196c>
    3a9a:	00002097          	auipc	ra,0x2
    3a9e:	1c2080e7          	jalr	450(ra) # 5c5c <printf>
    exit(1);
    3aa2:	4505                	li	a0,1
    ...
    3ab2:	bea50513          	addi	a0,a0,-1046 # 7698 <malloc+0x1984>
    3ab6:	00002097          	auipc	ra,0x2
    3aba:	1a6080e7          	jalr	422(ra) # 5c5c <printf>
    exit(1);
    3abe:	4505                	li	a0,1
    ...
    3ace:	be650513          	addi	a0,a0,-1050 # 76b0 <malloc+0x199c>
    3ad2:	00002097          	auipc	ra,0x2
    3ad6:	18a080e7          	jalr	394(ra) # 5c5c <printf>
    exit(1);
    3ada:	4505                	li	a0,1
    ...
    3aea:	58250513          	addi	a0,a0,1410 # 7068 <malloc+0x1354>
    3aee:	00002097          	auipc	ra,0x2
    3af2:	16e080e7          	jalr	366(ra) # 5c5c <printf>
    exit(1);
    3af6:	4505                	li	a0,1
    ...
    3b06:	bce50513          	addi	a0,a0,-1074 # 76d0 <malloc+0x19bc>
    3b0a:	00002097          	auipc	ra,0x2
    3b0e:	152080e7          	jalr	338(ra) # 5c5c <printf>
    exit(1);
    3b12:	4505                	li	a0,1
    ...
    3b22:	bda50513          	addi	a0,a0,-1062 # 76f8 <malloc+0x19e4>
    3b26:	00002097          	auipc	ra,0x2
    3b2a:	136080e7          	jalr	310(ra) # 5c5c <printf>
    exit(1);
    3b2e:	4505                	li	a0,1
    ...
    3b3e:	bde50513          	addi	a0,a0,-1058 # 7718 <malloc+0x1a04>
    3b42:	00002097          	auipc	ra,0x2
    3b46:	11a080e7          	jalr	282(ra) # 5c5c <printf>
    exit(1);
    3b4a:	4505                	li	a0,1
...
0000000000003b54 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3b6a:	bd250513          	addi	a0,a0,-1070 # 7738 <malloc+0x1a24>
  ...
  if(chdir("dirfile") == 0){
    ...
    3b86:	bb650513          	addi	a0,a0,-1098 # 7738 <malloc+0x1a24>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3b9a:	bea50513          	addi	a0,a0,-1046 # 7780 <malloc+0x1a6c>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3bb2:	bd250513          	addi	a0,a0,-1070 # 7780 <malloc+0x1a6c>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3bc6:	bbe50513          	addi	a0,a0,-1090 # 7780 <malloc+0x1a6c>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3bda:	baa50513          	addi	a0,a0,-1110 # 7780 <malloc+0x1a6c>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3bee:	b9658593          	addi	a1,a1,-1130 # 7780 <malloc+0x1a6c>
    3bf2:	00002517          	auipc	a0,0x2
    3bf6:	3ee50513          	addi	a0,a0,1006 # 5fe0 <malloc+0x2cc>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c0a:	b3250513          	addi	a0,a0,-1230 # 7738 <malloc+0x1a24>
  ...
  fd = open(".", O_RDWR);
    ...
    3c20:	8d450513          	addi	a0,a0,-1836 # 64f0 <malloc+0x7dc>
  ...
  fd = open(".", 0);
    ...
    3c36:	8be50513          	addi	a0,a0,-1858 # 64f0 <malloc+0x7dc>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3c4a:	26258593          	addi	a1,a1,610 # 5ea8 <malloc+0x194>
  ...
  close(fd);
    ...
    3c76:	ace50513          	addi	a0,a0,-1330 # 7740 <malloc+0x1a2c>
    3c7a:	00002097          	auipc	ra,0x2
    3c7e:	fe2080e7          	jalr	-30(ra) # 5c5c <printf>
    exit(1);
    3c82:	4505                	li	a0,1
    ...
    3c92:	ad250513          	addi	a0,a0,-1326 # 7760 <malloc+0x1a4c>
    3c96:	00002097          	auipc	ra,0x2
    3c9a:	fc6080e7          	jalr	-58(ra) # 5c5c <printf>
    exit(1);
    3c9e:	4505                	li	a0,1
    ...
    3cae:	ae650513          	addi	a0,a0,-1306 # 7790 <malloc+0x1a7c>
    3cb2:	00002097          	auipc	ra,0x2
    3cb6:	faa080e7          	jalr	-86(ra) # 5c5c <printf>
    exit(1);
    3cba:	4505                	li	a0,1
    ...
    3cca:	aca50513          	addi	a0,a0,-1334 # 7790 <malloc+0x1a7c>
    3cce:	00002097          	auipc	ra,0x2
    3cd2:	f8e080e7          	jalr	-114(ra) # 5c5c <printf>
    exit(1);
    3cd6:	4505                	li	a0,1
    ...
    3ce6:	ad650513          	addi	a0,a0,-1322 # 77b8 <malloc+0x1aa4>
    3cea:	00002097          	auipc	ra,0x2
    3cee:	f72080e7          	jalr	-142(ra) # 5c5c <printf>
    exit(1);
    3cf2:	4505                	li	a0,1
    ...
    3d02:	ae250513          	addi	a0,a0,-1310 # 77e0 <malloc+0x1acc>
    3d06:	00002097          	auipc	ra,0x2
    3d0a:	f56080e7          	jalr	-170(ra) # 5c5c <printf>
    exit(1);
    3d0e:	4505                	li	a0,1
    ...
    3d1e:	aee50513          	addi	a0,a0,-1298 # 7808 <malloc+0x1af4>
    3d22:	00002097          	auipc	ra,0x2
    3d26:	f3a080e7          	jalr	-198(ra) # 5c5c <printf>
    exit(1);
    3d2a:	4505                	li	a0,1
    ...
    3d3a:	afa50513          	addi	a0,a0,-1286 # 7830 <malloc+0x1b1c>
    3d3e:	00002097          	auipc	ra,0x2
    3d42:	f1e080e7          	jalr	-226(ra) # 5c5c <printf>
    exit(1);
    3d46:	4505                	li	a0,1
    ...
    3d56:	afe50513          	addi	a0,a0,-1282 # 7850 <malloc+0x1b3c>
    3d5a:	00002097          	auipc	ra,0x2
    3d5e:	f02080e7          	jalr	-254(ra) # 5c5c <printf>
    exit(1);
    3d62:	4505                	li	a0,1
    ...
    3d72:	b0a50513          	addi	a0,a0,-1270 # 7878 <malloc+0x1b64>
    3d76:	00002097          	auipc	ra,0x2
    3d7a:	ee6080e7          	jalr	-282(ra) # 5c5c <printf>
    exit(1);
    3d7e:	4505                	li	a0,1
...
0000000000003d88 <iref>:
{
    ...
    3da6:	aeea0a13          	addi	s4,s4,-1298 # 7890 <malloc+0x1b7c>
    mkdir("");
    3daa:	00003497          	auipc	s1,0x3
    3dae:	5ee48493          	addi	s1,s1,1518 # 7398 <malloc+0x1684>
    link("README", "");
    3db2:	00002a97          	auipc	s5,0x2
    3db6:	22ea8a93          	addi	s5,s5,558 # 5fe0 <malloc+0x2cc>
    fd = open("xx", O_CREATE);
    3dba:	00004997          	auipc	s3,0x4
    3dbe:	9ce98993          	addi	s3,s3,-1586 # 7788 <malloc+0x1a74>
    3dc2:	a891                	j	3e16 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3dc4:	85da                	mv	a1,s6
    3dc6:	00004517          	auipc	a0,0x4
    3dca:	ad250513          	addi	a0,a0,-1326 # 7898 <malloc+0x1b84>
    3dce:	00002097          	auipc	ra,0x2
    3dd2:	e8e080e7          	jalr	-370(ra) # 5c5c <printf>
      exit(1);
    3dd6:	4505                	li	a0,1
    ...
    3de6:	ace50513          	addi	a0,a0,-1330 # 78b0 <malloc+0x1b9c>
    3dea:	00002097          	auipc	ra,0x2
    3dee:	e72080e7          	jalr	-398(ra) # 5c5c <printf>
      exit(1);
    3df2:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3e7a:	24298993          	addi	s3,s3,578 # 70b8 <malloc+0x13a4>
    unlink("irefd");
    3e7e:	00004917          	auipc	s2,0x4
    3e82:	a1290913          	addi	s2,s2,-1518 # 7890 <malloc+0x1b7c>
    chdir("..");
    3e86:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3ea2:	1c250513          	addi	a0,a0,450 # 7060 <malloc+0x134c>
...
0000000000003ec2 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3ed2:	9fa50513          	addi	a0,a0,-1542 # 78c8 <malloc+0x1bb4>
  ...
  if(pid == 0){
    ...
    3ef6:	9d650513          	addi	a0,a0,-1578 # 78c8 <malloc+0x1bb4>
    ...
    3f0c:	9e050513          	addi	a0,a0,-1568 # 78e8 <malloc+0x1bd4>
    3f10:	00002097          	auipc	ra,0x2
    3f14:	d4c080e7          	jalr	-692(ra) # 5c5c <printf>
      exit(1);
    3f18:	4505                	li	a0,1
    ...
    3f28:	9ac50513          	addi	a0,a0,-1620 # 78d0 <malloc+0x1bbc>
    3f2c:	00002097          	auipc	ra,0x2
    3f30:	d30080e7          	jalr	-720(ra) # 5c5c <printf>
    exit(1);
    3f34:	4505                	li	a0,1
    ...
    3f44:	75050513          	addi	a0,a0,1872 # 6690 <malloc+0x97c>
    3f48:	00002097          	auipc	ra,0x2
    3f4c:	d14080e7          	jalr	-748(ra) # 5c5c <printf>
    exit(1);
    3f50:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3f72:	95a50513          	addi	a0,a0,-1702 # 78c8 <malloc+0x1bb4>
    ...
    3f86:	8fe50513          	addi	a0,a0,-1794 # 6880 <malloc+0xb6c>
    3f8a:	00002097          	auipc	ra,0x2
    3f8e:	cd2080e7          	jalr	-814(ra) # 5c5c <printf>
    exit(1);
    3f92:	4505                	li	a0,1
...
0000000000003fb4 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3fc4:	95050513          	addi	a0,a0,-1712 # 7910 <malloc+0x1bfc>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ff0:	92450513          	addi	a0,a0,-1756 # 7910 <malloc+0x1bfc>
  ...
  sleep(10); // one second
    ...
    4028:	82c50513          	addi	a0,a0,-2004 # 6850 <malloc+0xb3c>
    402c:	00002097          	auipc	ra,0x2
    4030:	c30080e7          	jalr	-976(ra) # 5c5c <printf>
    exit(1);
    4034:	4505                	li	a0,1
    ...
    4042:	8d248493          	addi	s1,s1,-1838 # 7910 <malloc+0x1bfc>
    4046:	4581                	li	a1,0
    4048:	8526                	mv	a0,s1
...
0000000000004084 <killstatus>:
{
  ...
  exit(0);
    ...
    40ea:	5aa50513          	addi	a0,a0,1450 # 6690 <malloc+0x97c>
    40ee:	00002097          	auipc	ra,0x2
    40f2:	b6e080e7          	jalr	-1170(ra) # 5c5c <printf>
      exit(1);
    40f6:	4505                	li	a0,1
    ...
    4110:	81450513          	addi	a0,a0,-2028 # 7920 <malloc+0x1c0c>
    4114:	00002097          	auipc	ra,0x2
    4118:	b48080e7          	jalr	-1208(ra) # 5c5c <printf>
       exit(1);
    411c:	4505                	li	a0,1
...
0000000000004126 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    4150:	70450513          	addi	a0,a0,1796 # 6850 <malloc+0xb3c>
    4154:	00002097          	auipc	ra,0x2
    4158:	b08080e7          	jalr	-1272(ra) # 5c5c <printf>
    exit(1);
    415c:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    417e:	51650513          	addi	a0,a0,1302 # 6690 <malloc+0x97c>
    4182:	00002097          	auipc	ra,0x2
    4186:	ada080e7          	jalr	-1318(ra) # 5c5c <printf>
    exit(1);
    418a:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    41c2:	cea58593          	addi	a1,a1,-790 # 5ea8 <malloc+0x194>
    ...
    41ec:	4a850513          	addi	a0,a0,1192 # 6690 <malloc+0x97c>
    41f0:	00002097          	auipc	ra,0x2
    41f4:	a6c080e7          	jalr	-1428(ra) # 5c5c <printf>
     exit(1);
    41f8:	4505                	li	a0,1
    ...
    4208:	73c50513          	addi	a0,a0,1852 # 7940 <malloc+0x1c2c>
    420c:	00002097          	auipc	ra,0x2
    4210:	a50080e7          	jalr	-1456(ra) # 5c5c <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4228:	c5458593          	addi	a1,a1,-940 # be78 <buf>
    ...
    4244:	71850513          	addi	a0,a0,1816 # 7958 <malloc+0x1c44>
    4248:	00002097          	auipc	ra,0x2
    424c:	a14080e7          	jalr	-1516(ra) # 5c5c <printf>
}
  ...
  printf("kill... ");
    ...
    4270:	70450513          	addi	a0,a0,1796 # 7970 <malloc+0x1c5c>
    4274:	00002097          	auipc	ra,0x2
    4278:	9e8080e7          	jalr	-1560(ra) # 5c5c <printf>
  kill(pid1);
    427c:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    429e:	6e650513          	addi	a0,a0,1766 # 7980 <malloc+0x1c6c>
    42a2:	00002097          	auipc	ra,0x2
    42a6:	9ba080e7          	jalr	-1606(ra) # 5c5c <printf>
  wait(0);
    42aa:	4501                	li	a0,0
...
00000000000042ca <reparent>:
{
  ...
  exit(0);
    ...
    431e:	37650513          	addi	a0,a0,886 # 6690 <malloc+0x97c>
    4322:	00002097          	auipc	ra,0x2
    4326:	93a080e7          	jalr	-1734(ra) # 5c5c <printf>
      exit(1);
    432a:	4505                	li	a0,1
    ...
    433a:	4e250513          	addi	a0,a0,1250 # 6818 <malloc+0xb04>
    433e:	00002097          	auipc	ra,0x2
    4342:	91e080e7          	jalr	-1762(ra) # 5c5c <printf>
        exit(1);
    4346:	4505                	li	a0,1
...
000000000000437a <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    43b0:	3ec50513          	addi	a0,a0,1004 # 6798 <malloc+0xa84>
    43b4:	00002097          	auipc	ra,0x2
    43b8:	8a8080e7          	jalr	-1880(ra) # 5c5c <printf>
    exit(1);
    43bc:	4505                	li	a0,1
    ...
    43e4:	ac858593          	addi	a1,a1,-1336 # 5ea8 <malloc+0x194>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    44a8:	4ec50513          	addi	a0,a0,1260 # 7990 <malloc+0x1c7c>
    44ac:	00001097          	auipc	ra,0x1
    44b0:	7b0080e7          	jalr	1968(ra) # 5c5c <printf>
    exit(1);
    44b4:	4505                	li	a0,1
    ...
    44c4:	1d050513          	addi	a0,a0,464 # 6690 <malloc+0x97c>
    44c8:	00001097          	auipc	ra,0x1
    44cc:	794080e7          	jalr	1940(ra) # 5c5c <printf>
    exit(1);
    44d0:	4505                	li	a0,1
    ...
    44fa:	6705                	lui	a4,0x1
      n += *(a+i);
    44fc:	0007c683          	lbu	a3,0(a5) # 6400000 <__BSS_END__+0x63f1178>
    ...
    4510:	4a450513          	addi	a0,a0,1188 # 79b0 <malloc+0x1c9c>
    4514:	00001097          	auipc	ra,0x1
    4518:	748080e7          	jalr	1864(ra) # 5c5c <printf>
    exit(1);
    451c:	4505                	li	a0,1
...
0000000000004530 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    457a:	79e080e7          	jalr	1950(ra) # 5d14 <malloc>
    ...
    45b4:	43050513          	addi	a0,a0,1072 # 79e0 <malloc+0x1ccc>
    45b8:	00001097          	auipc	ra,0x1
    45bc:	6a4080e7          	jalr	1700(ra) # 5c5c <printf>
      exit(1);
    45c0:	4505                	li	a0,1
...
00000000000045d4 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    466a:	3aa50513          	addi	a0,a0,938 # 7a10 <malloc+0x1cfc>
    466e:	00001097          	auipc	ra,0x1
    4672:	5ee080e7          	jalr	1518(ra) # 5c5c <printf>
    exit(1);
    4676:	4505                	li	a0,1
    ...
    4686:	3b650513          	addi	a0,a0,950 # 7a38 <malloc+0x1d24>
    468a:	00001097          	auipc	ra,0x1
    468e:	5d2080e7          	jalr	1490(ra) # 5c5c <printf>
      exit(1);
    4692:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    46ca:	33a50513          	addi	a0,a0,826 # 7a00 <malloc+0x1cec>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    470a:	35250513          	addi	a0,a0,850 # 7a58 <malloc+0x1d44>
    470e:	00001097          	auipc	ra,0x1
    4712:	54e080e7          	jalr	1358(ra) # 5c5c <printf>
    exit(1);
    4716:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4746:	2be50513          	addi	a0,a0,702 # 7a00 <malloc+0x1cec>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    476c:	31850513          	addi	a0,a0,792 # 7a80 <malloc+0x1d6c>
    4770:	00001097          	auipc	ra,0x1
    4774:	4ec080e7          	jalr	1260(ra) # 5c5c <printf>
    exit(1);
    4778:	4505                	li	a0,1
...
000000000000478c <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    47b2:	2ea78793          	addi	a5,a5,746 # 7a98 <malloc+0x1d84>
    47b6:	f6f43823          	sd	a5,-144(s0)
    47ba:	00003797          	auipc	a5,0x3
    47be:	2e678793          	addi	a5,a5,742 # 7aa0 <malloc+0x1d8c>
    47c2:	f6f43c23          	sd	a5,-136(s0)
    47c6:	00003797          	auipc	a5,0x3
    47ca:	2e278793          	addi	a5,a5,738 # 7aa8 <malloc+0x1d94>
    47ce:	f8f43023          	sd	a5,-128(s0)
    47d2:	00003797          	auipc	a5,0x3
    47d6:	2de78793          	addi	a5,a5,734 # 7ab0 <malloc+0x1d9c>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    482e:	64ea0a13          	addi	s4,s4,1614 # be78 <buf>
    4832:	00007a97          	auipc	s5,0x7
    4836:	647a8a93          	addi	s5,s5,1607 # be79 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    484e:	26650513          	addi	a0,a0,614 # 6ab0 <malloc+0xd9c>
    4852:	00001097          	auipc	ra,0x1
    4856:	40a080e7          	jalr	1034(ra) # 5c5c <printf>
      exit(1);
    485a:	4505                	li	a0,1
    ...
    48ca:	1f250513          	addi	a0,a0,498 # 7ab8 <malloc+0x1da4>
    48ce:	00001097          	auipc	ra,0x1
    48d2:	38e080e7          	jalr	910(ra) # 5c5c <printf>
        exit(1);
    48d6:	4505                	li	a0,1
    ...
    48e4:	1e850513          	addi	a0,a0,488 # 7ac8 <malloc+0x1db4>
    48e8:	00001097          	auipc	ra,0x1
    48ec:	374080e7          	jalr	884(ra) # 5c5c <printf>
          exit(1);
    48f0:	4505                	li	a0,1
    ...
    490c:	1d850513          	addi	a0,a0,472 # 7ae0 <malloc+0x1dcc>
    4910:	00001097          	auipc	ra,0x1
    4914:	34c080e7          	jalr	844(ra) # 5c5c <printf>
          exit(1);
    4918:	4505                	li	a0,1
    ...
    493c:	54078793          	addi	a5,a5,1344 # be78 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    499a:	15a50513          	addi	a0,a0,346 # 7af0 <malloc+0x1ddc>
    499e:	00001097          	auipc	ra,0x1
    49a2:	2be080e7          	jalr	702(ra) # 5c5c <printf>
      exit(1);
    49a6:	4505                	li	a0,1
...
00000000000049ce <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    49fc:	110b8b93          	addi	s7,s7,272 # 7b08 <malloc+0x1df4>
  for(i = 0; i < N; i++){
    ...
    4a3e:	0d650513          	addi	a0,a0,214 # 7b10 <malloc+0x1dfc>
    4a42:	00001097          	auipc	ra,0x1
    4a46:	21a080e7          	jalr	538(ra) # 5c5c <printf>
        exit(1);
    4a4a:	4505                	li	a0,1
    ...
    4a5c:	0b050513          	addi	a0,a0,176 # 7b08 <malloc+0x1df4>
  ...
  fd = open(".", 0);
    ...
    4a94:	a6050513          	addi	a0,a0,-1440 # 64f0 <malloc+0x7dc>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4b0c:	02850513          	addi	a0,a0,40 # 7b30 <malloc+0x1e1c>
    4b10:	00001097          	auipc	ra,0x1
    4b14:	14c080e7          	jalr	332(ra) # 5c5c <printf>
        exit(1);
    4b18:	4505                	li	a0,1
    ...
    4b2c:	02850513          	addi	a0,a0,40 # 7b50 <malloc+0x1e3c>
    4b30:	00001097          	auipc	ra,0x1
    4b34:	12c080e7          	jalr	300(ra) # 5c5c <printf>
        exit(1);
    4b38:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4b64:	01850513          	addi	a0,a0,24 # 7b78 <malloc+0x1e64>
    4b68:	00001097          	auipc	ra,0x1
    4b6c:	0f4080e7          	jalr	244(ra) # 5c5c <printf>
    exit(1);
    4b70:	4505                	li	a0,1
    ...
    4b80:	b1450513          	addi	a0,a0,-1260 # 6690 <malloc+0x97c>
    4b84:	00001097          	auipc	ra,0x1
    4b88:	0d8080e7          	jalr	216(ra) # 5c5c <printf>
      exit(1);
    4b8c:	4505                	li	a0,1
...
0000000000004d2a <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4d6a:	11290913          	addi	s2,s2,274 # be78 <buf>
  for(i = 0; i < N; i++){
    4d6e:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4db2:	e0250513          	addi	a0,a0,-510 # 7bb0 <malloc+0x1e9c>
  ...
  for(i = 0; ; i++){
    ...
    4dc8:	0b490913          	addi	s2,s2,180 # be78 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4e16:	dae50513          	addi	a0,a0,-594 # 7bc0 <malloc+0x1eac>
    4e1a:	00001097          	auipc	ra,0x1
    4e1e:	e42080e7          	jalr	-446(ra) # 5c5c <printf>
    exit(1);
    4e22:	4505                	li	a0,1
    ...
    4e32:	db250513          	addi	a0,a0,-590 # 7be0 <malloc+0x1ecc>
    4e36:	00001097          	auipc	ra,0x1
    4e3a:	e26080e7          	jalr	-474(ra) # 5c5c <printf>
      exit(1);
    4e3e:	4505                	li	a0,1
    ...
    4e4e:	db650513          	addi	a0,a0,-586 # 7c00 <malloc+0x1eec>
    4e52:	00001097          	auipc	ra,0x1
    4e56:	e0a080e7          	jalr	-502(ra) # 5c5c <printf>
    exit(1);
    4e5a:	4505                	li	a0,1
    ...
    4e6a:	dba50513          	addi	a0,a0,-582 # 7c20 <malloc+0x1f0c>
    4e6e:	00001097          	auipc	ra,0x1
    4e72:	dee080e7          	jalr	-530(ra) # 5c5c <printf>
      exit(1);
    4e76:	4505                	li	a0,1
    ...
    4e86:	dbe50513          	addi	a0,a0,-578 # 7c40 <malloc+0x1f2c>
    4e8a:	00001097          	auipc	ra,0x1
    4e8e:	dd2080e7          	jalr	-558(ra) # 5c5c <printf>
      exit(1);
    4e92:	4505                	li	a0,1
    ...
    4ea2:	dba50513          	addi	a0,a0,-582 # 7c58 <malloc+0x1f44>
    4ea6:	00001097          	auipc	ra,0x1
    4eaa:	db6080e7          	jalr	-586(ra) # 5c5c <printf>
      exit(1);
    4eae:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    4ed0:	ce450513          	addi	a0,a0,-796 # 7bb0 <malloc+0x1e9c>
    ...
    4ef4:	d8850513          	addi	a0,a0,-632 # 7c78 <malloc+0x1f64>
    4ef8:	00001097          	auipc	ra,0x1
    4efc:	d64080e7          	jalr	-668(ra) # 5c5c <printf>
    exit(1);
    4f00:	4505                	li	a0,1
...
0000000000004f0a <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4f2c:	d7050513          	addi	a0,a0,-656 # 7c98 <malloc+0x1f84>
    4f30:	00001097          	auipc	ra,0x1
    4f34:	d2c080e7          	jalr	-724(ra) # 5c5c <printf>
  for(nfiles = 0; ; nfiles++){
    4f38:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4f4c:	d60c8c93          	addi	s9,s9,-672 # 7ca8 <malloc+0x1f94>
    int total = 0;
    4f50:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    4f52:	00007a17          	auipc	s4,0x7
    4f56:	f26a0a13          	addi	s4,s4,-218 # be78 <buf>
    name[0] = 'f';
    ...
    4fa4:	cbc080e7          	jalr	-836(ra) # 5c5c <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    4fc6:	cf650513          	addi	a0,a0,-778 # 7cb8 <malloc+0x1fa4>
    4fca:	00001097          	auipc	ra,0x1
    4fce:	c92080e7          	jalr	-878(ra) # 5c5c <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    503c:	ca050513          	addi	a0,a0,-864 # 7cd8 <malloc+0x1fc4>
    5040:	00001097          	auipc	ra,0x1
    5044:	c1c080e7          	jalr	-996(ra) # 5c5c <printf>
}
    ...
    508c:	c4050513          	addi	a0,a0,-960 # 7cc8 <malloc+0x1fb4>
    5090:	00001097          	auipc	ra,0x1
    5094:	bcc080e7          	jalr	-1076(ra) # 5c5c <printf>
    close(fd);
    5098:	854a                	mv	a0,s2
...
00000000000050aa <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    511e:	bd650513          	addi	a0,a0,-1066 # 7cf0 <malloc+0x1fdc>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    5136:	d7658593          	addi	a1,a1,-650 # 5ea8 <malloc+0x194>
    ...
    514c:	bc850513          	addi	a0,a0,-1080 # 7d10 <malloc+0x1ffc>
    5150:	00001097          	auipc	ra,0x1
    5154:	b0c080e7          	jalr	-1268(ra) # 5c5c <printf>
    exit(1);
    5158:	4505                	li	a0,1
    ...
    5166:	b9650513          	addi	a0,a0,-1130 # 7cf8 <malloc+0x1fe4>
    516a:	00001097          	auipc	ra,0x1
    516e:	af2080e7          	jalr	-1294(ra) # 5c5c <printf>
      exit(1);
    5172:	4505                	li	a0,1
    ...
    5180:	b7c50513          	addi	a0,a0,-1156 # 7cf8 <malloc+0x1fe4>
    5184:	00001097          	auipc	ra,0x1
    5188:	ad8080e7          	jalr	-1320(ra) # 5c5c <printf>
    exit(1);
    518c:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    51a4:	b5050513          	addi	a0,a0,-1200 # 7cf0 <malloc+0x1fdc>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    51fa:	cb298993          	addi	s3,s3,-846 # 5ea8 <malloc+0x194>
      uint64 a = (uint64) sbrk(4096);
    ...
    522c:	b3850513          	addi	a0,a0,-1224 # 7d60 <malloc+0x204c>
    5230:	00001097          	auipc	ra,0x1
    5234:	a2c080e7          	jalr	-1492(ra) # 5c5c <printf>
        exit(1);
    5238:	4505                	li	a0,1
    ...
    5246:	ade50513          	addi	a0,a0,-1314 # 7d20 <malloc+0x200c>
    524a:	00001097          	auipc	ra,0x1
    524e:	a12080e7          	jalr	-1518(ra) # 5c5c <printf>
    exit(1);
    5252:	4505                	li	a0,1
    ...
    5260:	ae450513          	addi	a0,a0,-1308 # 7d40 <malloc+0x202c>
    5264:	00001097          	auipc	ra,0x1
    5268:	9f8080e7          	jalr	-1544(ra) # 5c5c <printf>
    exit(1);
    526c:	4505                	li	a0,1
  ...
  while(1){
    ...
    52ae:	ad650513          	addi	a0,a0,-1322 # 7d80 <malloc+0x206c>
    52b2:	00001097          	auipc	ra,0x1
    52b6:	9aa080e7          	jalr	-1622(ra) # 5c5c <printf>
      exit(1);
    52ba:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    52fe:	aa650513          	addi	a0,a0,-1370 # 7da0 <malloc+0x208c>
    5302:	00001097          	auipc	ra,0x1
    5306:	95a080e7          	jalr	-1702(ra) # 5c5c <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    532e:	a9e50513          	addi	a0,a0,-1378 # 7dc8 <malloc+0x20b4>
    5332:	00001097          	auipc	ra,0x1
    5336:	92a080e7          	jalr	-1750(ra) # 5c5c <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    5352:	a6250513          	addi	a0,a0,-1438 # 7db0 <malloc+0x209c>
    5356:	00001097          	auipc	ra,0x1
    535a:	906080e7          	jalr	-1786(ra) # 5c5c <printf>
    exit(1);
    535e:	4505                	li	a0,1
    ...
    537a:	a5a50513          	addi	a0,a0,-1446 # 7dd0 <malloc+0x20bc>
    537e:	00001097          	auipc	ra,0x1
    5382:	8de080e7          	jalr	-1826(ra) # 5c5c <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    53c4:	e2878793          	addi	a5,a5,-472 # 81e8 <malloc+0x24d4>
    53c8:	bd040713          	addi	a4,s0,-1072
    53cc:	00003317          	auipc	t1,0x3
    53d0:	20c30313          	addi	t1,t1,524 # 85d8 <malloc+0x28c4>
  ...
  printf("usertests starting\n");
    ...
    5404:	a8850513          	addi	a0,a0,-1400 # 7e88 <malloc+0x2174>
    5408:	00001097          	auipc	ra,0x1
    540c:	854080e7          	jalr	-1964(ra) # 5c5c <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    543c:	a0850513          	addi	a0,a0,-1528 # 7e40 <malloc+0x212c>
    5440:	00001097          	auipc	ra,0x1
    5444:	81c080e7          	jalr	-2020(ra) # 5c5c <printf>
    exit(1);
    5448:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    5458:	98458593          	addi	a1,a1,-1660 # 7dd8 <malloc+0x20c4>
    ...
    546e:	a5658593          	addi	a1,a1,-1450 # 7ec0 <malloc+0x21ac>
    ...
    5492:	95250513          	addi	a0,a0,-1710 # 7de0 <malloc+0x20cc>
    5496:	00000097          	auipc	ra,0x0
    549a:	7c6080e7          	jalr	1990(ra) # 5c5c <printf>
    exit(1);
    549e:	4505                	li	a0,1
    ...
    54bc:	7a4080e7          	jalr	1956(ra) # 5c5c <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    54fe:	92e50513          	addi	a0,a0,-1746 # 7e28 <malloc+0x2114>
    5502:	00000097          	auipc	ra,0x0
    5506:	75a080e7          	jalr	1882(ra) # 5c5c <printf>
    exit(1);
    550a:	4505                	li	a0,1
    ...
    5518:	95c50513          	addi	a0,a0,-1700 # 7e70 <malloc+0x215c>
    551c:	00000097          	auipc	ra,0x0
    5520:	740080e7          	jalr	1856(ra) # 5c5c <printf>
    exit(0);
    5524:	4501                	li	a0,0
    ...
    5534:	72c080e7          	jalr	1836(ra) # 5c5c <printf>
        if(continuous != 2)
    ...
    5576:	c7678793          	addi	a5,a5,-906 # 81e8 <malloc+0x24d4>
    557a:	bd040713          	addi	a4,s0,-1072
    557e:	00003317          	auipc	t1,0x3
    5582:	05a30313          	addi	t1,t1,90 # 85d8 <malloc+0x28c4>
    ...
    55b6:	8ee50513          	addi	a0,a0,-1810 # 7ea0 <malloc+0x218c>
    55ba:	00000097          	auipc	ra,0x0
    55be:	6a2080e7          	jalr	1698(ra) # 5c5c <printf>
        printf("SOME TESTS FAILED\n");
    55c2:	00003a97          	auipc	s5,0x3
    55c6:	866a8a93          	addi	s5,s5,-1946 # 7e28 <malloc+0x2114>
        if(continuous != 2)
    55ca:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    55cc:	00003b17          	auipc	s6,0x3
    55d0:	83cb0b13          	addi	s6,s6,-1988 # 7e08 <malloc+0x20f4>
...
000000000000592a <barrier_alloc>:
...
0000000000005932 <barrier>:
.global barrier
barrier:
 li a7, SYS_barrier
    5932:	02000893          	li	a7,32
 ecall
    5936:	00000073          	ecall
 ret
    593a:	8082                	ret

000000000000593c <barrier_free>:
.global barrier_free
barrier_free:
 li a7, SYS_barrier_free
    593c:	02100893          	li	a7,33
 ecall
    5940:	00000073          	ecall
 ret
    5944:	8082                	ret

0000000000005946 <buffer_cond_init>:
.global buffer_cond_init
buffer_cond_init:
 li a7, SYS_buffer_cond_init
    5946:	02200893          	li	a7,34
 ecall
    594a:	00000073          	ecall
 ret
    594e:	8082                	ret

0000000000005950 <cond_produce>:
.global cond_produce
cond_produce:
 li a7, SYS_cond_produce
    5950:	02300893          	li	a7,35
 ecall
    5954:	00000073          	ecall
 ret
    5958:	8082                	ret

000000000000595a <cond_consume>:
.global cond_consume
cond_consume:
 li a7, SYS_cond_consume
    595a:	02400893          	li	a7,36
 ecall
    595e:	00000073          	ecall
 ret
    5962:	8082                	ret

0000000000005964 <buffer_sem_init>:
.global buffer_sem_init
buffer_sem_init:
 li a7, SYS_buffer_sem_init
    5964:	02500893          	li	a7,37
 ecall
    5968:	00000073          	ecall
 ret
    596c:	8082                	ret

000000000000596e <sem_produce>:
.global sem_produce
sem_produce:
 li a7, SYS_sem_produce
    596e:	02600893          	li	a7,38
 ecall
    5972:	00000073          	ecall
 ret
    5976:	8082                	ret

0000000000005978 <sem_consume>:
.global sem_consume
sem_consume:
 li a7, SYS_sem_consume
    5978:	02700893          	li	a7,39
 ecall
    597c:	00000073          	ecall
 ret
    5980:	8082                	ret

0000000000005982 <putc>:
...
putc(int fd, char c)
{
    5982:	1101                	addi	sp,sp,-32
    5984:	ec06                	sd	ra,24(sp)
    5986:	e822                	sd	s0,16(sp)
    5988:	1000                	addi	s0,sp,32
    598a:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    598e:	4605                	li	a2,1
    5990:	fef40593          	addi	a1,s0,-17
    5994:	00000097          	auipc	ra,0x0
    5998:	ece080e7          	jalr	-306(ra) # 5862 <write>
}
    599c:	60e2                	ld	ra,24(sp)
    599e:	6442                	ld	s0,16(sp)
    59a0:	6105                	addi	sp,sp,32
    59a2:	8082                	ret

00000000000059a4 <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    59a4:	7139                	addi	sp,sp,-64
    59a6:	fc06                	sd	ra,56(sp)
    59a8:	f822                	sd	s0,48(sp)
    59aa:	f426                	sd	s1,40(sp)
    59ac:	f04a                	sd	s2,32(sp)
    59ae:	ec4e                	sd	s3,24(sp)
    59b0:	0080                	addi	s0,sp,64
    59b2:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    59b4:	c299                	beqz	a3,59ba <printint+0x16>
    59b6:	0805c963          	bltz	a1,5a48 <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    59ba:	2581                	sext.w	a1,a1
  neg = 0;
    59bc:	4881                	li	a7,0
    59be:	fc040693          	addi	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    59c4:	2601                	sext.w	a2,a2
    59c6:	00003517          	auipc	a0,0x3
    59ca:	c7250513          	addi	a0,a0,-910 # 8638 <digits>
    59ce:	883a                	mv	a6,a4
    59d0:	2705                	addiw	a4,a4,1
    59d2:	02c5f7bb          	remuw	a5,a1,a2
    59d6:	1782                	slli	a5,a5,0x20
    59d8:	9381                	srli	a5,a5,0x20
    59da:	97aa                	add	a5,a5,a0
    59dc:	0007c783          	lbu	a5,0(a5)
    59e0:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    59e4:	0005879b          	sext.w	a5,a1
    59e8:	02c5d5bb          	divuw	a1,a1,a2
    59ec:	0685                	addi	a3,a3,1
    59ee:	fec7f0e3          	bgeu	a5,a2,59ce <printint+0x2a>
  if(neg)
    59f2:	00088c63          	beqz	a7,5a0a <printint+0x66>
    buf[i++] = '-';
    59f6:	fd070793          	addi	a5,a4,-48
    59fa:	00878733          	add	a4,a5,s0
    59fe:	02d00793          	li	a5,45
    5a02:	fef70823          	sb	a5,-16(a4)
    5a06:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    5a0a:	02e05863          	blez	a4,5a3a <printint+0x96>
    5a0e:	fc040793          	addi	a5,s0,-64
    5a12:	00e78933          	add	s2,a5,a4
    5a16:	fff78993          	addi	s3,a5,-1
    5a1a:	99ba                	add	s3,s3,a4
    5a1c:	377d                	addiw	a4,a4,-1
    5a1e:	1702                	slli	a4,a4,0x20
    5a20:	9301                	srli	a4,a4,0x20
    5a22:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    5a26:	fff94583          	lbu	a1,-1(s2)
    5a2a:	8526                	mv	a0,s1
    5a2c:	00000097          	auipc	ra,0x0
    5a30:	f56080e7          	jalr	-170(ra) # 5982 <putc>
  while(--i >= 0)
    5a34:	197d                	addi	s2,s2,-1
    5a36:	ff3918e3          	bne	s2,s3,5a26 <printint+0x82>
}
    5a3a:	70e2                	ld	ra,56(sp)
    5a3c:	7442                	ld	s0,48(sp)
    5a3e:	74a2                	ld	s1,40(sp)
    5a40:	7902                	ld	s2,32(sp)
    5a42:	69e2                	ld	s3,24(sp)
    5a44:	6121                	addi	sp,sp,64
    5a46:	8082                	ret
    x = -xx;
    5a48:	40b005bb          	negw	a1,a1
    neg = 1;
    5a4c:	4885                	li	a7,1
    x = -xx;
    5a4e:	bf85                	j	59be <printint+0x1a>

0000000000005a50 <vprintf>:
}
...
{
    5a50:	7119                	addi	sp,sp,-128
    5a52:	fc86                	sd	ra,120(sp)
    5a54:	f8a2                	sd	s0,112(sp)
    5a56:	f4a6                	sd	s1,104(sp)
    5a58:	f0ca                	sd	s2,96(sp)
    5a5a:	ecce                	sd	s3,88(sp)
    5a5c:	e8d2                	sd	s4,80(sp)
    5a5e:	e4d6                	sd	s5,72(sp)
    5a60:	e0da                	sd	s6,64(sp)
    5a62:	fc5e                	sd	s7,56(sp)
    5a64:	f862                	sd	s8,48(sp)
    5a66:	f466                	sd	s9,40(sp)
    5a68:	f06a                	sd	s10,32(sp)
    5a6a:	ec6e                	sd	s11,24(sp)
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
    5a6e:	0005c903          	lbu	s2,0(a1)
    5a72:	18090f63          	beqz	s2,5c10 <vprintf+0x1c0>
    5a76:	8aaa                	mv	s5,a0
    5a78:	8b32                	mv	s6,a2
    5a7a:	00158493          	addi	s1,a1,1
  state = 0;
    5a7e:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    5a80:	02500a13          	li	s4,37
    5a84:	4c55                	li	s8,21
    5a86:	00003c97          	auipc	s9,0x3
    5a8a:	b5ac8c93          	addi	s9,s9,-1190 # 85e0 <malloc+0x28cc>
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
    5a8e:	02800d93          	li	s11,40
  putc(fd, 'x');
    5a92:	4d41                	li	s10,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5a94:	00003b97          	auipc	s7,0x3
    5a98:	ba4b8b93          	addi	s7,s7,-1116 # 8638 <digits>
    5a9c:	a839                	j	5aba <vprintf+0x6a>
        putc(fd, c);
    5a9e:	85ca                	mv	a1,s2
    5aa0:	8556                	mv	a0,s5
    5aa2:	00000097          	auipc	ra,0x0
    5aa6:	ee0080e7          	jalr	-288(ra) # 5982 <putc>
    5aaa:	a019                	j	5ab0 <vprintf+0x60>
    } else if(state == '%'){
    5aac:	01498d63          	beq	s3,s4,5ac6 <vprintf+0x76>
  for(i = 0; fmt[i]; i++){
    5ab0:	0485                	addi	s1,s1,1
    5ab2:	fff4c903          	lbu	s2,-1(s1)
    5ab6:	14090d63          	beqz	s2,5c10 <vprintf+0x1c0>
    if(state == 0){
    5aba:	fe0999e3          	bnez	s3,5aac <vprintf+0x5c>
      if(c == '%'){
    5abe:	ff4910e3          	bne	s2,s4,5a9e <vprintf+0x4e>
        state = '%';
    5ac2:	89d2                	mv	s3,s4
    5ac4:	b7f5                	j	5ab0 <vprintf+0x60>
      if(c == 'd'){
    5ac6:	11490c63          	beq	s2,s4,5bde <vprintf+0x18e>
    5aca:	f9d9079b          	addiw	a5,s2,-99
    5ace:	0ff7f793          	zext.b	a5,a5
    5ad2:	10fc6e63          	bltu	s8,a5,5bee <vprintf+0x19e>
    5ad6:	f9d9079b          	addiw	a5,s2,-99
    5ada:	0ff7f713          	zext.b	a4,a5
    5ade:	10ec6863          	bltu	s8,a4,5bee <vprintf+0x19e>
    5ae2:	00271793          	slli	a5,a4,0x2
    5ae6:	97e6                	add	a5,a5,s9
    5ae8:	439c                	lw	a5,0(a5)
    5aea:	97e6                	add	a5,a5,s9
    5aec:	8782                	jr	a5
        printint(fd, va_arg(ap, int), 10, 1);
    5aee:	008b0913          	addi	s2,s6,8
    5af2:	4685                	li	a3,1
    5af4:	4629                	li	a2,10
    5af6:	000b2583          	lw	a1,0(s6)
    5afa:	8556                	mv	a0,s5
    5afc:	00000097          	auipc	ra,0x0
    5b00:	ea8080e7          	jalr	-344(ra) # 59a4 <printint>
    5b04:	8b4a                	mv	s6,s2
      } else {
      ...
      state = 0;
    5b06:	4981                	li	s3,0
    5b08:	b765                	j	5ab0 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    5b0a:	008b0913          	addi	s2,s6,8
    5b0e:	4681                	li	a3,0
    5b10:	4629                	li	a2,10
    5b12:	000b2583          	lw	a1,0(s6)
    5b16:	8556                	mv	a0,s5
    5b18:	00000097          	auipc	ra,0x0
    5b1c:	e8c080e7          	jalr	-372(ra) # 59a4 <printint>
    5b20:	8b4a                	mv	s6,s2
      state = 0;
    5b22:	4981                	li	s3,0
    5b24:	b771                	j	5ab0 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    5b26:	008b0913          	addi	s2,s6,8
    5b2a:	4681                	li	a3,0
    5b2c:	866a                	mv	a2,s10
    5b2e:	000b2583          	lw	a1,0(s6)
    5b32:	8556                	mv	a0,s5
    5b34:	00000097          	auipc	ra,0x0
    5b38:	e70080e7          	jalr	-400(ra) # 59a4 <printint>
    5b3c:	8b4a                	mv	s6,s2
      state = 0;
    5b3e:	4981                	li	s3,0
    5b40:	bf85                	j	5ab0 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    5b42:	008b0793          	addi	a5,s6,8
    5b46:	f8f43423          	sd	a5,-120(s0)
    5b4a:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    5b4e:	03000593          	li	a1,48
    5b52:	8556                	mv	a0,s5
    5b54:	00000097          	auipc	ra,0x0
    5b58:	e2e080e7          	jalr	-466(ra) # 5982 <putc>
  putc(fd, 'x');
    5b5c:	07800593          	li	a1,120
    5b60:	8556                	mv	a0,s5
    5b62:	00000097          	auipc	ra,0x0
    5b66:	e20080e7          	jalr	-480(ra) # 5982 <putc>
    5b6a:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5b6c:	03c9d793          	srli	a5,s3,0x3c
    5b70:	97de                	add	a5,a5,s7
    5b72:	0007c583          	lbu	a1,0(a5)
    5b76:	8556                	mv	a0,s5
    5b78:	00000097          	auipc	ra,0x0
    5b7c:	e0a080e7          	jalr	-502(ra) # 5982 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5b80:	0992                	slli	s3,s3,0x4
    5b82:	397d                	addiw	s2,s2,-1
    5b84:	fe0914e3          	bnez	s2,5b6c <vprintf+0x11c>
        printptr(fd, va_arg(ap, uint64));
    5b88:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5b8c:	4981                	li	s3,0
    5b8e:	b70d                	j	5ab0 <vprintf+0x60>
        s = va_arg(ap, char*);
    5b90:	008b0913          	addi	s2,s6,8
    5b94:	000b3983          	ld	s3,0(s6)
        if(s == 0)
    5b98:	02098163          	beqz	s3,5bba <vprintf+0x16a>
        while(*s != 0){
    5b9c:	0009c583          	lbu	a1,0(s3)
    5ba0:	c5ad                	beqz	a1,5c0a <vprintf+0x1ba>
          putc(fd, *s);
    5ba2:	8556                	mv	a0,s5
    5ba4:	00000097          	auipc	ra,0x0
    5ba8:	dde080e7          	jalr	-546(ra) # 5982 <putc>
          s++;
    5bac:	0985                	addi	s3,s3,1
        while(*s != 0){
    5bae:	0009c583          	lbu	a1,0(s3)
    5bb2:	f9e5                	bnez	a1,5ba2 <vprintf+0x152>
        s = va_arg(ap, char*);
    5bb4:	8b4a                	mv	s6,s2
      state = 0;
    5bb6:	4981                	li	s3,0
    5bb8:	bde5                	j	5ab0 <vprintf+0x60>
          s = "(null)";
    5bba:	00003997          	auipc	s3,0x3
    5bbe:	a1e98993          	addi	s3,s3,-1506 # 85d8 <malloc+0x28c4>
        while(*s != 0){
    5bc2:	85ee                	mv	a1,s11
    5bc4:	bff9                	j	5ba2 <vprintf+0x152>
        putc(fd, va_arg(ap, uint));
    5bc6:	008b0913          	addi	s2,s6,8
    5bca:	000b4583          	lbu	a1,0(s6)
    5bce:	8556                	mv	a0,s5
    5bd0:	00000097          	auipc	ra,0x0
    5bd4:	db2080e7          	jalr	-590(ra) # 5982 <putc>
    5bd8:	8b4a                	mv	s6,s2
      state = 0;
    5bda:	4981                	li	s3,0
    5bdc:	bdd1                	j	5ab0 <vprintf+0x60>
        putc(fd, c);
    5bde:	85d2                	mv	a1,s4
    5be0:	8556                	mv	a0,s5
    5be2:	00000097          	auipc	ra,0x0
    5be6:	da0080e7          	jalr	-608(ra) # 5982 <putc>
      state = 0;
    5bea:	4981                	li	s3,0
    5bec:	b5d1                	j	5ab0 <vprintf+0x60>
        putc(fd, '%');
    5bee:	85d2                	mv	a1,s4
    5bf0:	8556                	mv	a0,s5
    5bf2:	00000097          	auipc	ra,0x0
    5bf6:	d90080e7          	jalr	-624(ra) # 5982 <putc>
        putc(fd, c);
    5bfa:	85ca                	mv	a1,s2
    5bfc:	8556                	mv	a0,s5
    5bfe:	00000097          	auipc	ra,0x0
    5c02:	d84080e7          	jalr	-636(ra) # 5982 <putc>
      state = 0;
    5c06:	4981                	li	s3,0
    5c08:	b565                	j	5ab0 <vprintf+0x60>
        s = va_arg(ap, char*);
    5c0a:	8b4a                	mv	s6,s2
      state = 0;
    5c0c:	4981                	li	s3,0
    5c0e:	b54d                	j	5ab0 <vprintf+0x60>
    }
  }
}
    5c10:	70e6                	ld	ra,120(sp)
    5c12:	7446                	ld	s0,112(sp)
    5c14:	74a6                	ld	s1,104(sp)
    5c16:	7906                	ld	s2,96(sp)
    5c18:	69e6                	ld	s3,88(sp)
    5c1a:	6a46                	ld	s4,80(sp)
    5c1c:	6aa6                	ld	s5,72(sp)
    5c1e:	6b06                	ld	s6,64(sp)
    5c20:	7be2                	ld	s7,56(sp)
    5c22:	7c42                	ld	s8,48(sp)
    5c24:	7ca2                	ld	s9,40(sp)
    5c26:	7d02                	ld	s10,32(sp)
    5c28:	6de2                	ld	s11,24(sp)
    5c2a:	6109                	addi	sp,sp,128
    5c2c:	8082                	ret

0000000000005c2e <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5c2e:	715d                	addi	sp,sp,-80
    5c30:	ec06                	sd	ra,24(sp)
    5c32:	e822                	sd	s0,16(sp)
    5c34:	1000                	addi	s0,sp,32
    5c36:	e010                	sd	a2,0(s0)
    5c38:	e414                	sd	a3,8(s0)
    5c3a:	e818                	sd	a4,16(s0)
    5c3c:	ec1c                	sd	a5,24(s0)
    5c3e:	03043023          	sd	a6,32(s0)
    5c42:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5c46:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5c4a:	8622                	mv	a2,s0
    5c4c:	00000097          	auipc	ra,0x0
    5c50:	e04080e7          	jalr	-508(ra) # 5a50 <vprintf>
}
    5c54:	60e2                	ld	ra,24(sp)
    5c56:	6442                	ld	s0,16(sp)
    5c58:	6161                	addi	sp,sp,80
    5c5a:	8082                	ret

0000000000005c5c <printf>:

void
printf(const char *fmt, ...)
{
    5c5c:	711d                	addi	sp,sp,-96
    5c5e:	ec06                	sd	ra,24(sp)
    5c60:	e822                	sd	s0,16(sp)
    5c62:	1000                	addi	s0,sp,32
    5c64:	e40c                	sd	a1,8(s0)
    5c66:	e810                	sd	a2,16(s0)
    5c68:	ec14                	sd	a3,24(s0)
    5c6a:	f018                	sd	a4,32(s0)
    5c6c:	f41c                	sd	a5,40(s0)
    5c6e:	03043823          	sd	a6,48(s0)
    5c72:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5c76:	00840613          	addi	a2,s0,8
    5c7a:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5c7e:	85aa                	mv	a1,a0
    5c80:	4505                	li	a0,1
    5c82:	00000097          	auipc	ra,0x0
    5c86:	dce080e7          	jalr	-562(ra) # 5a50 <vprintf>
}
    5c8a:	60e2                	ld	ra,24(sp)
    5c8c:	6442                	ld	s0,16(sp)
    5c8e:	6125                	addi	sp,sp,96
    5c90:	8082                	ret

0000000000005c92 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    5c98:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c9c:	00003797          	auipc	a5,0x3
    5ca0:	9bc7b783          	ld	a5,-1604(a5) # 8658 <freep>
    5ca4:	a02d                	j	5cce <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5ca6:	4618                	lw	a4,8(a2)
    5ca8:	9f2d                	addw	a4,a4,a1
    5caa:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5cae:	6398                	ld	a4,0(a5)
    5cb0:	6310                	ld	a2,0(a4)
    5cb2:	a83d                	j	5cf0 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5cb4:	ff852703          	lw	a4,-8(a0)
    5cb8:	9f31                	addw	a4,a4,a2
    5cba:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5cbc:	ff053683          	ld	a3,-16(a0)
    5cc0:	a091                	j	5d04 <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5cc2:	6398                	ld	a4,0(a5)
    5cc4:	00e7e463          	bltu	a5,a4,5ccc <free+0x3a>
    5cc8:	00e6ea63          	bltu	a3,a4,5cdc <free+0x4a>
{
    5ccc:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5cce:	fed7fae3          	bgeu	a5,a3,5cc2 <free+0x30>
    5cd2:	6398                	ld	a4,0(a5)
    5cd4:	00e6e463          	bltu	a3,a4,5cdc <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5cd8:	fee7eae3          	bltu	a5,a4,5ccc <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    5cdc:	ff852583          	lw	a1,-8(a0)
    5ce0:	6390                	ld	a2,0(a5)
    5ce2:	02059813          	slli	a6,a1,0x20
    5ce6:	01c85713          	srli	a4,a6,0x1c
    5cea:	9736                	add	a4,a4,a3
    5cec:	fae60de3          	beq	a2,a4,5ca6 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    5cf0:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5cf4:	4790                	lw	a2,8(a5)
    5cf6:	02061593          	slli	a1,a2,0x20
    5cfa:	01c5d713          	srli	a4,a1,0x1c
    5cfe:	973e                	add	a4,a4,a5
    5d00:	fae68ae3          	beq	a3,a4,5cb4 <free+0x22>
    p->s.ptr = bp->s.ptr;
    5d04:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    5d06:	00003717          	auipc	a4,0x3
    5d0a:	94f73923          	sd	a5,-1710(a4) # 8658 <freep>
}
    5d0e:	6422                	ld	s0,8(sp)
    5d10:	0141                	addi	sp,sp,16
    5d12:	8082                	ret

0000000000005d14 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    ...
    5d1c:	f04a                	sd	s2,32(sp)
    5d1e:	ec4e                	sd	s3,24(sp)
    5d20:	e852                	sd	s4,16(sp)
    5d22:	e456                	sd	s5,8(sp)
    5d24:	e05a                	sd	s6,0(sp)
    5d26:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5d28:	02051493          	slli	s1,a0,0x20
    5d2c:	9081                	srli	s1,s1,0x20
    5d2e:	04bd                	addi	s1,s1,15
    5d30:	8091                	srli	s1,s1,0x4
    5d32:	0014899b          	addiw	s3,s1,1
    5d36:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    5d38:	00003517          	auipc	a0,0x3
    5d3c:	92053503          	ld	a0,-1760(a0) # 8658 <freep>
    5d40:	c515                	beqz	a0,5d6c <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5d42:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5d44:	4798                	lw	a4,8(a5)
    5d46:	02977f63          	bgeu	a4,s1,5d84 <malloc+0x70>
    5d4a:	8a4e                	mv	s4,s3
    5d4c:	0009871b          	sext.w	a4,s3
    5d50:	6685                	lui	a3,0x1
    5d52:	00d77363          	bgeu	a4,a3,5d58 <malloc+0x44>
    5d56:	6a05                	lui	s4,0x1
    5d58:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    5d5c:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    5d60:	00003917          	auipc	s2,0x3
    5d64:	8f890913          	addi	s2,s2,-1800 # 8658 <freep>
  if(p == (char*)-1)
    5d68:	5afd                	li	s5,-1
    5d6a:	a895                	j	5dde <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    5d6c:	00009797          	auipc	a5,0x9
    5d70:	10c78793          	addi	a5,a5,268 # ee78 <base>
    5d74:	00003717          	auipc	a4,0x3
    5d78:	8ef73223          	sd	a5,-1820(a4) # 8658 <freep>
    5d7c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5d7e:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5d82:	b7e1                	j	5d4a <malloc+0x36>
      if(p->s.size == nunits)
    5d84:	02e48c63          	beq	s1,a4,5dbc <malloc+0xa8>
        p->s.size -= nunits;
    5d88:	4137073b          	subw	a4,a4,s3
    5d8c:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5d8e:	02071693          	slli	a3,a4,0x20
    5d92:	01c6d713          	srli	a4,a3,0x1c
    5d96:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5d98:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5d9c:	00003717          	auipc	a4,0x3
    5da0:	8aa73e23          	sd	a0,-1860(a4) # 8658 <freep>
      return (void*)(p + 1);
    5da4:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    5da8:	70e2                	ld	ra,56(sp)
    5daa:	7442                	ld	s0,48(sp)
    5dac:	74a2                	ld	s1,40(sp)
    5dae:	7902                	ld	s2,32(sp)
    5db0:	69e2                	ld	s3,24(sp)
    5db2:	6a42                	ld	s4,16(sp)
    5db4:	6aa2                	ld	s5,8(sp)
    5db6:	6b02                	ld	s6,0(sp)
    5db8:	6121                	addi	sp,sp,64
    5dba:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    5dbc:	6398                	ld	a4,0(a5)
    5dbe:	e118                	sd	a4,0(a0)
    5dc0:	bff1                	j	5d9c <malloc+0x88>
  hp->s.size = nu;
    5dc2:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5dc6:	0541                	addi	a0,a0,16
    5dc8:	00000097          	auipc	ra,0x0
    5dcc:	eca080e7          	jalr	-310(ra) # 5c92 <free>
  return freep;
    5dd0:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5dd4:	d971                	beqz	a0,5da8 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5dd6:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5dd8:	4798                	lw	a4,8(a5)
    5dda:	fa9775e3          	bgeu	a4,s1,5d84 <malloc+0x70>
    if(p == freep)
    5dde:	00093703          	ld	a4,0(s2)
    5de2:	853e                	mv	a0,a5
    5de4:	fef719e3          	bne	a4,a5,5dd6 <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    5de8:	8552                	mv	a0,s4
    5dea:	00000097          	auipc	ra,0x0
    5dee:	ae0080e7          	jalr	-1312(ra) # 58ca <sbrk>
  if(p == (char*)-1)
    5df2:	fd5518e3          	bne	a0,s5,5dc2 <malloc+0xae>
        return 0;
    5df6:	4501                	li	a0,0
    5df8:	bf45                	j	5da8 <malloc+0x94>
