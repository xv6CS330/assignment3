...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	0f250513          	addi	a0,a0,242 # 6130 <malloc+0x444>
      46:	00006097          	auipc	ra,0x6
      4a:	be8080e7          	jalr	-1048(ra) # 5c2e <printf>
      exit(1);
      4e:	4505                	li	a0,1
      ...
      74:	8082                	ret
{
      ...
      84:	0d050513          	addi	a0,a0,208 # 6150 <malloc+0x464>
      88:	00006097          	auipc	ra,0x6
      8c:	ba6080e7          	jalr	-1114(ra) # 5c2e <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	0c050513          	addi	a0,a0,192 # 6168 <malloc+0x47c>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	0c250513          	addi	a0,a0,194 # 6188 <malloc+0x49c>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	08a50513          	addi	a0,a0,138 # 6170 <malloc+0x484>
      ee:	00006097          	auipc	ra,0x6
      f2:	b40080e7          	jalr	-1216(ra) # 5c2e <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	09650513          	addi	a0,a0,150 # 6198 <malloc+0x4ac>
     10a:	00006097          	auipc	ra,0x6
     10e:	b24080e7          	jalr	-1244(ra) # 5c2e <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	09450513          	addi	a0,a0,148 # 61c0 <malloc+0x4d4>
     134:	00005097          	auipc	ra,0x5
     138:	76e080e7          	jalr	1902(ra) # 58a2 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	08050513          	addi	a0,a0,128 # 61c0 <malloc+0x4d4>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	07c58593          	addi	a1,a1,124 # 61d0 <malloc+0x4e4>
     15c:	00005097          	auipc	ra,0x5
     160:	716080e7          	jalr	1814(ra) # 5872 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	05850513          	addi	a0,a0,88 # 61c0 <malloc+0x4d4>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	05c58593          	addi	a1,a1,92 # 61d8 <malloc+0x4ec>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	02c50513          	addi	a0,a0,44 # 61c0 <malloc+0x4d4>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	01650513          	addi	a0,a0,22 # 61e0 <malloc+0x4f4>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	a5c080e7          	jalr	-1444(ra) # 5c2e <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	d3450513          	addi	a0,a0,-716 # 5fb0 <malloc+0x2c4>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	d20a8a93          	addi	s5,s5,-736 # 5fb0 <malloc+0x2c4>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	ef650513          	addi	a0,a0,-266 # 6208 <malloc+0x51c>
     31a:	00006097          	auipc	ra,0x6
     31e:	914080e7          	jalr	-1772(ra) # 5c2e <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     33a:	ef250513          	addi	a0,a0,-270 # 6228 <malloc+0x53c>
     33e:	00006097          	auipc	ra,0x6
     342:	8f0080e7          	jalr	-1808(ra) # 5c2e <printf>
        exit(1);
     346:	4505                	li	a0,1
...
0000000000000350 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     376:	ecea0a13          	addi	s4,s4,-306 # 6240 <malloc+0x554>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     422:	e2a50513          	addi	a0,a0,-470 # 6248 <malloc+0x55c>
     426:	00006097          	auipc	ra,0x6
     42a:	808080e7          	jalr	-2040(ra) # 5c2e <printf>
      exit(1);
     42e:	4505                	li	a0,1
     ...
     440:	e2450513          	addi	a0,a0,-476 # 6260 <malloc+0x574>
     444:	00005097          	auipc	ra,0x5
     448:	7ea080e7          	jalr	2026(ra) # 5c2e <printf>
      exit(1);
     44c:	4505                	li	a0,1
     ...
     45e:	e3650513          	addi	a0,a0,-458 # 6290 <malloc+0x5a4>
     462:	00005097          	auipc	ra,0x5
     466:	7cc080e7          	jalr	1996(ra) # 5c2e <printf>
      exit(1);
     46a:	4505                	li	a0,1
     ...
     478:	e4c50513          	addi	a0,a0,-436 # 62c0 <malloc+0x5d4>
     47c:	00005097          	auipc	ra,0x5
     480:	7b2080e7          	jalr	1970(ra) # 5c2e <printf>
      exit(1);
     484:	4505                	li	a0,1
     ...
     496:	e3e50513          	addi	a0,a0,-450 # 62d0 <malloc+0x5e4>
     49a:	00005097          	auipc	ra,0x5
     49e:	794080e7          	jalr	1940(ra) # 5c2e <printf>
      exit(1);
     4a2:	4505                	li	a0,1
...
00000000000004ac <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d4:	e30a0a13          	addi	s4,s4,-464 # 6300 <malloc+0x614>
    n = write(fds[1], "x", 1);
     4d8:	00006a97          	auipc	s5,0x6
     4dc:	d00a8a93          	addi	s5,s5,-768 # 61d8 <malloc+0x4ec>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     582:	d8a50513          	addi	a0,a0,-630 # 6308 <malloc+0x61c>
     586:	00005097          	auipc	ra,0x5
     58a:	6a8080e7          	jalr	1704(ra) # 5c2e <printf>
      exit(1);
     58e:	4505                	li	a0,1
     ...
     5a0:	d8450513          	addi	a0,a0,-636 # 6320 <malloc+0x634>
     5a4:	00005097          	auipc	ra,0x5
     5a8:	68a080e7          	jalr	1674(ra) # 5c2e <printf>
      exit(1);
     5ac:	4505                	li	a0,1
     ...
     5ba:	d0a50513          	addi	a0,a0,-758 # 62c0 <malloc+0x5d4>
     5be:	00005097          	auipc	ra,0x5
     5c2:	670080e7          	jalr	1648(ra) # 5c2e <printf>
      exit(1);
     5c6:	4505                	li	a0,1
     ...
     5d4:	d8050513          	addi	a0,a0,-640 # 6350 <malloc+0x664>
     5d8:	00005097          	auipc	ra,0x5
     5dc:	656080e7          	jalr	1622(ra) # 5c2e <printf>
      exit(1);
     5e0:	4505                	li	a0,1
     ...
     5f2:	d7a50513          	addi	a0,a0,-646 # 6368 <malloc+0x67c>
     5f6:	00005097          	auipc	ra,0x5
     5fa:	638080e7          	jalr	1592(ra) # 5c2e <printf>
      exit(1);
     5fe:	4505                	li	a0,1
...
0000000000000608 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     648:	b8c58593          	addi	a1,a1,-1140 # 61d0 <malloc+0x4e4>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     664:	b6050513          	addi	a0,a0,-1184 # 61c0 <malloc+0x4d4>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     690:	b3450513          	addi	a0,a0,-1228 # 61c0 <malloc+0x4d4>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a4:	b2050513          	addi	a0,a0,-1248 # 61c0 <malloc+0x4d4>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e2:	d1a58593          	addi	a1,a1,-742 # 63f8 <malloc+0x70c>
     6e6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     724:	aa050513          	addi	a0,a0,-1376 # 61c0 <malloc+0x4d4>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     768:	c3450513          	addi	a0,a0,-972 # 6398 <malloc+0x6ac>
     76c:	00005097          	auipc	ra,0x5
     770:	4c2080e7          	jalr	1218(ra) # 5c2e <printf>
    exit(1);
     774:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     784:	c3850513          	addi	a0,a0,-968 # 63b8 <malloc+0x6cc>
     788:	00005097          	auipc	ra,0x5
     78c:	4a6080e7          	jalr	1190(ra) # 5c2e <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     790:	8652                	mv	a2,s4
     792:	85d6                	mv	a1,s5
     794:	00006517          	auipc	a0,0x6
     798:	c3450513          	addi	a0,a0,-972 # 63c8 <malloc+0x6dc>
     79c:	00005097          	auipc	ra,0x5
     7a0:	492080e7          	jalr	1170(ra) # 5c2e <printf>
    exit(1);
     7a4:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b4:	c3850513          	addi	a0,a0,-968 # 63e8 <malloc+0x6fc>
     7b8:	00005097          	auipc	ra,0x5
     7bc:	476080e7          	jalr	1142(ra) # 5c2e <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7c0:	8652                	mv	a2,s4
     7c2:	85d6                	mv	a1,s5
     7c4:	00006517          	auipc	a0,0x6
     7c8:	c0450513          	addi	a0,a0,-1020 # 63c8 <malloc+0x6dc>
     7cc:	00005097          	auipc	ra,0x5
     7d0:	462080e7          	jalr	1122(ra) # 5c2e <printf>
    exit(1);
     7d4:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e6:	c1e50513          	addi	a0,a0,-994 # 6400 <malloc+0x714>
     7ea:	00005097          	auipc	ra,0x5
     7ee:	444080e7          	jalr	1092(ra) # 5c2e <printf>
    exit(1);
     7f2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     804:	c2050513          	addi	a0,a0,-992 # 6420 <malloc+0x734>
     808:	00005097          	auipc	ra,0x5
     80c:	426080e7          	jalr	1062(ra) # 5c2e <printf>
    exit(1);
     810:	4505                	li	a0,1
...
000000000000081a <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     838:	c0c50513          	addi	a0,a0,-1012 # 6440 <malloc+0x754>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     850:	c1c98993          	addi	s3,s3,-996 # 6468 <malloc+0x77c>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     854:	00006a97          	auipc	s5,0x6
     858:	c4ca8a93          	addi	s5,s5,-948 # 64a0 <malloc+0x7b4>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89e:	ba650513          	addi	a0,a0,-1114 # 6440 <malloc+0x754>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8b8:	53c58593          	addi	a1,a1,1340 # bdf0 <buf>
  ...
  if(unlink("small") < 0){
     ...
     8da:	b6a50513          	addi	a0,a0,-1174 # 6440 <malloc+0x754>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     904:	b4850513          	addi	a0,a0,-1208 # 6448 <malloc+0x75c>
     908:	00005097          	auipc	ra,0x5
     90c:	326080e7          	jalr	806(ra) # 5c2e <printf>
    exit(1);
     910:	4505                	li	a0,1
     ...
     922:	b5a50513          	addi	a0,a0,-1190 # 6478 <malloc+0x78c>
     926:	00005097          	auipc	ra,0x5
     92a:	308080e7          	jalr	776(ra) # 5c2e <printf>
      exit(1);
     92e:	4505                	li	a0,1
     ...
     940:	b7450513          	addi	a0,a0,-1164 # 64b0 <malloc+0x7c4>
     944:	00005097          	auipc	ra,0x5
     948:	2ea080e7          	jalr	746(ra) # 5c2e <printf>
      exit(1);
     94c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95c:	b8050513          	addi	a0,a0,-1152 # 64d8 <malloc+0x7ec>
     960:	00005097          	auipc	ra,0x5
     964:	2ce080e7          	jalr	718(ra) # 5c2e <printf>
    exit(1);
     968:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     978:	b8450513          	addi	a0,a0,-1148 # 64f8 <malloc+0x80c>
     97c:	00005097          	auipc	ra,0x5
     980:	2b2080e7          	jalr	690(ra) # 5c2e <printf>
    exit(1);
     984:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     994:	b8050513          	addi	a0,a0,-1152 # 6510 <malloc+0x824>
     998:	00005097          	auipc	ra,0x5
     99c:	296080e7          	jalr	662(ra) # 5c2e <printf>
    exit(1);
     9a0:	4505                	li	a0,1
...
00000000000009aa <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c6:	b6e50513          	addi	a0,a0,-1170 # 6530 <malloc+0x844>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9da:	41a90913          	addi	s2,s2,1050 # bdf0 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a18:	b1c50513          	addi	a0,a0,-1252 # 6530 <malloc+0x844>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2c:	3c890913          	addi	s2,s2,968 # bdf0 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	adc50513          	addi	a0,a0,-1316 # 6538 <malloc+0x84c>
     a64:	00005097          	auipc	ra,0x5
     a68:	1ca080e7          	jalr	458(ra) # 5c2e <printf>
    exit(1);
     a6c:	4505                	li	a0,1
     ...
     a7e:	ade50513          	addi	a0,a0,-1314 # 6558 <malloc+0x86c>
     a82:	00005097          	auipc	ra,0x5
     a86:	1ac080e7          	jalr	428(ra) # 5c2e <printf>
      exit(1);
     a8a:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a9a:	aea50513          	addi	a0,a0,-1302 # 6580 <malloc+0x894>
     a9e:	00005097          	auipc	ra,0x5
     aa2:	190080e7          	jalr	400(ra) # 5c2e <printf>
    exit(1);
     aa6:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ac6:	a6e50513          	addi	a0,a0,-1426 # 6530 <malloc+0x844>
     ...
     af2:	ab250513          	addi	a0,a0,-1358 # 65a0 <malloc+0x8b4>
     af6:	00005097          	auipc	ra,0x5
     afa:	138080e7          	jalr	312(ra) # 5c2e <printf>
        exit(1);
     afe:	4505                	li	a0,1
     ...
     b10:	abc50513          	addi	a0,a0,-1348 # 65c8 <malloc+0x8dc>
     b14:	00005097          	auipc	ra,0x5
     b18:	11a080e7          	jalr	282(ra) # 5c2e <printf>
      exit(1);
     b1c:	4505                	li	a0,1
     ...
     b2e:	ab650513          	addi	a0,a0,-1354 # 65e0 <malloc+0x8f4>
     b32:	00005097          	auipc	ra,0x5
     b36:	0fc080e7          	jalr	252(ra) # 5c2e <printf>
      exit(1);
     b3a:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b4a:	ac250513          	addi	a0,a0,-1342 # 6608 <malloc+0x91c>
     b4e:	00005097          	auipc	ra,0x5
     b52:	0e0080e7          	jalr	224(ra) # 5c2e <printf>
    exit(1);
     b56:	4505                	li	a0,1
...
0000000000000b60 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b78:	3cc50513          	addi	a0,a0,972 # 5f40 <malloc+0x254>
  ...
  write(fd, "hello", SZ);
     ...
     b90:	ab458593          	addi	a1,a1,-1356 # 6640 <malloc+0x954>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     bac:	39850513          	addi	a0,a0,920 # 5f40 <malloc+0x254>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc2:	38250513          	addi	a0,a0,898 # 5f40 <malloc+0x254>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd8:	36c50513          	addi	a0,a0,876 # 5f40 <malloc+0x254>
  ...
  write(fd1, "yyy", 3);
     ...
     bec:	aa058593          	addi	a1,a1,-1376 # 6688 <malloc+0x99c>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c08:	1ec58593          	addi	a1,a1,492 # bdf0 <buf>
     c0c:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c54:	2f050513          	addi	a0,a0,752 # 5f40 <malloc+0x254>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c74:	9b050513          	addi	a0,a0,-1616 # 6620 <malloc+0x934>
     c78:	00005097          	auipc	ra,0x5
     c7c:	fb6080e7          	jalr	-74(ra) # 5c2e <printf>
    exit(1);
     c80:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c90:	9bc50513          	addi	a0,a0,-1604 # 6648 <malloc+0x95c>
     c94:	00005097          	auipc	ra,0x5
     c98:	f9a080e7          	jalr	-102(ra) # 5c2e <printf>
    exit(1);
     c9c:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     cac:	9c050513          	addi	a0,a0,-1600 # 6668 <malloc+0x97c>
     cb0:	00005097          	auipc	ra,0x5
     cb4:	f7e080e7          	jalr	-130(ra) # 5c2e <printf>
    exit(1);
     cb8:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc8:	9cc50513          	addi	a0,a0,-1588 # 6690 <malloc+0x9a4>
     ccc:	00005097          	auipc	ra,0x5
     cd0:	f62080e7          	jalr	-158(ra) # 5c2e <printf>
    exit(1);
     cd4:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce4:	9d050513          	addi	a0,a0,-1584 # 66b0 <malloc+0x9c4>
     ce8:	00005097          	auipc	ra,0x5
     cec:	f46080e7          	jalr	-186(ra) # 5c2e <printf>
    exit(1);
     cf0:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     d00:	9d450513          	addi	a0,a0,-1580 # 66d0 <malloc+0x9e4>
     d04:	00005097          	auipc	ra,0x5
     d08:	f2a080e7          	jalr	-214(ra) # 5c2e <printf>
    exit(1);
     d0c:	4505                	li	a0,1
...
0000000000000d16 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d64:	8e058593          	addi	a1,a1,-1824 # 6640 <malloc+0x954>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d84:	97858593          	addi	a1,a1,-1672 # 66f8 <malloc+0xa0c>
     d88:	00006517          	auipc	a0,0x6
     d8c:	96850513          	addi	a0,a0,-1688 # 66f0 <malloc+0xa04>
  ...
  unlink("lf1");
     ...
     da0:	95450513          	addi	a0,a0,-1708 # 66f0 <malloc+0xa04>
     da4:	00005097          	auipc	ra,0x5
     da8:	afe080e7          	jalr	-1282(ra) # 58a2 <unlink>
  if(open("lf1", 0) >= 0){
     dac:	4581                	li	a1,0
     dae:	00006517          	auipc	a0,0x6
     db2:	94250513          	addi	a0,a0,-1726 # 66f0 <malloc+0xa04>
  ...
  fd = open("lf2", 0);
     ...
     dc8:	93450513          	addi	a0,a0,-1740 # 66f8 <malloc+0xa0c>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     de0:	01458593          	addi	a1,a1,20 # bdf0 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     e00:	8fc58593          	addi	a1,a1,-1796 # 66f8 <malloc+0xa0c>
     e04:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e16:	8e650513          	addi	a0,a0,-1818 # 66f8 <malloc+0xa0c>
     e1a:	00005097          	auipc	ra,0x5
     e1e:	a88080e7          	jalr	-1400(ra) # 58a2 <unlink>
  if(link("lf2", "lf1") >= 0){
     e22:	00006597          	auipc	a1,0x6
     e26:	8ce58593          	addi	a1,a1,-1842 # 66f0 <malloc+0xa04>
     e2a:	00006517          	auipc	a0,0x6
     e2e:	8ce50513          	addi	a0,a0,-1842 # 66f8 <malloc+0xa0c>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e42:	8b258593          	addi	a1,a1,-1870 # 66f0 <malloc+0xa04>
     e46:	00006517          	auipc	a0,0x6
     e4a:	9ba50513          	addi	a0,a0,-1606 # 6800 <malloc+0xb14>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6c:	89850513          	addi	a0,a0,-1896 # 6700 <malloc+0xa14>
     e70:	00005097          	auipc	ra,0x5
     e74:	dbe080e7          	jalr	-578(ra) # 5c2e <printf>
    exit(1);
     e78:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e88:	89450513          	addi	a0,a0,-1900 # 6718 <malloc+0xa2c>
     e8c:	00005097          	auipc	ra,0x5
     e90:	da2080e7          	jalr	-606(ra) # 5c2e <printf>
    exit(1);
     e94:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea4:	89050513          	addi	a0,a0,-1904 # 6730 <malloc+0xa44>
     ea8:	00005097          	auipc	ra,0x5
     eac:	d86080e7          	jalr	-634(ra) # 5c2e <printf>
    exit(1);
     eb0:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ec0:	89450513          	addi	a0,a0,-1900 # 6750 <malloc+0xa64>
     ec4:	00005097          	auipc	ra,0x5
     ec8:	d6a080e7          	jalr	-662(ra) # 5c2e <printf>
    exit(1);
     ecc:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     edc:	8a850513          	addi	a0,a0,-1880 # 6780 <malloc+0xa94>
     ee0:	00005097          	auipc	ra,0x5
     ee4:	d4e080e7          	jalr	-690(ra) # 5c2e <printf>
    exit(1);
     ee8:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef8:	8a450513          	addi	a0,a0,-1884 # 6798 <malloc+0xaac>
     efc:	00005097          	auipc	ra,0x5
     f00:	d32080e7          	jalr	-718(ra) # 5c2e <printf>
    exit(1);
     f04:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f14:	8a050513          	addi	a0,a0,-1888 # 67b0 <malloc+0xac4>
     f18:	00005097          	auipc	ra,0x5
     f1c:	d16080e7          	jalr	-746(ra) # 5c2e <printf>
    exit(1);
     f20:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f30:	8ac50513          	addi	a0,a0,-1876 # 67d8 <malloc+0xaec>
     f34:	00005097          	auipc	ra,0x5
     f38:	cfa080e7          	jalr	-774(ra) # 5c2e <printf>
    exit(1);
     f3c:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4c:	8c050513          	addi	a0,a0,-1856 # 6808 <malloc+0xb1c>
     f50:	00005097          	auipc	ra,0x5
     f54:	cde080e7          	jalr	-802(ra) # 5c2e <printf>
    exit(1);
     f58:	4505                	li	a0,1
...
0000000000000f62 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb2:	87aa0a13          	addi	s4,s4,-1926 # 6828 <malloc+0xb3c>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1004:	82850513          	addi	a0,a0,-2008 # 6828 <malloc+0xb3c>
  ...
  for(i = 0; i < N; i++){
    ...
    1074:	7c050513          	addi	a0,a0,1984 # 6830 <malloc+0xb44>
    1078:	00005097          	auipc	ra,0x5
    107c:	bb6080e7          	jalr	-1098(ra) # 5c2e <printf>
    exit(1);
    1080:	4505                	li	a0,1
    ...
    1094:	7c050513          	addi	a0,a0,1984 # 6850 <malloc+0xb64>
    1098:	00005097          	auipc	ra,0x5
    109c:	b96080e7          	jalr	-1130(ra) # 5c2e <printf>
      exit(1);
    10a0:	4505                	li	a0,1
    ...
    10b0:	7c450513          	addi	a0,a0,1988 # 6870 <malloc+0xb84>
    10b4:	00005097          	auipc	ra,0x5
    10b8:	b7a080e7          	jalr	-1158(ra) # 5c2e <printf>
      exit(1);
    10bc:	4505                	li	a0,1
...
00000000000010c6 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e2:	7b298993          	addi	s3,s3,1970 # 6890 <malloc+0xba4>
    10e6:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111e:	78650513          	addi	a0,a0,1926 # 68a0 <malloc+0xbb4>
    1122:	00005097          	auipc	ra,0x5
    1126:	b0c080e7          	jalr	-1268(ra) # 5c2e <printf>
      exit(1);
    112a:	4505                	li	a0,1
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1146:	4864b483          	ld	s1,1158(s1) # 85c8 <__SDATA_BEGIN__>
...
badarg(char *s)
{
    ...
    117c:	35048493          	addi	s1,s1,848 # c350 <buf+0x560>
  for(int i = 0; i < 50000; i++){
    ...
    118a:	fe298993          	addi	s3,s3,-30 # 6168 <malloc+0x47c>
    argv[0] = (char*)0xffffffff;
...
00000000000011b2 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1214:	87878793          	addi	a5,a5,-1928 # 7a88 <malloc+0x1d9c>
  ...
  if(pid == 0){
    ...
    124a:	49278793          	addi	a5,a5,1170 # 86d8 <big.1299>
    124e:	00008697          	auipc	a3,0x8
    1252:	48a68693          	addi	a3,a3,1162 # 96d8 <__global_pointer$+0x910>
      big[i] = 'x';
    ...
    1268:	46078a23          	sb	zero,1140(a5) # 96d8 <__global_pointer$+0x910>
    char *args2[] = { big, big, big, 0 };
    126c:	00007797          	auipc	a5,0x7
    1270:	f2c78793          	addi	a5,a5,-212 # 8198 <malloc+0x24ac>
    ...
    1294:	ed850513          	addi	a0,a0,-296 # 6168 <malloc+0x47c>
    ...
    12ac:	6a050513          	addi	a0,a0,1696 # 6948 <malloc+0xc5c>
    12b0:	00005097          	auipc	ra,0x5
    12b4:	97e080e7          	jalr	-1666(ra) # 5c2e <printf>
      exit(1);
    12b8:	4505                	li	a0,1
    ...
    12cc:	5f850513          	addi	a0,a0,1528 # 68c0 <malloc+0xbd4>
    12d0:	00005097          	auipc	ra,0x5
    12d4:	95e080e7          	jalr	-1698(ra) # 5c2e <printf>
    exit(1);
    12d8:	4505                	li	a0,1
    ...
    12ec:	5f850513          	addi	a0,a0,1528 # 68e0 <malloc+0xbf4>
    12f0:	00005097          	auipc	ra,0x5
    12f4:	93e080e7          	jalr	-1730(ra) # 5c2e <printf>
    exit(1);
    12f8:	4505                	li	a0,1
    ...
    130e:	5f650513          	addi	a0,a0,1526 # 6900 <malloc+0xc14>
    1312:	00005097          	auipc	ra,0x5
    1316:	91c080e7          	jalr	-1764(ra) # 5c2e <printf>
    exit(1);
    131a:	4505                	li	a0,1
    ...
    132e:	5fe50513          	addi	a0,a0,1534 # 6928 <malloc+0xc3c>
    1332:	00005097          	auipc	ra,0x5
    1336:	8fc080e7          	jalr	-1796(ra) # 5c2e <printf>
    exit(1);
    133a:	4505                	li	a0,1
    ...
    1348:	a7c50513          	addi	a0,a0,-1412 # 6dc0 <malloc+0x10d4>
    134c:	00005097          	auipc	ra,0x5
    1350:	8e2080e7          	jalr	-1822(ra) # 5c2e <printf>
    exit(1);
    1354:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1392:	5e250513          	addi	a0,a0,1506 # 6970 <malloc+0xc84>
    1396:	00005097          	auipc	ra,0x5
    139a:	898080e7          	jalr	-1896(ra) # 5c2e <printf>
    exit(1);
    139e:	4505                	li	a0,1
...
00000000000013a8 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c4:	e0050513          	addi	a0,a0,-512 # 61c0 <malloc+0x4d4>
  ...
  if(pid == 0){
    ...
    13ee:	dd6a0a13          	addi	s4,s4,-554 # 61c0 <malloc+0x4d4>
      int n = write(fd, "1234567890", 10);
    13f2:	00005a97          	auipc	s5,0x5
    13f6:	5dea8a93          	addi	s5,s5,1502 # 69d0 <malloc+0xce4>
      int fd = open("truncfile", O_WRONLY);
    13fa:	4585                	li	a1,1
    13fc:	8552                	mv	a0,s4
    ...
    1466:	53e50513          	addi	a0,a0,1342 # 69a0 <malloc+0xcb4>
    146a:	00004097          	auipc	ra,0x4
    146e:	7c4080e7          	jalr	1988(ra) # 5c2e <printf>
    exit(1);
    1472:	4505                	li	a0,1
    ...
    1482:	53a50513          	addi	a0,a0,1338 # 69b8 <malloc+0xccc>
    1486:	00004097          	auipc	ra,0x4
    148a:	7a8080e7          	jalr	1960(ra) # 5c2e <printf>
        exit(1);
    148e:	4505                	li	a0,1
    ...
    14a0:	54450513          	addi	a0,a0,1348 # 69e0 <malloc+0xcf4>
    14a4:	00004097          	auipc	ra,0x4
    14a8:	78a080e7          	jalr	1930(ra) # 5c2e <printf>
        exit(1);
    14ac:	4505                	li	a0,1
    ...
    14be:	d06a0a13          	addi	s4,s4,-762 # 61c0 <malloc+0x4d4>
    int n = write(fd, "xxx", 3);
    14c2:	00005a97          	auipc	s5,0x5
    14c6:	53ea8a93          	addi	s5,s5,1342 # 6a00 <malloc+0xd14>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1510:	cb450513          	addi	a0,a0,-844 # 61c0 <malloc+0x4d4>
  ...
  exit(xstatus);
    ...
    152e:	48e50513          	addi	a0,a0,1166 # 69b8 <malloc+0xccc>
    1532:	00004097          	auipc	ra,0x4
    1536:	6fc080e7          	jalr	1788(ra) # 5c2e <printf>
      exit(1);
    153a:	4505                	li	a0,1
    ...
    154c:	4c050513          	addi	a0,a0,1216 # 6a08 <malloc+0xd1c>
    1550:	00004097          	auipc	ra,0x4
    1554:	6de080e7          	jalr	1758(ra) # 5c2e <printf>
      exit(1);
    1558:	4505                	li	a0,1
...
0000000000001562 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1574:	bf878793          	addi	a5,a5,-1032 # 6168 <malloc+0x47c>
    1578:	fcf43023          	sd	a5,-64(s0)
    157c:	00005797          	auipc	a5,0x5
    1580:	4ac78793          	addi	a5,a5,1196 # 6a28 <malloc+0xd3c>
    1584:	fcf43423          	sd	a5,-56(s0)
    1588:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158c:	00005517          	auipc	a0,0x5
    1590:	4a450513          	addi	a0,a0,1188 # 6a30 <malloc+0xd44>
  ...
  if(pid == 0) {
    ...
    15be:	47650513          	addi	a0,a0,1142 # 6a30 <malloc+0xd44>
    ...
    15da:	47a50513          	addi	a0,a0,1146 # 6a50 <malloc+0xd64>
    15de:	00004097          	auipc	ra,0x4
    15e2:	650080e7          	jalr	1616(ra) # 5c2e <printf>
      exit(1);
    15e6:	4505                	li	a0,1
    ...
    15f6:	3ae50513          	addi	a0,a0,942 # 69a0 <malloc+0xcb4>
    15fa:	00004097          	auipc	ra,0x4
    15fe:	634080e7          	jalr	1588(ra) # 5c2e <printf>
     exit(1);
    1602:	4505                	li	a0,1
    ...
    1612:	42a50513          	addi	a0,a0,1066 # 6a38 <malloc+0xd4c>
    1616:	00004097          	auipc	ra,0x4
    161a:	618080e7          	jalr	1560(ra) # 5c2e <printf>
      exit(1);
    161e:	4505                	li	a0,1
    ...
    1630:	b3c50513          	addi	a0,a0,-1220 # 6168 <malloc+0x47c>
  ...
  if(xstatus != 0)
    ...
    1664:	40050513          	addi	a0,a0,1024 # 6a60 <malloc+0xd74>
    1668:	00004097          	auipc	ra,0x4
    166c:	5c6080e7          	jalr	1478(ra) # 5c2e <printf>
      exit(1);
    1670:	4505                	li	a0,1
    ...
    1680:	3fc50513          	addi	a0,a0,1020 # 6a78 <malloc+0xd8c>
    1684:	00004097          	auipc	ra,0x4
    1688:	5aa080e7          	jalr	1450(ra) # 5c2e <printf>
    168c:	b7d1                	j	1650 <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    168e:	4581                	li	a1,0
    1690:	00005517          	auipc	a0,0x5
    1694:	3a050513          	addi	a0,a0,928 # 6a30 <malloc+0xd44>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16be:	e3e50513          	addi	a0,a0,-450 # 64f8 <malloc+0x80c>
    16c2:	00004097          	auipc	ra,0x4
    16c6:	56c080e7          	jalr	1388(ra) # 5c2e <printf>
    exit(1);
    16ca:	4505                	li	a0,1
    ...
    16da:	2e250513          	addi	a0,a0,738 # 69b8 <malloc+0xccc>
    16de:	00004097          	auipc	ra,0x4
    16e2:	550080e7          	jalr	1360(ra) # 5c2e <printf>
    exit(1);
    16e6:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    16f4:	34050513          	addi	a0,a0,832 # 6a30 <malloc+0xd44>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171e:	37650513          	addi	a0,a0,886 # 6a90 <malloc+0xda4>
    1722:	00004097          	auipc	ra,0x4
    1726:	50c080e7          	jalr	1292(ra) # 5c2e <printf>
    exit(1);
    172a:	4505                	li	a0,1
...
000000000000173e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    178a:	66aa8a93          	addi	s5,s5,1642 # bdf0 <buf>
      if(cc > sizeof(buf))
    ...
    17a8:	64c70713          	addi	a4,a4,1612 # bdf0 <buf>
    ...
    17e0:	2cc50513          	addi	a0,a0,716 # 6aa8 <malloc+0xdbc>
    17e4:	00004097          	auipc	ra,0x4
    17e8:	44a080e7          	jalr	1098(ra) # 5c2e <printf>
    exit(1);
    17ec:	4505                	li	a0,1
    ...
    1806:	5eeb0b13          	addi	s6,s6,1518 # bdf0 <buf>
    ...
    181a:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x85>
{
    ...
    1866:	25e50513          	addi	a0,a0,606 # 6ac0 <malloc+0xdd4>
    186a:	00004097          	auipc	ra,0x4
    186e:	3c4080e7          	jalr	964(ra) # 5c2e <printf>
        exit(1);
    1872:	4505                	li	a0,1
    ...
    1882:	25a50513          	addi	a0,a0,602 # 6ad8 <malloc+0xdec>
    1886:	00004097          	auipc	ra,0x4
    188a:	3a8080e7          	jalr	936(ra) # 5c2e <printf>
}
    ...
    18b4:	24050513          	addi	a0,a0,576 # 6af0 <malloc+0xe04>
    18b8:	00004097          	auipc	ra,0x4
    18bc:	376080e7          	jalr	886(ra) # 5c2e <printf>
      exit(1);
    18c0:	4505                	li	a0,1
    ...
    18f4:	22050513          	addi	a0,a0,544 # 6b10 <malloc+0xe24>
    18f8:	00004097          	auipc	ra,0x4
    18fc:	336080e7          	jalr	822(ra) # 5c2e <printf>
    exit(1);
    1900:	4505                	li	a0,1
...
000000000000190a <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1966:	03e50513          	addi	a0,a0,62 # 69a0 <malloc+0xcb4>
    196a:	00004097          	auipc	ra,0x4
    196e:	2c4080e7          	jalr	708(ra) # 5c2e <printf>
      exit(1);
    1972:	4505                	li	a0,1
    ...
    1982:	1aa50513          	addi	a0,a0,426 # 6b28 <malloc+0xe3c>
    1986:	00004097          	auipc	ra,0x4
    198a:	2a8080e7          	jalr	680(ra) # 5c2e <printf>
        exit(1);
    198e:	4505                	li	a0,1
    ...
    199e:	1a650513          	addi	a0,a0,422 # 6b40 <malloc+0xe54>
    19a2:	00004097          	auipc	ra,0x4
    19a6:	28c080e7          	jalr	652(ra) # 5c2e <printf>
        exit(1);
    19aa:	4505                	li	a0,1
...
00000000000019be <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a16:	f8e50513          	addi	a0,a0,-114 # 69a0 <malloc+0xcb4>
    1a1a:	00004097          	auipc	ra,0x4
    1a1e:	214080e7          	jalr	532(ra) # 5c2e <printf>
      exit(1);
    1a22:	4505                	li	a0,1
    ...
    1a3a:	f6a50513          	addi	a0,a0,-150 # 69a0 <malloc+0xcb4>
    1a3e:	00004097          	auipc	ra,0x4
    1a42:	1f0080e7          	jalr	496(ra) # 5c2e <printf>
        exit(1);
    1a46:	4505                	li	a0,1
...
0000000000001a58 <forkfork>:
{
    ...
    1ab4:	0b050513          	addi	a0,a0,176 # 6b60 <malloc+0xe74>
    1ab8:	00004097          	auipc	ra,0x4
    1abc:	176080e7          	jalr	374(ra) # 5c2e <printf>
      exit(1);
    1ac0:	4505                	li	a0,1
    ...
    1ac6:	d90080e7          	jalr	-624(ra) # 5852 <exit>
{
    ...
    1b0c:	06850513          	addi	a0,a0,104 # 6b70 <malloc+0xe84>
    1b10:	00004097          	auipc	ra,0x4
    1b14:	11e080e7          	jalr	286(ra) # 5c2e <printf>
      exit(1);
    1b18:	4505                	li	a0,1
...
0000000000001b22 <reparent2>:
{
  ...
  exit(0);
    ...
    1b5a:	26a50513          	addi	a0,a0,618 # 6dc0 <malloc+0x10d4>
    1b5e:	00004097          	auipc	ra,0x4
    1b62:	0d0080e7          	jalr	208(ra) # 5c2e <printf>
      exit(1);
    1b66:	4505                	li	a0,1
...
0000000000001b8a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf8:	1cc50513          	addi	a0,a0,460 # 6dc0 <malloc+0x10d4>
    1bfc:	00004097          	auipc	ra,0x4
    1c00:	032080e7          	jalr	50(ra) # 5c2e <printf>
      exit(1);
    1c04:	4505                	li	a0,1
    ...
    1c24:	e1850513          	addi	a0,a0,-488 # 6a38 <malloc+0xd4c>
    1c28:	00004097          	auipc	ra,0x4
    1c2c:	006080e7          	jalr	6(ra) # 5c2e <printf>
          exit(1);
    1c30:	4505                	li	a0,1
    ...
    1c96:	efe50513          	addi	a0,a0,-258 # 6b90 <malloc+0xea4>
    1c9a:	00004097          	auipc	ra,0x4
    1c9e:	f94080e7          	jalr	-108(ra) # 5c2e <printf>
            exit(1);
    1ca2:	4505                	li	a0,1
    ...
    1cca:	ee250513          	addi	a0,a0,-286 # 6ba8 <malloc+0xebc>
    1cce:	00004097          	auipc	ra,0x4
    1cd2:	f60080e7          	jalr	-160(ra) # 5c2e <printf>
        exit(1);
    1cd6:	4505                	li	a0,1
    ...
    1d30:	ea450513          	addi	a0,a0,-348 # 6bd0 <malloc+0xee4>
    1d34:	00004097          	auipc	ra,0x4
    1d38:	efa080e7          	jalr	-262(ra) # 5c2e <printf>
        exit(1);
    1d3c:	4505                	li	a0,1
...
0000000000001db0 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dd0:	40c50513          	addi	a0,a0,1036 # 61d8 <malloc+0x4ec>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e0c:	3d0a8a93          	addi	s5,s5,976 # 61d8 <malloc+0x4ec>
      link("cat", "x");
    1e10:	00005b97          	auipc	s7,0x5
    1e14:	de8b8b93          	addi	s7,s7,-536 # 6bf8 <malloc+0xf0c>
    1e18:	a091                	j	1e5c <linkunlink+0xac>
    printf("%s: fork failed\n", s);
    1e1a:	85a6                	mv	a1,s1
    1e1c:	00005517          	auipc	a0,0x5
    1e20:	b8450513          	addi	a0,a0,-1148 # 69a0 <malloc+0xcb4>
    1e24:	00004097          	auipc	ra,0x4
    1e28:	e0a080e7          	jalr	-502(ra) # 5c2e <printf>
    exit(1);
    1e2c:	4505                	li	a0,1
...
0000000000001eb2 <manywrites>:
{
  ...
  exit(0);
    ...
    1f0e:	eb650513          	addi	a0,a0,-330 # 6dc0 <malloc+0x10d4>
    1f12:	00004097          	auipc	ra,0x4
    1f16:	d1c080e7          	jalr	-740(ra) # 5c2e <printf>
      exit(1);
    1f1a:	4505                	li	a0,1
    ...
    1f4a:	eaab8b93          	addi	s7,s7,-342 # bdf0 <buf>
    ...
    1fbe:	c4650513          	addi	a0,a0,-954 # 6c00 <malloc+0xf14>
    1fc2:	00004097          	auipc	ra,0x4
    1fc6:	c6c080e7          	jalr	-916(ra) # 5c2e <printf>
            exit(1);
    1fca:	4505                	li	a0,1
    ...
    1fde:	24e50513          	addi	a0,a0,590 # 6228 <malloc+0x53c>
    1fe2:	00004097          	auipc	ra,0x4
    1fe6:	c4c080e7          	jalr	-948(ra) # 5c2e <printf>
            exit(1);
    1fea:	4505                	li	a0,1
...
0000000000001ffc <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    202c:	c0850513          	addi	a0,a0,-1016 # 6c30 <malloc+0xf44>
    2030:	00004097          	auipc	ra,0x4
    2034:	bfe080e7          	jalr	-1026(ra) # 5c2e <printf>
    exit(1);
    2038:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    208e:	b8e50513          	addi	a0,a0,-1138 # 6c18 <malloc+0xf2c>
    2092:	00004097          	auipc	ra,0x4
    2096:	b9c080e7          	jalr	-1124(ra) # 5c2e <printf>
    exit(1);
    209a:	4505                	li	a0,1
    ...
    20aa:	bb250513          	addi	a0,a0,-1102 # 6c58 <malloc+0xf6c>
    20ae:	00004097          	auipc	ra,0x4
    20b2:	b80080e7          	jalr	-1152(ra) # 5c2e <printf>
      exit(1);
    20b6:	4505                	li	a0,1
    ...
    20c6:	bae50513          	addi	a0,a0,-1106 # 6c70 <malloc+0xf84>
    20ca:	00004097          	auipc	ra,0x4
    20ce:	b64080e7          	jalr	-1180(ra) # 5c2e <printf>
    exit(1);
    20d2:	4505                	li	a0,1
...
00000000000020dc <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    20f8:	35098993          	addi	s3,s3,848 # c350 <buf+0x560>
    20fc:	1003d937          	lui	s2,0x1003d
    2100:	090e                	slli	s2,s2,0x3
    2102:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e680>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2146:	85e50513          	addi	a0,a0,-1954 # 69a0 <malloc+0xcb4>
    214a:	00004097          	auipc	ra,0x4
    214e:	ae4080e7          	jalr	-1308(ra) # 5c2e <printf>
      exit(1);
    2152:	4505                	li	a0,1
    ...
    2168:	b2450513          	addi	a0,a0,-1244 # 6c88 <malloc+0xf9c>
    216c:	00004097          	auipc	ra,0x4
    2170:	ac2080e7          	jalr	-1342(ra) # 5c2e <printf>
      exit(1);
    2174:	4505                	li	a0,1
...
0000000000002188 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    21ea:	7ba50513          	addi	a0,a0,1978 # 69a0 <malloc+0xcb4>
    21ee:	00004097          	auipc	ra,0x4
    21f2:	a40080e7          	jalr	-1472(ra) # 5c2e <printf>
      exit(1);
    21f6:	4505                	li	a0,1
    ...
    2216:	a9650513          	addi	a0,a0,-1386 # 6ca8 <malloc+0xfbc>
    221a:	00004097          	auipc	ra,0x4
    221e:	a14080e7          	jalr	-1516(ra) # 5c2e <printf>
      exit(1);
    2222:	4505                	li	a0,1
...
0000000000002236 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2246:	a7e50513          	addi	a0,a0,-1410 # 6cc0 <malloc+0xfd4>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2278:	a4c50513          	addi	a0,a0,-1460 # 6cc0 <malloc+0xfd4>
  ...
  close(fd);
    ...
    229e:	33e78793          	addi	a5,a5,830 # 85d8 <args.1888>
    22a2:	00006697          	auipc	a3,0x6
    22a6:	42e68693          	addi	a3,a3,1070 # 86d0 <args.1888+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    22aa:	00005717          	auipc	a4,0x5
    22ae:	a2670713          	addi	a4,a4,-1498 # 6cd0 <malloc+0xfe4>
    ...
    2302:	ab250513          	addi	a0,a0,-1358 # 6db0 <malloc+0x10c4>
    2306:	00004097          	auipc	ra,0x4
    230a:	928080e7          	jalr	-1752(ra) # 5c2e <printf>
    exit(1);
    230e:	4505                	li	a0,1
    ...
    2326:	aae50513          	addi	a0,a0,-1362 # 6dd0 <malloc+0x10e4>
    232a:	00004097          	auipc	ra,0x4
    232e:	904080e7          	jalr	-1788(ra) # 5c2e <printf>
    exit(1);
    2332:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    237a:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff0200>
    237e:	85a6                	mv	a1,s1
    2380:	00005517          	auipc	a0,0x5
    2384:	a7050513          	addi	a0,a0,-1424 # 6df0 <malloc+0x1104>
    2388:	00004097          	auipc	ra,0x4
    238c:	8a6080e7          	jalr	-1882(ra) # 5c2e <printf>
    exit(1);
    2390:	4505                	li	a0,1
    ...
    23a0:	60450513          	addi	a0,a0,1540 # 69a0 <malloc+0xcb4>
    23a4:	00004097          	auipc	ra,0x4
    23a8:	88a080e7          	jalr	-1910(ra) # 5c2e <printf>
    exit(1);
    23ac:	4505                	li	a0,1
...
00000000000023c0 <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    243a:	65278793          	addi	a5,a5,1618 # 7a88 <malloc+0x1d9c>
  ...
  if(ret != -1){
    ...
    247c:	9a050513          	addi	a0,a0,-1632 # 6e18 <malloc+0x112c>
    2480:	00003097          	auipc	ra,0x3
    2484:	7ae080e7          	jalr	1966(ra) # 5c2e <printf>
    exit(1);
    2488:	4505                	li	a0,1
    ...
    249a:	42a50513          	addi	a0,a0,1066 # 68c0 <malloc+0xbd4>
    249e:	00003097          	auipc	ra,0x3
    24a2:	790080e7          	jalr	1936(ra) # 5c2e <printf>
    exit(1);
    24a6:	4505                	li	a0,1
    ...
    24b8:	42c50513          	addi	a0,a0,1068 # 68e0 <malloc+0xbf4>
    24bc:	00003097          	auipc	ra,0x3
    24c0:	772080e7          	jalr	1906(ra) # 5c2e <printf>
    exit(1);
    24c4:	4505                	li	a0,1
    ...
    24d8:	42c50513          	addi	a0,a0,1068 # 6900 <malloc+0xc14>
    24dc:	00003097          	auipc	ra,0x3
    24e0:	752080e7          	jalr	1874(ra) # 5c2e <printf>
    exit(1);
    24e4:	4505                	li	a0,1
    ...
    24f6:	43650513          	addi	a0,a0,1078 # 6928 <malloc+0xc3c>
    24fa:	00003097          	auipc	ra,0x3
    24fe:	734080e7          	jalr	1844(ra) # 5c2e <printf>
    exit(1);
    2502:	4505                	li	a0,1
...
000000000000250c <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2542:	91a50513          	addi	a0,a0,-1766 # 5e58 <malloc+0x16c>
  ...
  if(n >= 0){
    ...
    2574:	90050513          	addi	a0,a0,-1792 # 6e70 <malloc+0x1184>
    2578:	00003097          	auipc	ra,0x3
    257c:	6b6080e7          	jalr	1718(ra) # 5c2e <printf>
    exit(1);
    2580:	4505                	li	a0,1
    ...
    258e:	89650513          	addi	a0,a0,-1898 # 6e20 <malloc+0x1134>
    2592:	00003097          	auipc	ra,0x3
    2596:	69c080e7          	jalr	1692(ra) # 5c2e <printf>
    exit(1);
    259a:	4505                	li	a0,1
    ...
    25a8:	89450513          	addi	a0,a0,-1900 # 6e38 <malloc+0x114c>
    25ac:	00003097          	auipc	ra,0x3
    25b0:	682080e7          	jalr	1666(ra) # 5c2e <printf>
    exit(1);
    25b4:	4505                	li	a0,1
    ...
    25c2:	89a50513          	addi	a0,a0,-1894 # 6e58 <malloc+0x116c>
    25c6:	00003097          	auipc	ra,0x3
    25ca:	668080e7          	jalr	1640(ra) # 5c2e <printf>
    exit(1);
    25ce:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    25e6:	87650513          	addi	a0,a0,-1930 # 5e58 <malloc+0x16c>
    25ea:	00003097          	auipc	ra,0x3
    25ee:	2b8080e7          	jalr	696(ra) # 58a2 <unlink>
  fd = open("README", O_RDONLY);
    25f2:	4581                	li	a1,0
    25f4:	00004517          	auipc	a0,0x4
    25f8:	d0c50513          	addi	a0,a0,-756 # 6300 <malloc+0x614>
  ...
  if(n >= 0){
    ...
    2622:	88250513          	addi	a0,a0,-1918 # 6ea0 <malloc+0x11b4>
    2626:	00003097          	auipc	ra,0x3
    262a:	608080e7          	jalr	1544(ra) # 5c2e <printf>
    exit(1);
    262e:	4505                	li	a0,1
    ...
    263c:	82050513          	addi	a0,a0,-2016 # 6e58 <malloc+0x116c>
    2640:	00003097          	auipc	ra,0x3
    2644:	5ee080e7          	jalr	1518(ra) # 5c2e <printf>
    exit(1);
    2648:	4505                	li	a0,1
...
0000000000002666 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    26a4:	6705                	lui	a4,0x1
      *b = 99;
    26a6:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff1200>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    26be:	80e50513          	addi	a0,a0,-2034 # 6ec8 <malloc+0x11dc>
    26c2:	00003097          	auipc	ra,0x3
    26c6:	56c080e7          	jalr	1388(ra) # 5c2e <printf>
    exit(1);
    26ca:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2712:	7da50513          	addi	a0,a0,2010 # 6ee8 <malloc+0x11fc>
    2716:	00003097          	auipc	ra,0x3
    271a:	518080e7          	jalr	1304(ra) # 5c2e <printf>
    exit(1);
    271e:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    2774:	7d850513          	addi	a0,a0,2008 # 6f48 <malloc+0x125c>
    2778:	00003097          	auipc	ra,0x3
    277c:	4b6080e7          	jalr	1206(ra) # 5c2e <printf>
    exit(1);
    2780:	4505                	li	a0,1
    ...
    2796:	77650513          	addi	a0,a0,1910 # 6f08 <malloc+0x121c>
    279a:	00003097          	auipc	ra,0x3
    279e:	494080e7          	jalr	1172(ra) # 5c2e <printf>
      exit(1);
    27a2:	4505                	li	a0,1
    ...
    27b2:	77a50513          	addi	a0,a0,1914 # 6f28 <malloc+0x123c>
    27b6:	00003097          	auipc	ra,0x3
    27ba:	478080e7          	jalr	1144(ra) # 5c2e <printf>
    exit(1);
    27be:	4505                	li	a0,1
...
00000000000027ee <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2850:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f11ff>
  a = sbrk(0);
    2854:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    28b4:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f11ff>
  ...
  if(c != a){
    ...
    28fc:	67050513          	addi	a0,a0,1648 # 6f68 <malloc+0x127c>
    2900:	00003097          	auipc	ra,0x3
    2904:	32e080e7          	jalr	814(ra) # 5c2e <printf>
    exit(1);
    2908:	4505                	li	a0,1
    ...
    2918:	69c50513          	addi	a0,a0,1692 # 6fb0 <malloc+0x12c4>
    291c:	00003097          	auipc	ra,0x3
    2920:	312080e7          	jalr	786(ra) # 5c2e <printf>
    exit(1);
    2924:	4505                	li	a0,1
    ...
    2938:	69c50513          	addi	a0,a0,1692 # 6fd0 <malloc+0x12e4>
    293c:	00003097          	auipc	ra,0x3
    2940:	2f2080e7          	jalr	754(ra) # 5c2e <printf>
    exit(1);
    2944:	4505                	li	a0,1
    ...
    2958:	6bc50513          	addi	a0,a0,1724 # 7010 <malloc+0x1324>
    295c:	00003097          	auipc	ra,0x3
    2960:	2d2080e7          	jalr	722(ra) # 5c2e <printf>
    exit(1);
    2964:	4505                	li	a0,1
    ...
    2974:	6d050513          	addi	a0,a0,1744 # 7040 <malloc+0x1354>
    2978:	00003097          	auipc	ra,0x3
    297c:	2b6080e7          	jalr	694(ra) # 5c2e <printf>
    exit(1);
    2980:	4505                	li	a0,1
    ...
    2994:	6e850513          	addi	a0,a0,1768 # 7078 <malloc+0x138c>
    2998:	00003097          	auipc	ra,0x3
    299c:	296080e7          	jalr	662(ra) # 5c2e <printf>
    exit(1);
    29a0:	4505                	li	a0,1
...
00000000000029aa <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    29ce:	6d650513          	addi	a0,a0,1750 # 70a0 <malloc+0x13b4>
    29d2:	00003097          	auipc	ra,0x3
    29d6:	ec0080e7          	jalr	-320(ra) # 5892 <open>
    29da:	84aa                	mv	s1,a0
  unlink("sbrk");
    29dc:	00004517          	auipc	a0,0x4
    29e0:	6c450513          	addi	a0,a0,1732 # 70a0 <malloc+0x13b4>
  ...
  if(pipe((int *) a) != 0){
    ...
    2a34:	67850513          	addi	a0,a0,1656 # 70a8 <malloc+0x13bc>
    2a38:	00003097          	auipc	ra,0x3
    2a3c:	1f6080e7          	jalr	502(ra) # 5c2e <printf>
    exit(1);
    2a40:	4505                	li	a0,1
    ...
    2a50:	67450513          	addi	a0,a0,1652 # 70c0 <malloc+0x13d4>
    2a54:	00003097          	auipc	ra,0x3
    2a58:	1da080e7          	jalr	474(ra) # 5c2e <printf>
    exit(1);
    2a5c:	4505                	li	a0,1
    ...
    2a6c:	04050513          	addi	a0,a0,64 # 6aa8 <malloc+0xdbc>
    2a70:	00003097          	auipc	ra,0x3
    2a74:	1be080e7          	jalr	446(ra) # 5c2e <printf>
    exit(1);
    2a78:	4505                	li	a0,1
...
0000000000002a82 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2a96:	64650513          	addi	a0,a0,1606 # 70d8 <malloc+0x13ec>
  ...
  close(fd);
    ...
    2ade:	ede50513          	addi	a0,a0,-290 # 69b8 <malloc+0xccc>
    2ae2:	00003097          	auipc	ra,0x3
    2ae6:	14c080e7          	jalr	332(ra) # 5c2e <printf>
    exit(1);
    2aea:	4505                	li	a0,1
...
0000000000002af4 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2b2c:	29850513          	addi	a0,a0,664 # 6dc0 <malloc+0x10d4>
    2b30:	00003097          	auipc	ra,0x3
    2b34:	0fe080e7          	jalr	254(ra) # 5c2e <printf>
    exit(1);
    2b38:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2b82:	24250513          	addi	a0,a0,578 # 6dc0 <malloc+0x10d4>
    2b86:	00003097          	auipc	ra,0x3
    2b8a:	0a8080e7          	jalr	168(ra) # 5c2e <printf>
    exit(1);
    2b8e:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2be2:	1e250513          	addi	a0,a0,482 # 6dc0 <malloc+0x10d4>
    2be6:	00003097          	auipc	ra,0x3
    2bea:	048080e7          	jalr	72(ra) # 5c2e <printf>
    exit(1);
    2bee:	4505                	li	a0,1
...
0000000000002cde <sbrk8000>:
{
  ...
  *(top-1) = *(top-1) + 1;
    2cfe:	fff54783          	lbu	a5,-1(a0) # ffffffff7fffffff <__BSS_END__+0xffffffff7fff11ff>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2d56:	06e50513          	addi	a0,a0,110 # 6dc0 <malloc+0x10d4>
    2d5a:	00003097          	auipc	ra,0x3
    2d5e:	ed4080e7          	jalr	-300(ra) # 5c2e <printf>
      exit(1);
    2d62:	4505                	li	a0,1
    ...
    2daa:	3c250513          	addi	a0,a0,962 # 6168 <malloc+0x47c>
    2dae:	faa43c23          	sd	a0,-72(s0)
    2db2:	00003797          	auipc	a5,0x3
    2db6:	42678793          	addi	a5,a5,1062 # 61d8 <malloc+0x4ec>
...
0000000000002dd8 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2de8:	4cc50513          	addi	a0,a0,1228 # 72b0 <malloc+0x15c4>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2dfa:	31250513          	addi	a0,a0,786 # 7108 <malloc+0x141c>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2e10:	35450513          	addi	a0,a0,852 # 7160 <malloc+0x1474>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2e2e:	3ae50513          	addi	a0,a0,942 # 71d8 <malloc+0x14ec>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2e4a:	40250513          	addi	a0,a0,1026 # 7248 <malloc+0x155c>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2e5c:	44850513          	addi	a0,a0,1096 # 72a0 <malloc+0x15b4>
  ...
  unlink("12345678901234");
    ...
    2eda:	20a50513          	addi	a0,a0,522 # 70e0 <malloc+0x13f4>
    2ede:	00003097          	auipc	ra,0x3
    2ee2:	d50080e7          	jalr	-688(ra) # 5c2e <printf>
    exit(1);
    2ee6:	4505                	li	a0,1
    ...
    2ef6:	23650513          	addi	a0,a0,566 # 7128 <malloc+0x143c>
    2efa:	00003097          	auipc	ra,0x3
    2efe:	d34080e7          	jalr	-716(ra) # 5c2e <printf>
    exit(1);
    2f02:	4505                	li	a0,1
    ...
    2f12:	28250513          	addi	a0,a0,642 # 7190 <malloc+0x14a4>
    2f16:	00003097          	auipc	ra,0x3
    2f1a:	d18080e7          	jalr	-744(ra) # 5c2e <printf>
    exit(1);
    2f1e:	4505                	li	a0,1
    ...
    2f2e:	2de50513          	addi	a0,a0,734 # 7208 <malloc+0x151c>
    2f32:	00003097          	auipc	ra,0x3
    2f36:	cfc080e7          	jalr	-772(ra) # 5c2e <printf>
    exit(1);
    2f3a:	4505                	li	a0,1
    ...
    2f4a:	32250513          	addi	a0,a0,802 # 7268 <malloc+0x157c>
    2f4e:	00003097          	auipc	ra,0x3
    2f52:	ce0080e7          	jalr	-800(ra) # 5c2e <printf>
    exit(1);
    2f56:	4505                	li	a0,1
    ...
    2f66:	35e50513          	addi	a0,a0,862 # 72c0 <malloc+0x15d4>
    2f6a:	00003097          	auipc	ra,0x3
    2f6e:	cc4080e7          	jalr	-828(ra) # 5c2e <printf>
    exit(1);
    2f72:	4505                	li	a0,1
...
0000000000002f7c <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2f8c:	37050513          	addi	a0,a0,880 # 72f8 <malloc+0x160c>
  ...
  if(chdir("iputdir") < 0){
    ...
    2fa0:	35c50513          	addi	a0,a0,860 # 72f8 <malloc+0x160c>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2fb4:	38850513          	addi	a0,a0,904 # 7338 <malloc+0x164c>
  ...
  if(chdir("/") < 0){
    ...
    2fc8:	3a450513          	addi	a0,a0,932 # 7368 <malloc+0x167c>
    ...
    2fe8:	31c50513          	addi	a0,a0,796 # 7300 <malloc+0x1614>
    2fec:	00003097          	auipc	ra,0x3
    2ff0:	c42080e7          	jalr	-958(ra) # 5c2e <printf>
    exit(1);
    2ff4:	4505                	li	a0,1
    ...
    3004:	31850513          	addi	a0,a0,792 # 7318 <malloc+0x162c>
    3008:	00003097          	auipc	ra,0x3
    300c:	c26080e7          	jalr	-986(ra) # 5c2e <printf>
    exit(1);
    3010:	4505                	li	a0,1
    ...
    3020:	32c50513          	addi	a0,a0,812 # 7348 <malloc+0x165c>
    3024:	00003097          	auipc	ra,0x3
    3028:	c0a080e7          	jalr	-1014(ra) # 5c2e <printf>
    exit(1);
    302c:	4505                	li	a0,1
    ...
    303c:	33850513          	addi	a0,a0,824 # 7370 <malloc+0x1684>
    3040:	00003097          	auipc	ra,0x3
    3044:	bee080e7          	jalr	-1042(ra) # 5c2e <printf>
    exit(1);
    3048:	4505                	li	a0,1
...
0000000000003052 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    3070:	28c50513          	addi	a0,a0,652 # 72f8 <malloc+0x160c>
    ...
    3084:	27850513          	addi	a0,a0,632 # 72f8 <malloc+0x160c>
    ...
    3098:	2a450513          	addi	a0,a0,676 # 7338 <malloc+0x164c>
    ...
    30b8:	8ec50513          	addi	a0,a0,-1812 # 69a0 <malloc+0xcb4>
    30bc:	00003097          	auipc	ra,0x3
    30c0:	b72080e7          	jalr	-1166(ra) # 5c2e <printf>
    exit(1);
    30c4:	4505                	li	a0,1
    ...
    30d4:	23050513          	addi	a0,a0,560 # 7300 <malloc+0x1614>
    30d8:	00003097          	auipc	ra,0x3
    30dc:	b56080e7          	jalr	-1194(ra) # 5c2e <printf>
      exit(1);
    30e0:	4505                	li	a0,1
    ...
    30f0:	29c50513          	addi	a0,a0,668 # 7388 <malloc+0x169c>
    30f4:	00003097          	auipc	ra,0x3
    30f8:	b3a080e7          	jalr	-1222(ra) # 5c2e <printf>
      exit(1);
    30fc:	4505                	li	a0,1
    ...
    310c:	24050513          	addi	a0,a0,576 # 7348 <malloc+0x165c>
    3110:	00003097          	auipc	ra,0x3
    3114:	b1e080e7          	jalr	-1250(ra) # 5c2e <printf>
      exit(1);
    3118:	4505                	li	a0,1
...
000000000000313a <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    314a:	25a50513          	addi	a0,a0,602 # 73a0 <malloc+0x16b4>
  ...
  if(chdir("dir0") < 0){
    ...
    315e:	24650513          	addi	a0,a0,582 # 73a0 <malloc+0x16b4>
  ...
  if(chdir("..") < 0){
    ...
    3172:	25250513          	addi	a0,a0,594 # 73c0 <malloc+0x16d4>
  ...
  if(unlink("dir0") < 0){
    ...
    3186:	21e50513          	addi	a0,a0,542 # 73a0 <malloc+0x16b4>
    ...
    31a6:	15e50513          	addi	a0,a0,350 # 7300 <malloc+0x1614>
    31aa:	00003097          	auipc	ra,0x3
    31ae:	a84080e7          	jalr	-1404(ra) # 5c2e <printf>
    exit(1);
    31b2:	4505                	li	a0,1
    ...
    31c2:	1ea50513          	addi	a0,a0,490 # 73a8 <malloc+0x16bc>
    31c6:	00003097          	auipc	ra,0x3
    31ca:	a68080e7          	jalr	-1432(ra) # 5c2e <printf>
    exit(1);
    31ce:	4505                	li	a0,1
    ...
    31de:	1ee50513          	addi	a0,a0,494 # 73c8 <malloc+0x16dc>
    31e2:	00003097          	auipc	ra,0x3
    31e6:	a4c080e7          	jalr	-1460(ra) # 5c2e <printf>
    exit(1);
    31ea:	4505                	li	a0,1
    ...
    31fa:	1ea50513          	addi	a0,a0,490 # 73e0 <malloc+0x16f4>
    31fe:	00003097          	auipc	ra,0x3
    3202:	a30080e7          	jalr	-1488(ra) # 5c2e <printf>
    exit(1);
    3206:	4505                	li	a0,1
...
0000000000003210 <subdir>:
{
  ...
  unlink("ff");
    ...
    3222:	30a50513          	addi	a0,a0,778 # 7528 <malloc+0x183c>
    3226:	00002097          	auipc	ra,0x2
    322a:	67c080e7          	jalr	1660(ra) # 58a2 <unlink>
  if(mkdir("dd") != 0){
    322e:	00004517          	auipc	a0,0x4
    3232:	1ca50513          	addi	a0,a0,458 # 73f8 <malloc+0x170c>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    324a:	1d250513          	addi	a0,a0,466 # 7418 <malloc+0x172c>
  ...
  write(fd, "ff", 2);
    ...
    3262:	2ca58593          	addi	a1,a1,714 # 7528 <malloc+0x183c>
  ...
  if(unlink("dd") >= 0){
    ...
    327c:	18050513          	addi	a0,a0,384 # 73f8 <malloc+0x170c>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3290:	1e450513          	addi	a0,a0,484 # 7470 <malloc+0x1784>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32a8:	1f450513          	addi	a0,a0,500 # 7498 <malloc+0x17ac>
  ...
  write(fd, "FF", 2);
    ...
    32c0:	20c58593          	addi	a1,a1,524 # 74c8 <malloc+0x17dc>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    32dc:	1f850513          	addi	a0,a0,504 # 74d0 <malloc+0x17e4>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    32f4:	b0058593          	addi	a1,a1,-1280 # bdf0 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    330a:	aea74703          	lbu	a4,-1302(a4) # bdf0 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    3324:	20058593          	addi	a1,a1,512 # 7520 <malloc+0x1834>
    3328:	00004517          	auipc	a0,0x4
    332c:	17050513          	addi	a0,a0,368 # 7498 <malloc+0x17ac>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3340:	15c50513          	addi	a0,a0,348 # 7498 <malloc+0x17ac>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3356:	14650513          	addi	a0,a0,326 # 7498 <malloc+0x17ac>
  ...
  if(chdir("dd") != 0){
    ...
    336a:	09250513          	addi	a0,a0,146 # 73f8 <malloc+0x170c>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    337e:	23e50513          	addi	a0,a0,574 # 75b8 <malloc+0x18cc>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    3392:	25a50513          	addi	a0,a0,602 # 75e8 <malloc+0x18fc>
  ...
  if(chdir("./..") != 0){
    ...
    33a6:	27650513          	addi	a0,a0,630 # 7618 <malloc+0x192c>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    33bc:	16850513          	addi	a0,a0,360 # 7520 <malloc+0x1834>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    33d4:	a2058593          	addi	a1,a1,-1504 # bdf0 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    33f6:	0a650513          	addi	a0,a0,166 # 7498 <malloc+0x17ac>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    340e:	29e50513          	addi	a0,a0,670 # 76a8 <malloc+0x19bc>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3426:	2b650513          	addi	a0,a0,694 # 76d8 <malloc+0x19ec>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    343e:	fbe50513          	addi	a0,a0,-66 # 73f8 <malloc+0x170c>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    3454:	fa850513          	addi	a0,a0,-88 # 73f8 <malloc+0x170c>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    346a:	f9250513          	addi	a0,a0,-110 # 73f8 <malloc+0x170c>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    347e:	2ee58593          	addi	a1,a1,750 # 7768 <malloc+0x1a7c>
    3482:	00004517          	auipc	a0,0x4
    3486:	22650513          	addi	a0,a0,550 # 76a8 <malloc+0x19bc>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    349a:	2d258593          	addi	a1,a1,722 # 7768 <malloc+0x1a7c>
    349e:	00004517          	auipc	a0,0x4
    34a2:	23a50513          	addi	a0,a0,570 # 76d8 <malloc+0x19ec>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    34b6:	06e58593          	addi	a1,a1,110 # 7520 <malloc+0x1834>
    34ba:	00004517          	auipc	a0,0x4
    34be:	f5e50513          	addi	a0,a0,-162 # 7418 <malloc+0x172c>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    34d2:	1da50513          	addi	a0,a0,474 # 76a8 <malloc+0x19bc>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    34e6:	1f650513          	addi	a0,a0,502 # 76d8 <malloc+0x19ec>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    34fa:	02a50513          	addi	a0,a0,42 # 7520 <malloc+0x1834>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    350e:	1ce50513          	addi	a0,a0,462 # 76d8 <malloc+0x19ec>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3522:	18a50513          	addi	a0,a0,394 # 76a8 <malloc+0x19bc>
  ...
  if(chdir("dd/ff") == 0){
    ...
    3536:	ee650513          	addi	a0,a0,-282 # 7418 <malloc+0x172c>
  ...
  if(chdir("dd/xx") == 0){
    ...
    354a:	37250513          	addi	a0,a0,882 # 78b8 <malloc+0x1bcc>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    355e:	fc650513          	addi	a0,a0,-58 # 7520 <malloc+0x1834>
  ...
  if(unlink("dd/ff") != 0){
    ...
    3572:	eaa50513          	addi	a0,a0,-342 # 7418 <malloc+0x172c>
  ...
  if(unlink("dd") == 0){
    ...
    3586:	e7650513          	addi	a0,a0,-394 # 73f8 <malloc+0x170c>
  ...
  if(unlink("dd/dd") < 0){
    ...
    359a:	39250513          	addi	a0,a0,914 # 7928 <malloc+0x1c3c>
  ...
  if(unlink("dd") < 0){
    ...
    35ae:	e4e50513          	addi	a0,a0,-434 # 73f8 <malloc+0x170c>
    ...
    35d0:	e3450513          	addi	a0,a0,-460 # 7400 <malloc+0x1714>
    35d4:	00002097          	auipc	ra,0x2
    35d8:	65a080e7          	jalr	1626(ra) # 5c2e <printf>
    exit(1);
    35dc:	4505                	li	a0,1
    ...
    35ec:	e3850513          	addi	a0,a0,-456 # 7420 <malloc+0x1734>
    35f0:	00002097          	auipc	ra,0x2
    35f4:	63e080e7          	jalr	1598(ra) # 5c2e <printf>
    exit(1);
    35f8:	4505                	li	a0,1
    ...
    3608:	e3c50513          	addi	a0,a0,-452 # 7440 <malloc+0x1754>
    360c:	00002097          	auipc	ra,0x2
    3610:	622080e7          	jalr	1570(ra) # 5c2e <printf>
    exit(1);
    3614:	4505                	li	a0,1
    ...
    3624:	e5850513          	addi	a0,a0,-424 # 7478 <malloc+0x178c>
    3628:	00002097          	auipc	ra,0x2
    362c:	606080e7          	jalr	1542(ra) # 5c2e <printf>
    exit(1);
    3630:	4505                	li	a0,1
    ...
    3640:	e6c50513          	addi	a0,a0,-404 # 74a8 <malloc+0x17bc>
    3644:	00002097          	auipc	ra,0x2
    3648:	5ea080e7          	jalr	1514(ra) # 5c2e <printf>
    exit(1);
    364c:	4505                	li	a0,1
    ...
    365c:	e8850513          	addi	a0,a0,-376 # 74e0 <malloc+0x17f4>
    3660:	00002097          	auipc	ra,0x2
    3664:	5ce080e7          	jalr	1486(ra) # 5c2e <printf>
    exit(1);
    3668:	4505                	li	a0,1
    ...
    3678:	e8c50513          	addi	a0,a0,-372 # 7500 <malloc+0x1814>
    367c:	00002097          	auipc	ra,0x2
    3680:	5b2080e7          	jalr	1458(ra) # 5c2e <printf>
    exit(1);
    3684:	4505                	li	a0,1
    ...
    3694:	ea050513          	addi	a0,a0,-352 # 7530 <malloc+0x1844>
    3698:	00002097          	auipc	ra,0x2
    369c:	596080e7          	jalr	1430(ra) # 5c2e <printf>
    exit(1);
    36a0:	4505                	li	a0,1
    ...
    36b0:	eac50513          	addi	a0,a0,-340 # 7558 <malloc+0x186c>
    36b4:	00002097          	auipc	ra,0x2
    36b8:	57a080e7          	jalr	1402(ra) # 5c2e <printf>
    exit(1);
    36bc:	4505                	li	a0,1
    ...
    36cc:	eb050513          	addi	a0,a0,-336 # 7578 <malloc+0x188c>
    36d0:	00002097          	auipc	ra,0x2
    36d4:	55e080e7          	jalr	1374(ra) # 5c2e <printf>
    exit(1);
    36d8:	4505                	li	a0,1
    ...
    36e8:	ebc50513          	addi	a0,a0,-324 # 75a0 <malloc+0x18b4>
    36ec:	00002097          	auipc	ra,0x2
    36f0:	542080e7          	jalr	1346(ra) # 5c2e <printf>
    exit(1);
    36f4:	4505                	li	a0,1
    ...
    3704:	ec850513          	addi	a0,a0,-312 # 75c8 <malloc+0x18dc>
    3708:	00002097          	auipc	ra,0x2
    370c:	526080e7          	jalr	1318(ra) # 5c2e <printf>
    exit(1);
    3710:	4505                	li	a0,1
    ...
    3720:	edc50513          	addi	a0,a0,-292 # 75f8 <malloc+0x190c>
    3724:	00002097          	auipc	ra,0x2
    3728:	50a080e7          	jalr	1290(ra) # 5c2e <printf>
    exit(1);
    372c:	4505                	li	a0,1
    ...
    373c:	ee850513          	addi	a0,a0,-280 # 7620 <malloc+0x1934>
    3740:	00002097          	auipc	ra,0x2
    3744:	4ee080e7          	jalr	1262(ra) # 5c2e <printf>
    exit(1);
    3748:	4505                	li	a0,1
    ...
    3758:	ee450513          	addi	a0,a0,-284 # 7638 <malloc+0x194c>
    375c:	00002097          	auipc	ra,0x2
    3760:	4d2080e7          	jalr	1234(ra) # 5c2e <printf>
    exit(1);
    3764:	4505                	li	a0,1
    ...
    3774:	ee850513          	addi	a0,a0,-280 # 7658 <malloc+0x196c>
    3778:	00002097          	auipc	ra,0x2
    377c:	4b6080e7          	jalr	1206(ra) # 5c2e <printf>
    exit(1);
    3780:	4505                	li	a0,1
    ...
    3790:	eec50513          	addi	a0,a0,-276 # 7678 <malloc+0x198c>
    3794:	00002097          	auipc	ra,0x2
    3798:	49a080e7          	jalr	1178(ra) # 5c2e <printf>
    exit(1);
    379c:	4505                	li	a0,1
    ...
    37ac:	f1050513          	addi	a0,a0,-240 # 76b8 <malloc+0x19cc>
    37b0:	00002097          	auipc	ra,0x2
    37b4:	47e080e7          	jalr	1150(ra) # 5c2e <printf>
    exit(1);
    37b8:	4505                	li	a0,1
    ...
    37c8:	f2450513          	addi	a0,a0,-220 # 76e8 <malloc+0x19fc>
    37cc:	00002097          	auipc	ra,0x2
    37d0:	462080e7          	jalr	1122(ra) # 5c2e <printf>
    exit(1);
    37d4:	4505                	li	a0,1
    ...
    37e4:	f2850513          	addi	a0,a0,-216 # 7708 <malloc+0x1a1c>
    37e8:	00002097          	auipc	ra,0x2
    37ec:	446080e7          	jalr	1094(ra) # 5c2e <printf>
    exit(1);
    37f0:	4505                	li	a0,1
    ...
    3800:	f2c50513          	addi	a0,a0,-212 # 7728 <malloc+0x1a3c>
    3804:	00002097          	auipc	ra,0x2
    3808:	42a080e7          	jalr	1066(ra) # 5c2e <printf>
    exit(1);
    380c:	4505                	li	a0,1
    ...
    381c:	f3050513          	addi	a0,a0,-208 # 7748 <malloc+0x1a5c>
    3820:	00002097          	auipc	ra,0x2
    3824:	40e080e7          	jalr	1038(ra) # 5c2e <printf>
    exit(1);
    3828:	4505                	li	a0,1
    ...
    3838:	f4450513          	addi	a0,a0,-188 # 7778 <malloc+0x1a8c>
    383c:	00002097          	auipc	ra,0x2
    3840:	3f2080e7          	jalr	1010(ra) # 5c2e <printf>
    exit(1);
    3844:	4505                	li	a0,1
    ...
    3854:	f5050513          	addi	a0,a0,-176 # 77a0 <malloc+0x1ab4>
    3858:	00002097          	auipc	ra,0x2
    385c:	3d6080e7          	jalr	982(ra) # 5c2e <printf>
    exit(1);
    3860:	4505                	li	a0,1
    ...
    3870:	f5c50513          	addi	a0,a0,-164 # 77c8 <malloc+0x1adc>
    3874:	00002097          	auipc	ra,0x2
    3878:	3ba080e7          	jalr	954(ra) # 5c2e <printf>
    exit(1);
    387c:	4505                	li	a0,1
    ...
    388c:	f6850513          	addi	a0,a0,-152 # 77f0 <malloc+0x1b04>
    3890:	00002097          	auipc	ra,0x2
    3894:	39e080e7          	jalr	926(ra) # 5c2e <printf>
    exit(1);
    3898:	4505                	li	a0,1
    ...
    38a8:	f6c50513          	addi	a0,a0,-148 # 7810 <malloc+0x1b24>
    38ac:	00002097          	auipc	ra,0x2
    38b0:	382080e7          	jalr	898(ra) # 5c2e <printf>
    exit(1);
    38b4:	4505                	li	a0,1
    ...
    38c4:	f7050513          	addi	a0,a0,-144 # 7830 <malloc+0x1b44>
    38c8:	00002097          	auipc	ra,0x2
    38cc:	366080e7          	jalr	870(ra) # 5c2e <printf>
    exit(1);
    38d0:	4505                	li	a0,1
    ...
    38e0:	f7c50513          	addi	a0,a0,-132 # 7858 <malloc+0x1b6c>
    38e4:	00002097          	auipc	ra,0x2
    38e8:	34a080e7          	jalr	842(ra) # 5c2e <printf>
    exit(1);
    38ec:	4505                	li	a0,1
    ...
    38fc:	f8050513          	addi	a0,a0,-128 # 7878 <malloc+0x1b8c>
    3900:	00002097          	auipc	ra,0x2
    3904:	32e080e7          	jalr	814(ra) # 5c2e <printf>
    exit(1);
    3908:	4505                	li	a0,1
    ...
    3918:	f8450513          	addi	a0,a0,-124 # 7898 <malloc+0x1bac>
    391c:	00002097          	auipc	ra,0x2
    3920:	312080e7          	jalr	786(ra) # 5c2e <printf>
    exit(1);
    3924:	4505                	li	a0,1
    ...
    3934:	f9050513          	addi	a0,a0,-112 # 78c0 <malloc+0x1bd4>
    3938:	00002097          	auipc	ra,0x2
    393c:	2f6080e7          	jalr	758(ra) # 5c2e <printf>
    exit(1);
    3940:	4505                	li	a0,1
    ...
    3950:	c0c50513          	addi	a0,a0,-1012 # 7558 <malloc+0x186c>
    3954:	00002097          	auipc	ra,0x2
    3958:	2da080e7          	jalr	730(ra) # 5c2e <printf>
    exit(1);
    395c:	4505                	li	a0,1
    ...
    396c:	f7850513          	addi	a0,a0,-136 # 78e0 <malloc+0x1bf4>
    3970:	00002097          	auipc	ra,0x2
    3974:	2be080e7          	jalr	702(ra) # 5c2e <printf>
    exit(1);
    3978:	4505                	li	a0,1
    ...
    3988:	f7c50513          	addi	a0,a0,-132 # 7900 <malloc+0x1c14>
    398c:	00002097          	auipc	ra,0x2
    3990:	2a2080e7          	jalr	674(ra) # 5c2e <printf>
    exit(1);
    3994:	4505                	li	a0,1
    ...
    39a4:	f9050513          	addi	a0,a0,-112 # 7930 <malloc+0x1c44>
    39a8:	00002097          	auipc	ra,0x2
    39ac:	286080e7          	jalr	646(ra) # 5c2e <printf>
    exit(1);
    39b0:	4505                	li	a0,1
    ...
    39c0:	f9450513          	addi	a0,a0,-108 # 7950 <malloc+0x1c64>
    39c4:	00002097          	auipc	ra,0x2
    39c8:	26a080e7          	jalr	618(ra) # 5c2e <printf>
    exit(1);
    39cc:	4505                	li	a0,1
...
00000000000039d6 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    39e6:	f8650513          	addi	a0,a0,-122 # 7968 <malloc+0x1c7c>
  ...
  if(chdir("dots") != 0){
    ...
    39f8:	f7450513          	addi	a0,a0,-140 # 7968 <malloc+0x1c7c>
  ...
  if(unlink(".") == 0){
    ...
    3a0a:	dfa50513          	addi	a0,a0,-518 # 6800 <malloc+0xb14>
  ...
  if(unlink("..") == 0){
    ...
    3a1c:	9a850513          	addi	a0,a0,-1624 # 73c0 <malloc+0x16d4>
  ...
  if(chdir("/") != 0){
    ...
    3a2e:	93e50513          	addi	a0,a0,-1730 # 7368 <malloc+0x167c>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a40:	f9450513          	addi	a0,a0,-108 # 79d0 <malloc+0x1ce4>
  ...
  if(unlink("dots/..") == 0){
    ...
    3a52:	faa50513          	addi	a0,a0,-86 # 79f8 <malloc+0x1d0c>
  ...
  if(unlink("dots") != 0){
    ...
    3a64:	f0850513          	addi	a0,a0,-248 # 7968 <malloc+0x1c7c>
    ...
    3a82:	ef250513          	addi	a0,a0,-270 # 7970 <malloc+0x1c84>
    3a86:	00002097          	auipc	ra,0x2
    3a8a:	1a8080e7          	jalr	424(ra) # 5c2e <printf>
    exit(1);
    3a8e:	4505                	li	a0,1
    ...
    3a9e:	eee50513          	addi	a0,a0,-274 # 7988 <malloc+0x1c9c>
    3aa2:	00002097          	auipc	ra,0x2
    3aa6:	18c080e7          	jalr	396(ra) # 5c2e <printf>
    exit(1);
    3aaa:	4505                	li	a0,1
    ...
    3aba:	eea50513          	addi	a0,a0,-278 # 79a0 <malloc+0x1cb4>
    3abe:	00002097          	auipc	ra,0x2
    3ac2:	170080e7          	jalr	368(ra) # 5c2e <printf>
    exit(1);
    3ac6:	4505                	li	a0,1
    ...
    3ad6:	ee650513          	addi	a0,a0,-282 # 79b8 <malloc+0x1ccc>
    3ada:	00002097          	auipc	ra,0x2
    3ade:	154080e7          	jalr	340(ra) # 5c2e <printf>
    exit(1);
    3ae2:	4505                	li	a0,1
    ...
    3af2:	88250513          	addi	a0,a0,-1918 # 7370 <malloc+0x1684>
    3af6:	00002097          	auipc	ra,0x2
    3afa:	138080e7          	jalr	312(ra) # 5c2e <printf>
    exit(1);
    3afe:	4505                	li	a0,1
    ...
    3b0e:	ece50513          	addi	a0,a0,-306 # 79d8 <malloc+0x1cec>
    3b12:	00002097          	auipc	ra,0x2
    3b16:	11c080e7          	jalr	284(ra) # 5c2e <printf>
    exit(1);
    3b1a:	4505                	li	a0,1
    ...
    3b2a:	eda50513          	addi	a0,a0,-294 # 7a00 <malloc+0x1d14>
    3b2e:	00002097          	auipc	ra,0x2
    3b32:	100080e7          	jalr	256(ra) # 5c2e <printf>
    exit(1);
    3b36:	4505                	li	a0,1
    ...
    3b46:	ede50513          	addi	a0,a0,-290 # 7a20 <malloc+0x1d34>
    3b4a:	00002097          	auipc	ra,0x2
    3b4e:	0e4080e7          	jalr	228(ra) # 5c2e <printf>
    exit(1);
    3b52:	4505                	li	a0,1
...
0000000000003b5c <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3b72:	59a50513          	addi	a0,a0,1434 # 6108 <malloc+0x41c>
  ...
  if(chdir("dirfile") == 0){
    ...
    3b8e:	57e50513          	addi	a0,a0,1406 # 6108 <malloc+0x41c>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3ba2:	ee250513          	addi	a0,a0,-286 # 7a80 <malloc+0x1d94>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3bba:	eca50513          	addi	a0,a0,-310 # 7a80 <malloc+0x1d94>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3bce:	eb650513          	addi	a0,a0,-330 # 7a80 <malloc+0x1d94>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3be2:	ea250513          	addi	a0,a0,-350 # 7a80 <malloc+0x1d94>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3bf6:	e8e58593          	addi	a1,a1,-370 # 7a80 <malloc+0x1d94>
    3bfa:	00002517          	auipc	a0,0x2
    3bfe:	70650513          	addi	a0,a0,1798 # 6300 <malloc+0x614>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c12:	4fa50513          	addi	a0,a0,1274 # 6108 <malloc+0x41c>
  ...
  fd = open(".", O_RDWR);
    ...
    3c28:	bdc50513          	addi	a0,a0,-1060 # 6800 <malloc+0xb14>
  ...
  fd = open(".", 0);
    ...
    3c3e:	bc650513          	addi	a0,a0,-1082 # 6800 <malloc+0xb14>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3c52:	58a58593          	addi	a1,a1,1418 # 61d8 <malloc+0x4ec>
  ...
  close(fd);
    ...
    3c7e:	dc650513          	addi	a0,a0,-570 # 7a40 <malloc+0x1d54>
    3c82:	00002097          	auipc	ra,0x2
    3c86:	fac080e7          	jalr	-84(ra) # 5c2e <printf>
    exit(1);
    3c8a:	4505                	li	a0,1
    ...
    3c9a:	dca50513          	addi	a0,a0,-566 # 7a60 <malloc+0x1d74>
    3c9e:	00002097          	auipc	ra,0x2
    3ca2:	f90080e7          	jalr	-112(ra) # 5c2e <printf>
    exit(1);
    3ca6:	4505                	li	a0,1
    ...
    3cb6:	dde50513          	addi	a0,a0,-546 # 7a90 <malloc+0x1da4>
    3cba:	00002097          	auipc	ra,0x2
    3cbe:	f74080e7          	jalr	-140(ra) # 5c2e <printf>
    exit(1);
    3cc2:	4505                	li	a0,1
    ...
    3cd2:	dc250513          	addi	a0,a0,-574 # 7a90 <malloc+0x1da4>
    3cd6:	00002097          	auipc	ra,0x2
    3cda:	f58080e7          	jalr	-168(ra) # 5c2e <printf>
    exit(1);
    3cde:	4505                	li	a0,1
    ...
    3cee:	dce50513          	addi	a0,a0,-562 # 7ab8 <malloc+0x1dcc>
    3cf2:	00002097          	auipc	ra,0x2
    3cf6:	f3c080e7          	jalr	-196(ra) # 5c2e <printf>
    exit(1);
    3cfa:	4505                	li	a0,1
    ...
    3d0a:	dda50513          	addi	a0,a0,-550 # 7ae0 <malloc+0x1df4>
    3d0e:	00002097          	auipc	ra,0x2
    3d12:	f20080e7          	jalr	-224(ra) # 5c2e <printf>
    exit(1);
    3d16:	4505                	li	a0,1
    ...
    3d26:	de650513          	addi	a0,a0,-538 # 7b08 <malloc+0x1e1c>
    3d2a:	00002097          	auipc	ra,0x2
    3d2e:	f04080e7          	jalr	-252(ra) # 5c2e <printf>
    exit(1);
    3d32:	4505                	li	a0,1
    ...
    3d42:	df250513          	addi	a0,a0,-526 # 7b30 <malloc+0x1e44>
    3d46:	00002097          	auipc	ra,0x2
    3d4a:	ee8080e7          	jalr	-280(ra) # 5c2e <printf>
    exit(1);
    3d4e:	4505                	li	a0,1
    ...
    3d5e:	df650513          	addi	a0,a0,-522 # 7b50 <malloc+0x1e64>
    3d62:	00002097          	auipc	ra,0x2
    3d66:	ecc080e7          	jalr	-308(ra) # 5c2e <printf>
    exit(1);
    3d6a:	4505                	li	a0,1
    ...
    3d7a:	e0250513          	addi	a0,a0,-510 # 7b78 <malloc+0x1e8c>
    3d7e:	00002097          	auipc	ra,0x2
    3d82:	eb0080e7          	jalr	-336(ra) # 5c2e <printf>
    exit(1);
    3d86:	4505                	li	a0,1
...
0000000000003d90 <iref>:
{
    ...
    3dae:	de6a0a13          	addi	s4,s4,-538 # 7b90 <malloc+0x1ea4>
    mkdir("");
    3db2:	00004497          	auipc	s1,0x4
    3db6:	8ee48493          	addi	s1,s1,-1810 # 76a0 <malloc+0x19b4>
    link("README", "");
    3dba:	00002a97          	auipc	s5,0x2
    3dbe:	546a8a93          	addi	s5,s5,1350 # 6300 <malloc+0x614>
    fd = open("xx", O_CREATE);
    3dc2:	00004997          	auipc	s3,0x4
    3dc6:	cc698993          	addi	s3,s3,-826 # 7a88 <malloc+0x1d9c>
    3dca:	a891                	j	3e1e <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3dcc:	85da                	mv	a1,s6
    3dce:	00004517          	auipc	a0,0x4
    3dd2:	dca50513          	addi	a0,a0,-566 # 7b98 <malloc+0x1eac>
    3dd6:	00002097          	auipc	ra,0x2
    3dda:	e58080e7          	jalr	-424(ra) # 5c2e <printf>
      exit(1);
    3dde:	4505                	li	a0,1
    ...
    3dee:	dc650513          	addi	a0,a0,-570 # 7bb0 <malloc+0x1ec4>
    3df2:	00002097          	auipc	ra,0x2
    3df6:	e3c080e7          	jalr	-452(ra) # 5c2e <printf>
      exit(1);
    3dfa:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3e82:	54298993          	addi	s3,s3,1346 # 73c0 <malloc+0x16d4>
    unlink("irefd");
    3e86:	00004917          	auipc	s2,0x4
    3e8a:	d0a90913          	addi	s2,s2,-758 # 7b90 <malloc+0x1ea4>
    chdir("..");
    3e8e:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3eaa:	4c250513          	addi	a0,a0,1218 # 7368 <malloc+0x167c>
...
0000000000003eca <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3eda:	cf250513          	addi	a0,a0,-782 # 7bc8 <malloc+0x1edc>
  ...
  if(pid == 0){
    ...
    3efe:	cce50513          	addi	a0,a0,-818 # 7bc8 <malloc+0x1edc>
    ...
    3f14:	cd850513          	addi	a0,a0,-808 # 7be8 <malloc+0x1efc>
    3f18:	00002097          	auipc	ra,0x2
    3f1c:	d16080e7          	jalr	-746(ra) # 5c2e <printf>
      exit(1);
    3f20:	4505                	li	a0,1
    ...
    3f30:	ca450513          	addi	a0,a0,-860 # 7bd0 <malloc+0x1ee4>
    3f34:	00002097          	auipc	ra,0x2
    3f38:	cfa080e7          	jalr	-774(ra) # 5c2e <printf>
    exit(1);
    3f3c:	4505                	li	a0,1
    ...
    3f4c:	a5850513          	addi	a0,a0,-1448 # 69a0 <malloc+0xcb4>
    3f50:	00002097          	auipc	ra,0x2
    3f54:	cde080e7          	jalr	-802(ra) # 5c2e <printf>
    exit(1);
    3f58:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3f7a:	c5250513          	addi	a0,a0,-942 # 7bc8 <malloc+0x1edc>
    ...
    3f8e:	c0650513          	addi	a0,a0,-1018 # 6b90 <malloc+0xea4>
    3f92:	00002097          	auipc	ra,0x2
    3f96:	c9c080e7          	jalr	-868(ra) # 5c2e <printf>
    exit(1);
    3f9a:	4505                	li	a0,1
...
0000000000003fbc <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3fcc:	c4850513          	addi	a0,a0,-952 # 7c10 <malloc+0x1f24>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ff8:	c1c50513          	addi	a0,a0,-996 # 7c10 <malloc+0x1f24>
  ...
  sleep(10); // one second
    ...
    4030:	b3450513          	addi	a0,a0,-1228 # 6b60 <malloc+0xe74>
    4034:	00002097          	auipc	ra,0x2
    4038:	bfa080e7          	jalr	-1030(ra) # 5c2e <printf>
    exit(1);
    403c:	4505                	li	a0,1
    ...
    404a:	bca48493          	addi	s1,s1,-1078 # 7c10 <malloc+0x1f24>
    404e:	4581                	li	a1,0
    4050:	8526                	mv	a0,s1
...
000000000000408c <killstatus>:
{
  ...
  exit(0);
    ...
    40f2:	8b250513          	addi	a0,a0,-1870 # 69a0 <malloc+0xcb4>
    40f6:	00002097          	auipc	ra,0x2
    40fa:	b38080e7          	jalr	-1224(ra) # 5c2e <printf>
      exit(1);
    40fe:	4505                	li	a0,1
    ...
    4118:	b0c50513          	addi	a0,a0,-1268 # 7c20 <malloc+0x1f34>
    411c:	00002097          	auipc	ra,0x2
    4120:	b12080e7          	jalr	-1262(ra) # 5c2e <printf>
       exit(1);
    4124:	4505                	li	a0,1
...
000000000000412e <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    4158:	a0c50513          	addi	a0,a0,-1524 # 6b60 <malloc+0xe74>
    415c:	00002097          	auipc	ra,0x2
    4160:	ad2080e7          	jalr	-1326(ra) # 5c2e <printf>
    exit(1);
    4164:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    4186:	81e50513          	addi	a0,a0,-2018 # 69a0 <malloc+0xcb4>
    418a:	00002097          	auipc	ra,0x2
    418e:	aa4080e7          	jalr	-1372(ra) # 5c2e <printf>
    exit(1);
    4192:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    41ca:	01258593          	addi	a1,a1,18 # 61d8 <malloc+0x4ec>
    ...
    41f4:	7b050513          	addi	a0,a0,1968 # 69a0 <malloc+0xcb4>
    41f8:	00002097          	auipc	ra,0x2
    41fc:	a36080e7          	jalr	-1482(ra) # 5c2e <printf>
     exit(1);
    4200:	4505                	li	a0,1
    ...
    4210:	a3450513          	addi	a0,a0,-1484 # 7c40 <malloc+0x1f54>
    4214:	00002097          	auipc	ra,0x2
    4218:	a1a080e7          	jalr	-1510(ra) # 5c2e <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4230:	bc458593          	addi	a1,a1,-1084 # bdf0 <buf>
    ...
    424c:	a1050513          	addi	a0,a0,-1520 # 7c58 <malloc+0x1f6c>
    4250:	00002097          	auipc	ra,0x2
    4254:	9de080e7          	jalr	-1570(ra) # 5c2e <printf>
}
  ...
  printf("kill... ");
    ...
    4278:	9fc50513          	addi	a0,a0,-1540 # 7c70 <malloc+0x1f84>
    427c:	00002097          	auipc	ra,0x2
    4280:	9b2080e7          	jalr	-1614(ra) # 5c2e <printf>
  kill(pid1);
    4284:	8552                	mv	a0,s4
  ...
  printf("wait... ");
    ...
    42a6:	9de50513          	addi	a0,a0,-1570 # 7c80 <malloc+0x1f94>
    42aa:	00002097          	auipc	ra,0x2
    42ae:	984080e7          	jalr	-1660(ra) # 5c2e <printf>
  wait(0);
    42b2:	4501                	li	a0,0
...
00000000000042d2 <reparent>:
{
  ...
  exit(0);
    ...
    4326:	67e50513          	addi	a0,a0,1662 # 69a0 <malloc+0xcb4>
    432a:	00002097          	auipc	ra,0x2
    432e:	904080e7          	jalr	-1788(ra) # 5c2e <printf>
      exit(1);
    4332:	4505                	li	a0,1
    ...
    4342:	7ea50513          	addi	a0,a0,2026 # 6b28 <malloc+0xe3c>
    4346:	00002097          	auipc	ra,0x2
    434a:	8e8080e7          	jalr	-1816(ra) # 5c2e <printf>
        exit(1);
    434e:	4505                	li	a0,1
...
0000000000004382 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    43b8:	6f450513          	addi	a0,a0,1780 # 6aa8 <malloc+0xdbc>
    43bc:	00002097          	auipc	ra,0x2
    43c0:	872080e7          	jalr	-1934(ra) # 5c2e <printf>
    exit(1);
    43c4:	4505                	li	a0,1
    ...
    43ee:	dee58593          	addi	a1,a1,-530 # 61d8 <malloc+0x4ec>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    44b2:	7e250513          	addi	a0,a0,2018 # 7c90 <malloc+0x1fa4>
    44b6:	00001097          	auipc	ra,0x1
    44ba:	778080e7          	jalr	1912(ra) # 5c2e <printf>
    exit(1);
    44be:	4505                	li	a0,1
    ...
    44ce:	4d650513          	addi	a0,a0,1238 # 69a0 <malloc+0xcb4>
    44d2:	00001097          	auipc	ra,0x1
    44d6:	75c080e7          	jalr	1884(ra) # 5c2e <printf>
    exit(1);
    44da:	4505                	li	a0,1
    ...
    451a:	79a50513          	addi	a0,a0,1946 # 7cb0 <malloc+0x1fc4>
    451e:	00001097          	auipc	ra,0x1
    4522:	710080e7          	jalr	1808(ra) # 5c2e <printf>
    exit(1);
    4526:	4505                	li	a0,1
...
000000000000453a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4562:	78e080e7          	jalr	1934(ra) # 5cec <malloc>
    ...
    45a2:	74250513          	addi	a0,a0,1858 # 7ce0 <malloc+0x1ff4>
    45a6:	00001097          	auipc	ra,0x1
    45aa:	688080e7          	jalr	1672(ra) # 5c2e <printf>
      exit(1);
    45ae:	4505                	li	a0,1
...
00000000000045e0 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4676:	68e50513          	addi	a0,a0,1678 # 7d00 <malloc+0x2014>
    467a:	00001097          	auipc	ra,0x1
    467e:	5b4080e7          	jalr	1460(ra) # 5c2e <printf>
    exit(1);
    4682:	4505                	li	a0,1
    ...
    4692:	69a50513          	addi	a0,a0,1690 # 7d28 <malloc+0x203c>
    4696:	00001097          	auipc	ra,0x1
    469a:	598080e7          	jalr	1432(ra) # 5c2e <printf>
      exit(1);
    469e:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    46d6:	8a650513          	addi	a0,a0,-1882 # 5f78 <malloc+0x28c>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4716:	63650513          	addi	a0,a0,1590 # 7d48 <malloc+0x205c>
    471a:	00001097          	auipc	ra,0x1
    471e:	514080e7          	jalr	1300(ra) # 5c2e <printf>
    exit(1);
    4722:	4505                	li	a0,1
    ...
    4730:	fd2783e3          	beq	a5,s2,46f6 <sharedfd+0x116>
      if(buf[i] == 'c')
    4734:	0007c703          	lbu	a4,0(a5) # 3e800000 <__BSS_END__+0x3e7f1200>
  ...
  unlink("sharedfd");
    ...
    4752:	82a50513          	addi	a0,a0,-2006 # 5f78 <malloc+0x28c>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4778:	5fc50513          	addi	a0,a0,1532 # 7d70 <malloc+0x2084>
    477c:	00001097          	auipc	ra,0x1
    4780:	4b2080e7          	jalr	1202(ra) # 5c2e <printf>
    exit(1);
    4784:	4505                	li	a0,1
...
0000000000004798 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    47bc:	61878793          	addi	a5,a5,1560 # 5dd0 <malloc+0xe4>
    47c0:	f6f43823          	sd	a5,-144(s0)
    47c4:	00001797          	auipc	a5,0x1
    47c8:	61478793          	addi	a5,a5,1556 # 5dd8 <malloc+0xec>
    47cc:	f6f43c23          	sd	a5,-136(s0)
    47d0:	00001797          	auipc	a5,0x1
    47d4:	61078793          	addi	a5,a5,1552 # 5de0 <malloc+0xf4>
    47d8:	f8f43023          	sd	a5,-128(s0)
    47dc:	00001797          	auipc	a5,0x1
    47e0:	60c78793          	addi	a5,a5,1548 # 5de8 <malloc+0xfc>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    483a:	5baa0a13          	addi	s4,s4,1466 # bdf0 <buf>
    483e:	00007a97          	auipc	s5,0x7
    4842:	5b3a8a93          	addi	s5,s5,1459 # bdf1 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4858:	56c50513          	addi	a0,a0,1388 # 6dc0 <malloc+0x10d4>
    485c:	00001097          	auipc	ra,0x1
    4860:	3d2080e7          	jalr	978(ra) # 5c2e <printf>
      exit(1);
    4864:	4505                	li	a0,1
    ...
    48d2:	4ba50513          	addi	a0,a0,1210 # 7d88 <malloc+0x209c>
    48d6:	00001097          	auipc	ra,0x1
    48da:	358080e7          	jalr	856(ra) # 5c2e <printf>
        exit(1);
    48de:	4505                	li	a0,1
    ...
    48ec:	4b050513          	addi	a0,a0,1200 # 7d98 <malloc+0x20ac>
    48f0:	00001097          	auipc	ra,0x1
    48f4:	33e080e7          	jalr	830(ra) # 5c2e <printf>
          exit(1);
    48f8:	4505                	li	a0,1
    ...
    4910:	4a450513          	addi	a0,a0,1188 # 7db0 <malloc+0x20c4>
    4914:	00001097          	auipc	ra,0x1
    4918:	31a080e7          	jalr	794(ra) # 5c2e <printf>
          exit(1);
    491c:	4505                	li	a0,1
    ...
    4940:	4b478793          	addi	a5,a5,1204 # bdf0 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    49a0:	42450513          	addi	a0,a0,1060 # 7dc0 <malloc+0x20d4>
    49a4:	00001097          	auipc	ra,0x1
    49a8:	28a080e7          	jalr	650(ra) # 5c2e <printf>
      exit(1);
    49ac:	4505                	li	a0,1
...
00000000000049d4 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4a02:	3dab8b93          	addi	s7,s7,986 # 7dd8 <malloc+0x20ec>
  for(i = 0; i < N; i++){
    ...
    4a44:	3a050513          	addi	a0,a0,928 # 7de0 <malloc+0x20f4>
    4a48:	00001097          	auipc	ra,0x1
    4a4c:	1e6080e7          	jalr	486(ra) # 5c2e <printf>
        exit(1);
    4a50:	4505                	li	a0,1
    ...
    4a62:	37a50513          	addi	a0,a0,890 # 7dd8 <malloc+0x20ec>
  ...
  fd = open(".", 0);
    ...
    4a9a:	d6a50513          	addi	a0,a0,-662 # 6800 <malloc+0xb14>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4ac0:	34450513          	addi	a0,a0,836 # 7e00 <malloc+0x2114>
    4ac4:	00001097          	auipc	ra,0x1
    4ac8:	16a080e7          	jalr	362(ra) # 5c2e <printf>
        exit(1);
    4acc:	4505                	li	a0,1
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4b30:	2f450513          	addi	a0,a0,756 # 7e20 <malloc+0x2134>
    4b34:	00001097          	auipc	ra,0x1
    4b38:	0fa080e7          	jalr	250(ra) # 5c2e <printf>
        exit(1);
    4b3c:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4b68:	2e450513          	addi	a0,a0,740 # 7e48 <malloc+0x215c>
    4b6c:	00001097          	auipc	ra,0x1
    4b70:	0c2080e7          	jalr	194(ra) # 5c2e <printf>
    exit(1);
    4b74:	4505                	li	a0,1
    ...
    4b84:	e2050513          	addi	a0,a0,-480 # 69a0 <malloc+0xcb4>
    4b88:	00001097          	auipc	ra,0x1
    4b8c:	0a6080e7          	jalr	166(ra) # 5c2e <printf>
      exit(1);
    4b90:	4505                	li	a0,1
...
0000000000004d2e <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4d6e:	08690913          	addi	s2,s2,134 # bdf0 <buf>
  for(i = 0; i < N; i++){
    4d72:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4db6:	0ce50513          	addi	a0,a0,206 # 7e80 <malloc+0x2194>
  ...
  for(i = 0; ; i++){
    ...
    4dcc:	02890913          	addi	s2,s2,40 # bdf0 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4e1a:	07a50513          	addi	a0,a0,122 # 7e90 <malloc+0x21a4>
    4e1e:	00001097          	auipc	ra,0x1
    4e22:	e10080e7          	jalr	-496(ra) # 5c2e <printf>
    exit(1);
    4e26:	4505                	li	a0,1
    ...
    4e36:	07e50513          	addi	a0,a0,126 # 7eb0 <malloc+0x21c4>
    4e3a:	00001097          	auipc	ra,0x1
    4e3e:	df4080e7          	jalr	-524(ra) # 5c2e <printf>
      exit(1);
    4e42:	4505                	li	a0,1
    ...
    4e52:	08250513          	addi	a0,a0,130 # 7ed0 <malloc+0x21e4>
    4e56:	00001097          	auipc	ra,0x1
    4e5a:	dd8080e7          	jalr	-552(ra) # 5c2e <printf>
    exit(1);
    4e5e:	4505                	li	a0,1
    ...
    4e6e:	08650513          	addi	a0,a0,134 # 7ef0 <malloc+0x2204>
    4e72:	00001097          	auipc	ra,0x1
    4e76:	dbc080e7          	jalr	-580(ra) # 5c2e <printf>
      exit(1);
    4e7a:	4505                	li	a0,1
    ...
    4e8a:	08a50513          	addi	a0,a0,138 # 7f10 <malloc+0x2224>
    4e8e:	00001097          	auipc	ra,0x1
    4e92:	da0080e7          	jalr	-608(ra) # 5c2e <printf>
      exit(1);
    4e96:	4505                	li	a0,1
    ...
    4ea6:	08650513          	addi	a0,a0,134 # 7f28 <malloc+0x223c>
    4eaa:	00001097          	auipc	ra,0x1
    4eae:	d84080e7          	jalr	-636(ra) # 5c2e <printf>
      exit(1);
    4eb2:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    4ed4:	fb050513          	addi	a0,a0,-80 # 7e80 <malloc+0x2194>
    ...
    4ef8:	05450513          	addi	a0,a0,84 # 7f48 <malloc+0x225c>
    4efc:	00001097          	auipc	ra,0x1
    4f00:	d32080e7          	jalr	-718(ra) # 5c2e <printf>
    exit(1);
    4f04:	4505                	li	a0,1
...
0000000000004f0e <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4f30:	03c50513          	addi	a0,a0,60 # 7f68 <malloc+0x227c>
    4f34:	00001097          	auipc	ra,0x1
    4f38:	cfa080e7          	jalr	-774(ra) # 5c2e <printf>
  for(nfiles = 0; ; nfiles++){
    4f3c:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4f50:	02cc8c93          	addi	s9,s9,44 # 7f78 <malloc+0x228c>
    int total = 0;
    4f54:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    4f56:	00007a17          	auipc	s4,0x7
    4f5a:	e9aa0a13          	addi	s4,s4,-358 # bdf0 <buf>
    name[0] = 'f';
    ...
    4fa8:	c8a080e7          	jalr	-886(ra) # 5c2e <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    4fca:	fc250513          	addi	a0,a0,-62 # 7f88 <malloc+0x229c>
    4fce:	00001097          	auipc	ra,0x1
    4fd2:	c60080e7          	jalr	-928(ra) # 5c2e <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    5040:	f6c50513          	addi	a0,a0,-148 # 7fa8 <malloc+0x22bc>
    5044:	00001097          	auipc	ra,0x1
    5048:	bea080e7          	jalr	-1046(ra) # 5c2e <printf>
}
    ...
    5090:	f0c50513          	addi	a0,a0,-244 # 7f98 <malloc+0x22ac>
    5094:	00001097          	auipc	ra,0x1
    5098:	b9a080e7          	jalr	-1126(ra) # 5c2e <printf>
    close(fd);
    509c:	854a                	mv	a0,s2
...
00000000000050ae <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    5122:	ea250513          	addi	a0,a0,-350 # 7fc0 <malloc+0x22d4>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    513a:	0a258593          	addi	a1,a1,162 # 61d8 <malloc+0x4ec>
    ...
    5150:	e9450513          	addi	a0,a0,-364 # 7fe0 <malloc+0x22f4>
    5154:	00001097          	auipc	ra,0x1
    5158:	ada080e7          	jalr	-1318(ra) # 5c2e <printf>
    exit(1);
    515c:	4505                	li	a0,1
    ...
    516a:	e6250513          	addi	a0,a0,-414 # 7fc8 <malloc+0x22dc>
    516e:	00001097          	auipc	ra,0x1
    5172:	ac0080e7          	jalr	-1344(ra) # 5c2e <printf>
      exit(1);
    5176:	4505                	li	a0,1
    ...
    5184:	e4850513          	addi	a0,a0,-440 # 7fc8 <malloc+0x22dc>
    5188:	00001097          	auipc	ra,0x1
    518c:	aa6080e7          	jalr	-1370(ra) # 5c2e <printf>
    exit(1);
    5190:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    51a8:	e1c50513          	addi	a0,a0,-484 # 7fc0 <malloc+0x22d4>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    51fe:	fde90913          	addi	s2,s2,-34 # 61d8 <malloc+0x4ec>
      uint64 a = (uint64) sbrk(4096);
    ...
    5232:	e0250513          	addi	a0,a0,-510 # 8030 <malloc+0x2344>
    5236:	00001097          	auipc	ra,0x1
    523a:	9f8080e7          	jalr	-1544(ra) # 5c2e <printf>
        exit(1);
    523e:	4505                	li	a0,1
    ...
    524c:	da850513          	addi	a0,a0,-600 # 7ff0 <malloc+0x2304>
    5250:	00001097          	auipc	ra,0x1
    5254:	9de080e7          	jalr	-1570(ra) # 5c2e <printf>
    exit(1);
    5258:	4505                	li	a0,1
    ...
    5266:	dae50513          	addi	a0,a0,-594 # 8010 <malloc+0x2324>
    526a:	00001097          	auipc	ra,0x1
    526e:	9c4080e7          	jalr	-1596(ra) # 5c2e <printf>
    exit(1);
    5272:	4505                	li	a0,1
  ...
  while(1){
    ...
    52b4:	da050513          	addi	a0,a0,-608 # 8050 <malloc+0x2364>
    52b8:	00001097          	auipc	ra,0x1
    52bc:	976080e7          	jalr	-1674(ra) # 5c2e <printf>
      exit(1);
    52c0:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5304:	d7050513          	addi	a0,a0,-656 # 8070 <malloc+0x2384>
    5308:	00001097          	auipc	ra,0x1
    530c:	926080e7          	jalr	-1754(ra) # 5c2e <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    5334:	d6850513          	addi	a0,a0,-664 # 8098 <malloc+0x23ac>
    5338:	00001097          	auipc	ra,0x1
    533c:	8f6080e7          	jalr	-1802(ra) # 5c2e <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    5358:	d2c50513          	addi	a0,a0,-724 # 8080 <malloc+0x2394>
    535c:	00001097          	auipc	ra,0x1
    5360:	8d2080e7          	jalr	-1838(ra) # 5c2e <printf>
    exit(1);
    5364:	4505                	li	a0,1
    ...
    5380:	d2450513          	addi	a0,a0,-732 # 80a0 <malloc+0x23b4>
    5384:	00001097          	auipc	ra,0x1
    5388:	8aa080e7          	jalr	-1878(ra) # 5c2e <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    53ca:	df278793          	addi	a5,a5,-526 # 81b8 <malloc+0x24cc>
    53ce:	bd040713          	addi	a4,s0,-1072
    53d2:	00003317          	auipc	t1,0x3
    53d6:	1d630313          	addi	t1,t1,470 # 85a8 <malloc+0x28bc>
  ...
  printf("usertests starting\n");
    ...
    540a:	d5250513          	addi	a0,a0,-686 # 8158 <malloc+0x246c>
    540e:	00001097          	auipc	ra,0x1
    5412:	820080e7          	jalr	-2016(ra) # 5c2e <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    5442:	cd250513          	addi	a0,a0,-814 # 8110 <malloc+0x2424>
    5446:	00000097          	auipc	ra,0x0
    544a:	7e8080e7          	jalr	2024(ra) # 5c2e <printf>
    exit(1);
    544e:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    545e:	c4e58593          	addi	a1,a1,-946 # 80a8 <malloc+0x23bc>
    ...
    5474:	d2058593          	addi	a1,a1,-736 # 8190 <malloc+0x24a4>
    ...
    5498:	c1c50513          	addi	a0,a0,-996 # 80b0 <malloc+0x23c4>
    549c:	00000097          	auipc	ra,0x0
    54a0:	792080e7          	jalr	1938(ra) # 5c2e <printf>
    exit(1);
    54a4:	4505                	li	a0,1
    ...
    54c2:	770080e7          	jalr	1904(ra) # 5c2e <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    5504:	bf850513          	addi	a0,a0,-1032 # 80f8 <malloc+0x240c>
    5508:	00000097          	auipc	ra,0x0
    550c:	726080e7          	jalr	1830(ra) # 5c2e <printf>
    exit(1);
    5510:	4505                	li	a0,1
    ...
    551e:	c2650513          	addi	a0,a0,-986 # 8140 <malloc+0x2454>
    5522:	00000097          	auipc	ra,0x0
    5526:	70c080e7          	jalr	1804(ra) # 5c2e <printf>
    exit(0);
    552a:	4501                	li	a0,0
    ...
    553a:	6f8080e7          	jalr	1784(ra) # 5c2e <printf>
        if(continuous != 2)
    ...
    557c:	c4078793          	addi	a5,a5,-960 # 81b8 <malloc+0x24cc>
    5580:	bd040713          	addi	a4,s0,-1072
    5584:	00003317          	auipc	t1,0x3
    5588:	02430313          	addi	t1,t1,36 # 85a8 <malloc+0x28bc>
    ...
    55bc:	bb850513          	addi	a0,a0,-1096 # 8170 <malloc+0x2484>
    55c0:	00000097          	auipc	ra,0x0
    55c4:	66e080e7          	jalr	1646(ra) # 5c2e <printf>
        printf("SOME TESTS FAILED\n");
    55c8:	00003a97          	auipc	s5,0x3
    55cc:	b30a8a93          	addi	s5,s5,-1232 # 80f8 <malloc+0x240c>
        if(continuous != 2)
    55d0:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    55d2:	00003b17          	auipc	s6,0x3
    55d6:	b06b0b13          	addi	s6,s6,-1274 # 80d8 <malloc+0x23ec>
...
000000000000593a <barrier_alloc>:
...
putc(int fd, char c)
{
    ...
    595e:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    5962:	4605                	li	a2,1
    5964:	fef40593          	addi	a1,s0,-17
    5968:	00000097          	auipc	ra,0x0
    596c:	f0a080e7          	jalr	-246(ra) # 5872 <write>
}
    5970:	60e2                	ld	ra,24(sp)
    5972:	6442                	ld	s0,16(sp)
    5974:	6105                	addi	sp,sp,32
    5976:	8082                	ret

0000000000005978 <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    5978:	7139                	addi	sp,sp,-64
    597a:	fc06                	sd	ra,56(sp)
    597c:	f822                	sd	s0,48(sp)
    597e:	f426                	sd	s1,40(sp)
    5980:	f04a                	sd	s2,32(sp)
    5982:	ec4e                	sd	s3,24(sp)
    5984:	0080                	addi	s0,sp,64
    5986:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    5988:	c299                	beqz	a3,598e <printint+0x16>
    598a:	0805c863          	bltz	a1,5a1a <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  do{
    ...
    599e:	c1650513          	addi	a0,a0,-1002 # 85b0 <digits>
    59a2:	883a                	mv	a6,a4
    59a4:	2705                	addiw	a4,a4,1
    59a6:	02c5f7bb          	remuw	a5,a1,a2
    59aa:	1782                	slli	a5,a5,0x20
    59ac:	9381                	srli	a5,a5,0x20
    59ae:	97aa                	add	a5,a5,a0
    59b0:	0007c783          	lbu	a5,0(a5)
    59b4:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    59b8:	0005879b          	sext.w	a5,a1
    59bc:	02c5d5bb          	divuw	a1,a1,a2
    59c0:	0685                	addi	a3,a3,1
    59c2:	fec7f0e3          	bgeu	a5,a2,59a2 <printint+0x2a>
  if(neg)
    59c6:	00088b63          	beqz	a7,59dc <printint+0x64>
    buf[i++] = '-';
    59ca:	fd040793          	addi	a5,s0,-48
    59ce:	973e                	add	a4,a4,a5
    59d0:	02d00793          	li	a5,45
    59d4:	fef70823          	sb	a5,-16(a4)
    59d8:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    59dc:	02e05863          	blez	a4,5a0c <printint+0x94>
    59e0:	fc040793          	addi	a5,s0,-64
    59e4:	00e78933          	add	s2,a5,a4
    59e8:	fff78993          	addi	s3,a5,-1
    59ec:	99ba                	add	s3,s3,a4
    59ee:	377d                	addiw	a4,a4,-1
    59f0:	1702                	slli	a4,a4,0x20
    59f2:	9301                	srli	a4,a4,0x20
    59f4:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    59f8:	fff94583          	lbu	a1,-1(s2)
    59fc:	8526                	mv	a0,s1
    59fe:	00000097          	auipc	ra,0x0
    5a02:	f58080e7          	jalr	-168(ra) # 5956 <putc>
  while(--i >= 0)
    5a06:	197d                	addi	s2,s2,-1
    5a08:	ff3918e3          	bne	s2,s3,59f8 <printint+0x80>
}
    ...
    5a16:	6121                	addi	sp,sp,64
    5a18:	8082                	ret
    x = -xx;
    5a1a:	40b005bb          	negw	a1,a1
    neg = 1;
    5a1e:	4885                	li	a7,1
    x = -xx;
    5a20:	bf8d                	j	5992 <printint+0x1a>

0000000000005a22 <vprintf>:
}
...
{
    5a22:	7119                	addi	sp,sp,-128
    5a24:	fc86                	sd	ra,120(sp)
    5a26:	f8a2                	sd	s0,112(sp)
    5a28:	f4a6                	sd	s1,104(sp)
    5a2a:	f0ca                	sd	s2,96(sp)
    5a2c:	ecce                	sd	s3,88(sp)
    5a2e:	e8d2                	sd	s4,80(sp)
    5a30:	e4d6                	sd	s5,72(sp)
    5a32:	e0da                	sd	s6,64(sp)
    5a34:	fc5e                	sd	s7,56(sp)
    5a36:	f862                	sd	s8,48(sp)
    5a38:	f466                	sd	s9,40(sp)
    5a3a:	f06a                	sd	s10,32(sp)
    5a3c:	ec6e                	sd	s11,24(sp)
    5a3e:	0100                	addi	s0,sp,128
  char *s;
  int c, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    5a40:	0005c903          	lbu	s2,0(a1)
    5a44:	18090f63          	beqz	s2,5be2 <vprintf+0x1c0>
    5a48:	8aaa                	mv	s5,a0
    5a4a:	8b32                	mv	s6,a2
    5a4c:	00158493          	addi	s1,a1,1
  state = 0;
    5a50:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    5a52:	02500a13          	li	s4,37
      if(c == 'd'){
    5a56:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
    5a5a:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
    5a5e:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
    5a62:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5a66:	00003b97          	auipc	s7,0x3
    5a6a:	b4ab8b93          	addi	s7,s7,-1206 # 85b0 <digits>
    5a6e:	a839                	j	5a8c <vprintf+0x6a>
        putc(fd, c);
    5a70:	85ca                	mv	a1,s2
    5a72:	8556                	mv	a0,s5
    5a74:	00000097          	auipc	ra,0x0
    5a78:	ee2080e7          	jalr	-286(ra) # 5956 <putc>
    5a7c:	a019                	j	5a82 <vprintf+0x60>
    } else if(state == '%'){
    5a7e:	01498f63          	beq	s3,s4,5a9c <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
    5a82:	0485                	addi	s1,s1,1
    5a84:	fff4c903          	lbu	s2,-1(s1)
    5a88:	14090d63          	beqz	s2,5be2 <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    5a8c:	0009079b          	sext.w	a5,s2
    if(state == 0){
    5a90:	fe0997e3          	bnez	s3,5a7e <vprintf+0x5c>
      if(c == '%'){
    5a94:	fd479ee3          	bne	a5,s4,5a70 <vprintf+0x4e>
        state = '%';
    5a98:	89be                	mv	s3,a5
    5a9a:	b7e5                	j	5a82 <vprintf+0x60>
      if(c == 'd'){
    5a9c:	05878063          	beq	a5,s8,5adc <vprintf+0xba>
      } else if(c == 'l') {
    5aa0:	05978c63          	beq	a5,s9,5af8 <vprintf+0xd6>
      } else if(c == 'x') {
    5aa4:	07a78863          	beq	a5,s10,5b14 <vprintf+0xf2>
      } else if(c == 'p') {
    5aa8:	09b78463          	beq	a5,s11,5b30 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    5aac:	07300713          	li	a4,115
    5ab0:	0ce78663          	beq	a5,a4,5b7c <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    5ab4:	06300713          	li	a4,99
    5ab8:	0ee78e63          	beq	a5,a4,5bb4 <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    5abc:	11478863          	beq	a5,s4,5bcc <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    5ac8:	e92080e7          	jalr	-366(ra) # 5956 <putc>
        putc(fd, c);
    5acc:	85ca                	mv	a1,s2
    5ace:	8556                	mv	a0,s5
    5ad0:	00000097          	auipc	ra,0x0
    5ad4:	e86080e7          	jalr	-378(ra) # 5956 <putc>
      }
      state = 0;
    5ad8:	4981                	li	s3,0
    5ada:	b765                	j	5a82 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    ...
    5aee:	e8e080e7          	jalr	-370(ra) # 5978 <printint>
    5af2:	8b4a                	mv	s6,s2
      state = 0;
    5af4:	4981                	li	s3,0
    5af6:	b771                	j	5a82 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    5b0a:	e72080e7          	jalr	-398(ra) # 5978 <printint>
    5b0e:	8b4a                	mv	s6,s2
      state = 0;
    5b10:	4981                	li	s3,0
    5b12:	bf85                	j	5a82 <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    ...
    5b26:	e56080e7          	jalr	-426(ra) # 5978 <printint>
    5b2a:	8b4a                	mv	s6,s2
      state = 0;
    5b2c:	4981                	li	s3,0
    5b2e:	bf91                	j	5a82 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    5b30:	008b0793          	addi	a5,s6,8
    5b34:	f8f43423          	sd	a5,-120(s0)
    5b38:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    5b3c:	03000593          	li	a1,48
    5b40:	8556                	mv	a0,s5
    5b42:	00000097          	auipc	ra,0x0
    5b46:	e14080e7          	jalr	-492(ra) # 5956 <putc>
  putc(fd, 'x');
    5b4a:	85ea                	mv	a1,s10
    5b4c:	8556                	mv	a0,s5
    5b4e:	00000097          	auipc	ra,0x0
    5b52:	e08080e7          	jalr	-504(ra) # 5956 <putc>
    5b56:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    ...
    5b68:	df2080e7          	jalr	-526(ra) # 5956 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5b6c:	0992                	slli	s3,s3,0x4
    5b6e:	397d                	addiw	s2,s2,-1
    5b70:	fe0914e3          	bnez	s2,5b58 <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    5b74:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5b78:	4981                	li	s3,0
    5b7a:	b721                	j	5a82 <vprintf+0x60>
        s = va_arg(ap, char*);
    5b7c:	008b0993          	addi	s3,s6,8
    5b80:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    5b84:	02090163          	beqz	s2,5ba6 <vprintf+0x184>
        while(*s != 0){
    5b88:	00094583          	lbu	a1,0(s2)
    5b8c:	c9a1                	beqz	a1,5bdc <vprintf+0x1ba>
          putc(fd, *s);
    5b8e:	8556                	mv	a0,s5
    5b90:	00000097          	auipc	ra,0x0
    5b94:	dc6080e7          	jalr	-570(ra) # 5956 <putc>
          s++;
    5b98:	0905                	addi	s2,s2,1
        while(*s != 0){
    5b9a:	00094583          	lbu	a1,0(s2)
    5b9e:	f9e5                	bnez	a1,5b8e <vprintf+0x16c>
        s = va_arg(ap, char*);
    5ba0:	8b4e                	mv	s6,s3
      state = 0;
    5ba2:	4981                	li	s3,0
    5ba4:	bdf9                	j	5a82 <vprintf+0x60>
          s = "(null)";
    5ba6:	00003917          	auipc	s2,0x3
    5baa:	a0290913          	addi	s2,s2,-1534 # 85a8 <malloc+0x28bc>
        while(*s != 0){
    5bae:	02800593          	li	a1,40
    5bb2:	bff1                	j	5b8e <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    5bb4:	008b0913          	addi	s2,s6,8
    5bb8:	000b4583          	lbu	a1,0(s6)
    5bbc:	8556                	mv	a0,s5
    5bbe:	00000097          	auipc	ra,0x0
    5bc2:	d98080e7          	jalr	-616(ra) # 5956 <putc>
    5bc6:	8b4a                	mv	s6,s2
      state = 0;
    5bc8:	4981                	li	s3,0
    5bca:	bd65                	j	5a82 <vprintf+0x60>
        putc(fd, c);
    5bcc:	85d2                	mv	a1,s4
    5bce:	8556                	mv	a0,s5
    5bd0:	00000097          	auipc	ra,0x0
    5bd4:	d86080e7          	jalr	-634(ra) # 5956 <putc>
      state = 0;
    5bd8:	4981                	li	s3,0
    5bda:	b565                	j	5a82 <vprintf+0x60>
        s = va_arg(ap, char*);
    5bdc:	8b4e                	mv	s6,s3
      state = 0;
    5bde:	4981                	li	s3,0
    5be0:	b54d                	j	5a82 <vprintf+0x60>
    }
  }
}
    5be2:	70e6                	ld	ra,120(sp)
    5be4:	7446                	ld	s0,112(sp)
    5be6:	74a6                	ld	s1,104(sp)
    5be8:	7906                	ld	s2,96(sp)
    5bea:	69e6                	ld	s3,88(sp)
    5bec:	6a46                	ld	s4,80(sp)
    5bee:	6aa6                	ld	s5,72(sp)
    5bf0:	6b06                	ld	s6,64(sp)
    5bf2:	7be2                	ld	s7,56(sp)
    5bf4:	7c42                	ld	s8,48(sp)
    5bf6:	7ca2                	ld	s9,40(sp)
    5bf8:	7d02                	ld	s10,32(sp)
    5bfa:	6de2                	ld	s11,24(sp)
    5bfc:	6109                	addi	sp,sp,128
    5bfe:	8082                	ret

0000000000005c00 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5c00:	715d                	addi	sp,sp,-80
    5c02:	ec06                	sd	ra,24(sp)
    5c04:	e822                	sd	s0,16(sp)
    5c06:	1000                	addi	s0,sp,32
    5c08:	e010                	sd	a2,0(s0)
    5c0a:	e414                	sd	a3,8(s0)
    5c0c:	e818                	sd	a4,16(s0)
    5c0e:	ec1c                	sd	a5,24(s0)
    5c10:	03043023          	sd	a6,32(s0)
    5c14:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5c18:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5c1c:	8622                	mv	a2,s0
    5c1e:	00000097          	auipc	ra,0x0
    5c22:	e04080e7          	jalr	-508(ra) # 5a22 <vprintf>
}
    5c26:	60e2                	ld	ra,24(sp)
    5c28:	6442                	ld	s0,16(sp)
    5c2a:	6161                	addi	sp,sp,80
    5c2c:	8082                	ret

0000000000005c2e <printf>:
...
printf(const char *fmt, ...)
{
    ...
    5c36:	e40c                	sd	a1,8(s0)
    5c38:	e810                	sd	a2,16(s0)
    5c3a:	ec14                	sd	a3,24(s0)
    5c3c:	f018                	sd	a4,32(s0)
    5c3e:	f41c                	sd	a5,40(s0)
    5c40:	03043823          	sd	a6,48(s0)
    5c44:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5c48:	00840613          	addi	a2,s0,8
    5c4c:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5c50:	85aa                	mv	a1,a0
    5c52:	4505                	li	a0,1
    5c54:	00000097          	auipc	ra,0x0
    5c58:	dce080e7          	jalr	-562(ra) # 5a22 <vprintf>
}
    5c5c:	60e2                	ld	ra,24(sp)
    5c5e:	6442                	ld	s0,16(sp)
    5c60:	6125                	addi	sp,sp,96
    5c62:	8082                	ret

0000000000005c64 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    5c64:	1141                	addi	sp,sp,-16
    5c66:	e422                	sd	s0,8(sp)
    5c68:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5c6a:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c6e:	00003797          	auipc	a5,0x3
    5c72:	9627b783          	ld	a5,-1694(a5) # 85d0 <freep>
    5c76:	a805                	j	5ca6 <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5c78:	4618                	lw	a4,8(a2)
    5c7a:	9db9                	addw	a1,a1,a4
    5c7c:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5c80:	6398                	ld	a4,0(a5)
    5c82:	6318                	ld	a4,0(a4)
    5c84:	fee53823          	sd	a4,-16(a0)
    5c88:	a091                	j	5ccc <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5c8a:	ff852703          	lw	a4,-8(a0)
    5c8e:	9e39                	addw	a2,a2,a4
    5c90:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    5c92:	ff053703          	ld	a4,-16(a0)
    5c96:	e398                	sd	a4,0(a5)
    5c98:	a099                	j	5cde <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c9a:	6398                	ld	a4,0(a5)
    5c9c:	00e7e463          	bltu	a5,a4,5ca4 <free+0x40>
    5ca0:	00e6ea63          	bltu	a3,a4,5cb4 <free+0x50>
{
    5ca4:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5ca6:	fed7fae3          	bgeu	a5,a3,5c9a <free+0x36>
    5caa:	6398                	ld	a4,0(a5)
    5cac:	00e6e463          	bltu	a3,a4,5cb4 <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5cb0:	fee7eae3          	bltu	a5,a4,5ca4 <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    5cb4:	ff852583          	lw	a1,-8(a0)
    5cb8:	6390                	ld	a2,0(a5)
    5cba:	02059713          	slli	a4,a1,0x20
    5cbe:	9301                	srli	a4,a4,0x20
    5cc0:	0712                	slli	a4,a4,0x4
    5cc2:	9736                	add	a4,a4,a3
    5cc4:	fae60ae3          	beq	a2,a4,5c78 <free+0x14>
    bp->s.ptr = p->s.ptr;
    5cc8:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5ccc:	4790                	lw	a2,8(a5)
    5cce:	02061713          	slli	a4,a2,0x20
    5cd2:	9301                	srli	a4,a4,0x20
    5cd4:	0712                	slli	a4,a4,0x4
    5cd6:	973e                	add	a4,a4,a5
    5cd8:	fae689e3          	beq	a3,a4,5c8a <free+0x26>
  } else
    p->s.ptr = bp;
    5cdc:	e394                	sd	a3,0(a5)
  freep = p;
    5cde:	00003717          	auipc	a4,0x3
    5ce2:	8ef73923          	sd	a5,-1806(a4) # 85d0 <freep>
}
    5ce6:	6422                	ld	s0,8(sp)
    5ce8:	0141                	addi	sp,sp,16
    5cea:	8082                	ret

0000000000005cec <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5cec:	7139                	addi	sp,sp,-64
    5cee:	fc06                	sd	ra,56(sp)
    5cf0:	f822                	sd	s0,48(sp)
    5cf2:	f426                	sd	s1,40(sp)
    5cf4:	f04a                	sd	s2,32(sp)
    5cf6:	ec4e                	sd	s3,24(sp)
    5cf8:	e852                	sd	s4,16(sp)
    5cfa:	e456                	sd	s5,8(sp)
    5cfc:	e05a                	sd	s6,0(sp)
  ...
  if((prevp = freep) == 0){
    5d10:	00003517          	auipc	a0,0x3
    5d14:	8c053503          	ld	a0,-1856(a0) # 85d0 <freep>
    5d18:	c515                	beqz	a0,5d44 <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    5d1e:	02977f63          	bgeu	a4,s1,5d5c <malloc+0x70>
    5d22:	8a4e                	mv	s4,s3
    5d24:	0009871b          	sext.w	a4,s3
    5d28:	6685                	lui	a3,0x1
    5d2a:	00d77363          	bgeu	a4,a3,5d30 <malloc+0x44>
    5d2e:	6a05                	lui	s4,0x1
    5d30:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    5d34:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    5d38:	00003917          	auipc	s2,0x3
    5d3c:	89890913          	addi	s2,s2,-1896 # 85d0 <freep>
  if(p == (char*)-1)
    5d40:	5afd                	li	s5,-1
    5d42:	a88d                	j	5db4 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    5d44:	00009797          	auipc	a5,0x9
    5d48:	0ac78793          	addi	a5,a5,172 # edf0 <base>
    5d4c:	00003717          	auipc	a4,0x3
    5d50:	88f73223          	sd	a5,-1916(a4) # 85d0 <freep>
    5d54:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5d56:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5d5a:	b7e1                	j	5d22 <malloc+0x36>
      if(p->s.size == nunits)
    5d5c:	02e48b63          	beq	s1,a4,5d92 <malloc+0xa6>
        p->s.size -= nunits;
    5d60:	4137073b          	subw	a4,a4,s3
    5d64:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5d66:	1702                	slli	a4,a4,0x20
    5d68:	9301                	srli	a4,a4,0x20
    5d6a:	0712                	slli	a4,a4,0x4
    5d6c:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5d6e:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5d72:	00003717          	auipc	a4,0x3
    5d76:	84a73f23          	sd	a0,-1954(a4) # 85d0 <freep>
      return (void*)(p + 1);
    5d7a:	01078513          	addi	a0,a5,16
      if((p = morecore(nunits)) == 0)
        return 0;
  }
}
    5d7e:	70e2                	ld	ra,56(sp)
    5d80:	7442                	ld	s0,48(sp)
    5d82:	74a2                	ld	s1,40(sp)
    5d84:	7902                	ld	s2,32(sp)
    5d86:	69e2                	ld	s3,24(sp)
    5d88:	6a42                	ld	s4,16(sp)
    5d8a:	6aa2                	ld	s5,8(sp)
    5d8c:	6b02                	ld	s6,0(sp)
    5d8e:	6121                	addi	sp,sp,64
    5d90:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    5d92:	6398                	ld	a4,0(a5)
    5d94:	e118                	sd	a4,0(a0)
    5d96:	bff1                	j	5d72 <malloc+0x86>
  hp->s.size = nu;
    5d98:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5d9c:	0541                	addi	a0,a0,16
    5d9e:	00000097          	auipc	ra,0x0
    5da2:	ec6080e7          	jalr	-314(ra) # 5c64 <free>
  return freep;
    5da6:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5daa:	d971                	beqz	a0,5d7e <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5dac:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5dae:	4798                	lw	a4,8(a5)
    5db0:	fa9776e3          	bgeu	a4,s1,5d5c <malloc+0x70>
    if(p == freep)
    5db4:	00093703          	ld	a4,0(s2)
    5db8:	853e                	mv	a0,a5
    5dba:	fef719e3          	bne	a4,a5,5dac <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    5dbe:	8552                	mv	a0,s4
    5dc0:	00000097          	auipc	ra,0x0
    5dc4:	b1a080e7          	jalr	-1254(ra) # 58da <sbrk>
  if(p == (char*)-1)
    5dc8:	fd5518e3          	bne	a0,s5,5d98 <malloc+0xac>
        return 0;
    5dcc:	4501                	li	a0,0
    5dce:	bf45                	j	5d7e <malloc+0x92>
