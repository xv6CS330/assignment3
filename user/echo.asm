...
main(int argc, char *argv[])
{
  ...
  2e:	84ea0a13          	addi	s4,s4,-1970 # 878 <malloc+0xe4>
    write(1, argv[i], strlen(argv[i]));
  ...
  6c:	81858593          	addi	a1,a1,-2024 # 880 <malloc+0xec>
  70:	4505                	li	a0,1
...
00000000000003e2 <barrier_alloc>:
...
putc(int fd, char c)
{
 ...
 414:	f0a080e7          	jalr	-246(ra) # 31a <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 446:	44e50513          	addi	a0,a0,1102 # 890 <digits>
 44a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 512:	382b8b93          	addi	s7,s7,898 # 890 <digits>
 ...
 652:	23a90913          	addi	s2,s2,570 # 888 <malloc+0xf4>
        while(*s != 0){
...
free(void *ap)
{
 ...
 71a:	1927b783          	ld	a5,402(a5) # 8a8 <freep>
 ...
 748:	00e6ea63          	bltu	a3,a4,75c <free+0x50>
{
 ...
 78a:	12f73123          	sd	a5,290(a4) # 8a8 <freep>
}
 78e:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7bc:	0f053503          	ld	a0,240(a0) # 8a8 <freep>
 ...
 7e4:	0c890913          	addi	s2,s2,200 # 8a8 <freep>
  if(p == (char*)-1)
 7e8:	5afd                	li	s5,-1
 7ea:	a88d                	j	85c <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7ec:	00000797          	auipc	a5,0x0
 7f0:	0c478793          	addi	a5,a5,196 # 8b0 <base>
 7f4:	00000717          	auipc	a4,0x0
 7f8:	0af73a23          	sd	a5,180(a4) # 8a8 <freep>
 7fc:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 81e:	08a73723          	sd	a0,142(a4) # 8a8 <freep>
      return (void*)(p + 1);
 ...
 86c:	b1a080e7          	jalr	-1254(ra) # 382 <sbrk>
  if(p == (char*)-1)
