...
fmtname(char *path)
{
  ...
  6a:	b8298993          	addi	s3,s3,-1150 # be8 <buf.0>
...
ls(char *path)
{
 ...
 128:	a0450513          	addi	a0,a0,-1532 # b28 <malloc+0x118>
 12c:	00001097          	auipc	ra,0x1
 130:	82c080e7          	jalr	-2004(ra) # 958 <printf>
      }
 ...
 166:	99658593          	addi	a1,a1,-1642 # af8 <malloc+0xe8>
 16a:	4509                	li	a0,2
 16c:	00000097          	auipc	ra,0x0
 170:	7be080e7          	jalr	1982(ra) # 92a <fprintf>
    return;
 174:	b7e9                	j	13e <ls+0x8a>
    fprintf(2, "ls: cannot stat %s\n", path);
 176:	864a                	mv	a2,s2
 178:	00001597          	auipc	a1,0x1
 17c:	99858593          	addi	a1,a1,-1640 # b10 <malloc+0x100>
 180:	4509                	li	a0,2
 182:	00000097          	auipc	ra,0x0
 186:	7a8080e7          	jalr	1960(ra) # 92a <fprintf>
    close(fd);
 18a:	8526                	mv	a0,s1
 ...
 1ae:	98e50513          	addi	a0,a0,-1650 # b38 <malloc+0x128>
 1b2:	00000097          	auipc	ra,0x0
 1b6:	7a6080e7          	jalr	1958(ra) # 958 <printf>
      break;
 ...
 1f2:	962a0a13          	addi	s4,s4,-1694 # b50 <malloc+0x140>
        printf("ls: cannot stat %s\n", buf);
 1f6:	00001a97          	auipc	s5,0x1
 1fa:	91aa8a93          	addi	s5,s5,-1766 # b10 <malloc+0x100>
 ...
 20a:	752080e7          	jalr	1874(ra) # 958 <printf>
    while(read(fd, &de, sizeof(de)) == sizeof(de)){
 20e:	4641                	li	a2,16
 ...
 272:	6ea080e7          	jalr	1770(ra) # 958 <printf>
...
main(int argc, char *argv[])
{
 ...
 2bc:	8a850513          	addi	a0,a0,-1880 # b60 <malloc+0x150>
...
0000000000000626 <barrier_alloc>:
...
000000000000062e <barrier>:
.global barrier
barrier:
 li a7, SYS_barrier
 62e:	02000893          	li	a7,32
 ecall
 632:	00000073          	ecall
 ret
 636:	8082                	ret

0000000000000638 <barrier_free>:
.global barrier_free
barrier_free:
 li a7, SYS_barrier_free
 638:	02100893          	li	a7,33
 ecall
 63c:	00000073          	ecall
 ret
 640:	8082                	ret

0000000000000642 <buffer_cond_init>:
.global buffer_cond_init
buffer_cond_init:
 li a7, SYS_buffer_cond_init
 642:	02200893          	li	a7,34
 ecall
 646:	00000073          	ecall
 ret
 64a:	8082                	ret

000000000000064c <cond_produce>:
.global cond_produce
cond_produce:
 li a7, SYS_cond_produce
 64c:	02300893          	li	a7,35
 ecall
 650:	00000073          	ecall
 ret
 654:	8082                	ret

0000000000000656 <cond_consume>:
.global cond_consume
cond_consume:
 li a7, SYS_cond_consume
 656:	02400893          	li	a7,36
 ecall
 65a:	00000073          	ecall
 ret
 65e:	8082                	ret

0000000000000660 <buffer_sem_init>:
.global buffer_sem_init
buffer_sem_init:
 li a7, SYS_buffer_sem_init
 660:	02500893          	li	a7,37
 ecall
 664:	00000073          	ecall
 ret
 668:	8082                	ret

000000000000066a <sem_produce>:
.global sem_produce
sem_produce:
 li a7, SYS_sem_produce
 66a:	02600893          	li	a7,38
 ecall
 66e:	00000073          	ecall
 ret
 672:	8082                	ret

0000000000000674 <sem_consume>:
.global sem_consume
sem_consume:
 li a7, SYS_sem_consume
 674:	02700893          	li	a7,39
 ecall
 678:	00000073          	ecall
 ret
 67c:	8082                	ret
...
putc(int fd, char c)
{
 ...
 694:	ece080e7          	jalr	-306(ra) # 55e <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 6c6:	50650513          	addi	a0,a0,1286 # bc8 <digits>
 6ca:	883a                	mv	a6,a4
...
{
 74c:	7119                	addi	sp,sp,-128
 74e:	fc86                	sd	ra,120(sp)
 750:	f8a2                	sd	s0,112(sp)
 752:	f4a6                	sd	s1,104(sp)
 754:	f0ca                	sd	s2,96(sp)
 756:	ecce                	sd	s3,88(sp)
 758:	e8d2                	sd	s4,80(sp)
 75a:	e4d6                	sd	s5,72(sp)
 75c:	e0da                	sd	s6,64(sp)
 75e:	fc5e                	sd	s7,56(sp)
 760:	f862                	sd	s8,48(sp)
 762:	f466                	sd	s9,40(sp)
 764:	f06a                	sd	s10,32(sp)
 766:	ec6e                	sd	s11,24(sp)
 ...
 76e:	18090f63          	beqz	s2,90c <vprintf+0x1c0>
 772:	8aaa                	mv	s5,a0
 774:	8b32                	mv	s6,a2
 776:	00158493          	addi	s1,a1,1
  state = 0;
 77a:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
 ...
 780:	4c55                	li	s8,21
 782:	00000c97          	auipc	s9,0x0
 786:	3eec8c93          	addi	s9,s9,1006 # b70 <malloc+0x160>
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
 78a:	02800d93          	li	s11,40
  putc(fd, 'x');
 78e:	4d41                	li	s10,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 790:	00000b97          	auipc	s7,0x0
 794:	438b8b93          	addi	s7,s7,1080 # bc8 <digits>
 798:	a839                	j	7b6 <vprintf+0x6a>
        putc(fd, c);
 79a:	85ca                	mv	a1,s2
 79c:	8556                	mv	a0,s5
 79e:	00000097          	auipc	ra,0x0
 7a2:	ee0080e7          	jalr	-288(ra) # 67e <putc>
 7a6:	a019                	j	7ac <vprintf+0x60>
    } else if(state == '%'){
 7a8:	01498d63          	beq	s3,s4,7c2 <vprintf+0x76>
  for(i = 0; fmt[i]; i++){
 7ac:	0485                	addi	s1,s1,1
 7ae:	fff4c903          	lbu	s2,-1(s1)
 7b2:	14090d63          	beqz	s2,90c <vprintf+0x1c0>
    if(state == 0){
 7b6:	fe0999e3          	bnez	s3,7a8 <vprintf+0x5c>
      if(c == '%'){
 7ba:	ff4910e3          	bne	s2,s4,79a <vprintf+0x4e>
        state = '%';
 7be:	89d2                	mv	s3,s4
 7c0:	b7f5                	j	7ac <vprintf+0x60>
      if(c == 'd'){
 7c2:	11490c63          	beq	s2,s4,8da <vprintf+0x18e>
 7c6:	f9d9079b          	addiw	a5,s2,-99
 7ca:	0ff7f793          	zext.b	a5,a5
 7ce:	10fc6e63          	bltu	s8,a5,8ea <vprintf+0x19e>
 7d2:	f9d9079b          	addiw	a5,s2,-99
 7d6:	0ff7f713          	zext.b	a4,a5
 7da:	10ec6863          	bltu	s8,a4,8ea <vprintf+0x19e>
 7de:	00271793          	slli	a5,a4,0x2
 ...
 7fc:	ea8080e7          	jalr	-344(ra) # 6a0 <printint>
 800:	8b4a                	mv	s6,s2
      } else {
 ...
 818:	e8c080e7          	jalr	-372(ra) # 6a0 <printint>
 81c:	8b4a                	mv	s6,s2
      state = 0;
 81e:	4981                	li	s3,0
 820:	b771                	j	7ac <vprintf+0x60>
 ...
 834:	e70080e7          	jalr	-400(ra) # 6a0 <printint>
 838:	8b4a                	mv	s6,s2
      state = 0;
 83a:	4981                	li	s3,0
 83c:	bf85                	j	7ac <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
 ...
 854:	e2e080e7          	jalr	-466(ra) # 67e <putc>
  putc(fd, 'x');
 858:	07800593          	li	a1,120
 85c:	8556                	mv	a0,s5
 85e:	00000097          	auipc	ra,0x0
 862:	e20080e7          	jalr	-480(ra) # 67e <putc>
 866:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 ...
 878:	e0a080e7          	jalr	-502(ra) # 67e <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 87c:	0992                	slli	s3,s3,0x4
 87e:	397d                	addiw	s2,s2,-1
 880:	fe0914e3          	bnez	s2,868 <vprintf+0x11c>
        printptr(fd, va_arg(ap, uint64));
 884:	f8843b03          	ld	s6,-120(s0)
      state = 0;
 888:	4981                	li	s3,0
 88a:	b70d                	j	7ac <vprintf+0x60>
        s = va_arg(ap, char*);
 88c:	008b0913          	addi	s2,s6,8
 890:	000b3983          	ld	s3,0(s6)
        if(s == 0)
 894:	02098163          	beqz	s3,8b6 <vprintf+0x16a>
        while(*s != 0){
 898:	0009c583          	lbu	a1,0(s3)
 89c:	c5ad                	beqz	a1,906 <vprintf+0x1ba>
          putc(fd, *s);
 89e:	8556                	mv	a0,s5
 8a0:	00000097          	auipc	ra,0x0
 8a4:	dde080e7          	jalr	-546(ra) # 67e <putc>
          s++;
 8a8:	0985                	addi	s3,s3,1
        while(*s != 0){
 8aa:	0009c583          	lbu	a1,0(s3)
 8ae:	f9e5                	bnez	a1,89e <vprintf+0x152>
        s = va_arg(ap, char*);
 8b0:	8b4a                	mv	s6,s2
      state = 0;
 8b2:	4981                	li	s3,0
 8b4:	bde5                	j	7ac <vprintf+0x60>
          s = "(null)";
 8b6:	00000997          	auipc	s3,0x0
 8ba:	2b298993          	addi	s3,s3,690 # b68 <malloc+0x158>
        while(*s != 0){
 8be:	85ee                	mv	a1,s11
 8c0:	bff9                	j	89e <vprintf+0x152>
        putc(fd, va_arg(ap, uint));
 8c2:	008b0913          	addi	s2,s6,8
 8c6:	000b4583          	lbu	a1,0(s6)
 8ca:	8556                	mv	a0,s5
 8cc:	00000097          	auipc	ra,0x0
 8d0:	db2080e7          	jalr	-590(ra) # 67e <putc>
 8d4:	8b4a                	mv	s6,s2
      state = 0;
 8d6:	4981                	li	s3,0
 8d8:	bdd1                	j	7ac <vprintf+0x60>
        putc(fd, c);
 8da:	85d2                	mv	a1,s4
 8dc:	8556                	mv	a0,s5
 ...
 8fe:	d84080e7          	jalr	-636(ra) # 67e <putc>
      state = 0;
 902:	4981                	li	s3,0
 904:	b565                	j	7ac <vprintf+0x60>
        s = va_arg(ap, char*);
 906:	8b4a                	mv	s6,s2
      state = 0;
 908:	4981                	li	s3,0
 90a:	b54d                	j	7ac <vprintf+0x60>
    }
  }
}
 90c:	70e6                	ld	ra,120(sp)
 90e:	7446                	ld	s0,112(sp)
 910:	74a6                	ld	s1,104(sp)
 912:	7906                	ld	s2,96(sp)
 914:	69e6                	ld	s3,88(sp)
 916:	6a46                	ld	s4,80(sp)
 918:	6aa6                	ld	s5,72(sp)
 91a:	6b06                	ld	s6,64(sp)
 91c:	7be2                	ld	s7,56(sp)
 91e:	7c42                	ld	s8,48(sp)
 920:	7ca2                	ld	s9,40(sp)
 922:	7d02                	ld	s10,32(sp)
 924:	6de2                	ld	s11,24(sp)
 926:	6109                	addi	sp,sp,128
 928:	8082                	ret
...
fprintf(int fd, const char *fmt, ...)
{
 ...
 94c:	e04080e7          	jalr	-508(ra) # 74c <vprintf>
}
...
printf(const char *fmt, ...)
{
 ...
 982:	dce080e7          	jalr	-562(ra) # 74c <vprintf>
}
...
free(void *ap)
{
 ...
 99c:	2487b783          	ld	a5,584(a5) # be0 <freep>
 ...
 9c4:	00e6ea63          	bltu	a3,a4,9d8 <free+0x4a>
{
 ...
 a06:	1cf73f23          	sd	a5,478(a4) # be0 <freep>
}
 a0a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 a38:	1ac53503          	ld	a0,428(a0) # be0 <freep>
 ...
 a60:	18490913          	addi	s2,s2,388 # be0 <freep>
  if(p == (char*)-1)
 a64:	5afd                	li	s5,-1
 a66:	a895                	j	ada <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 a68:	00000797          	auipc	a5,0x0
 a6c:	19078793          	addi	a5,a5,400 # bf8 <base>
 a70:	00000717          	auipc	a4,0x0
 a74:	16f73823          	sd	a5,368(a4) # be0 <freep>
 a78:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a9c:	14a73423          	sd	a0,328(a4) # be0 <freep>
      return (void*)(p + 1);
 ...
 aea:	ae0080e7          	jalr	-1312(ra) # 5c6 <sbrk>
  if(p == (char*)-1)
