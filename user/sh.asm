...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
      ...
      14:	33858593          	addi	a1,a1,824 # 1348 <malloc+0xe4>
      18:	4509                	li	a0,2
      1a:	00001097          	auipc	ra,0x1
      1e:	15e080e7          	jalr	350(ra) # 1178 <fprintf>
  memset(buf, 0, nbuf);
      22:	864a                	mv	a2,s2
      24:	4581                	li	a1,0
      26:	8526                	mv	a0,s1
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	2f258593          	addi	a1,a1,754 # 1350 <malloc+0xec>
      66:	4509                	li	a0,2
      68:	00001097          	auipc	ra,0x1
      6c:	110080e7          	jalr	272(ra) # 1178 <fprintf>
  exit(1);
      70:	4505                	li	a0,1
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9c:	2c050513          	addi	a0,a0,704 # 1358 <malloc+0xf4>
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      c8:	39470713          	addi	a4,a4,916 # 1458 <malloc+0x1f4>
    ...
    panic("runcmd");
      ...
      e2:	28250513          	addi	a0,a0,642 # 1360 <malloc+0xfc>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     104:	26858593          	addi	a1,a1,616 # 1368 <malloc+0x104>
     108:	4509                	li	a0,2
     10a:	00001097          	auipc	ra,0x1
     10e:	06e080e7          	jalr	110(ra) # 1178 <fprintf>
  exit(0);
     112:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     150:	22c58593          	addi	a1,a1,556 # 1378 <malloc+0x114>
     154:	4509                	li	a0,2
     156:	00001097          	auipc	ra,0x1
     15a:	022080e7          	jalr	34(ra) # 1178 <fprintf>
      exit(1);
     15e:	4505                	li	a0,1
    ...
    break;
     ...
     1e6:	1a650513          	addi	a0,a0,422 # 1388 <malloc+0x124>
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     288:	fe0080e7          	jalr	-32(ra) # 1264 <malloc>
     28c:	84aa                	mv	s1,a0
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     2d2:	f96080e7          	jalr	-106(ra) # 1264 <malloc>
     2d6:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     32c:	f3c080e7          	jalr	-196(ra) # 1264 <malloc>
     330:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     332:	4661                	li	a2,24
     334:	4581                	li	a1,0
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     372:	ef6080e7          	jalr	-266(ra) # 1264 <malloc>
     376:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     378:	4661                	li	a2,24
     37a:	4581                	li	a1,0
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3b4:	eb4080e7          	jalr	-332(ra) # 1264 <malloc>
     3b8:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     3ba:	4641                	li	a2,16
     3bc:	4581                	li	a1,0
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     462:	05298993          	addi	s3,s3,82 # 14b0 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4cc:	fe898993          	addi	s3,s3,-24 # 14b0 <whitespace>
     4d0:	00001a97          	auipc	s5,0x1
     4d4:	fd8a8a93          	addi	s5,s5,-40 # 14a8 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     536:	f7e98993          	addi	s3,s3,-130 # 14b0 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a6:	e0eb8b93          	addi	s7,s7,-498 # 13b0 <malloc+0x14c>
  ...
  while(peek(ps, es, "<>")){
     ...
     5b8:	ddc50513          	addi	a0,a0,-548 # 1390 <malloc+0x12c>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a0:	d1c60613          	addi	a2,a2,-740 # 13b8 <malloc+0x154>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d0:	d0cb0b13          	addi	s6,s6,-756 # 13d8 <malloc+0x174>
  ...
  return ret;
     ...
     70a:	cba50513          	addi	a0,a0,-838 # 13c0 <malloc+0x15c>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76c:	c6050513          	addi	a0,a0,-928 # 13c8 <malloc+0x164>
...
0000000000000786 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a6:	c3e60613          	addi	a2,a2,-962 # 13e0 <malloc+0x17c>
     7aa:	85ce                	mv	a1,s3
     7ac:	854a                	mv	a0,s2
...
00000000000007f4 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     816:	bd6a0a13          	addi	s4,s4,-1066 # 13e8 <malloc+0x184>
     81a:	8652                	mv	a2,s4
     81c:	85ce                	mv	a1,s3
     81e:	854a                	mv	a0,s2
  ...
  if(peek(ps, es, ";")){
     ...
     84c:	ba860613          	addi	a2,a2,-1112 # 13f0 <malloc+0x18c>
     850:	85ce                	mv	a1,s3
     852:	854a                	mv	a0,s2
...
000000000000089c <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b2:	b0a60613          	addi	a2,a2,-1270 # 13b8 <malloc+0x154>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e2:	b2a60613          	addi	a2,a2,-1238 # 1408 <malloc+0x1a4>
     8e6:	85ca                	mv	a1,s2
     8e8:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     924:	ad850513          	addi	a0,a0,-1320 # 13f8 <malloc+0x194>
     928:	fffff097          	auipc	ra,0xfffff
     92c:	72c080e7          	jalr	1836(ra) # 54 <panic>
    panic("syntax - missing )");
     930:	00001517          	auipc	a0,0x1
     934:	ae050513          	addi	a0,a0,-1312 # 1410 <malloc+0x1ac>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     960:	b1470713          	addi	a4,a4,-1260 # 1470 <malloc+0x20c>
...
00000000000009d8 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0c:	a2060613          	addi	a2,a2,-1504 # 1428 <malloc+0x1c4>
     a10:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a42:	9f258593          	addi	a1,a1,-1550 # 1430 <malloc+0x1cc>
     a46:	4509                	li	a0,2
     a48:	00000097          	auipc	ra,0x0
     a4c:	730080e7          	jalr	1840(ra) # 1178 <fprintf>
    panic("syntax");
     a50:	00001517          	auipc	a0,0x1
     a54:	97050513          	addi	a0,a0,-1680 # 13c0 <malloc+0x15c>
...
0000000000000a60 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a76:	9ce48493          	addi	s1,s1,-1586 # 1440 <malloc+0x1dc>
     a7a:	4589                	li	a1,2
     a7c:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     a9c:	a2848493          	addi	s1,s1,-1496 # 14c0 <buf.1162>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa0:	06300913          	li	s2,99
     aa4:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     aa8:	00001a17          	auipc	s4,0x1
     aac:	a1ba0a13          	addi	s4,s4,-1509 # 14c3 <buf.1162+0x3>
        fprintf(2, "cannot cd %s\n", buf+3);
     ab0:	00001a97          	auipc	s5,0x1
     ab4:	998a8a93          	addi	s5,s5,-1640 # 1448 <malloc+0x1e4>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b2c:	650080e7          	jalr	1616(ra) # 1178 <fprintf>
     b30:	bf79                	j	ace <main+0x6e>
      runcmd(parsecmd(buf));
     b32:	00001517          	auipc	a0,0x1
     b36:	98e50513          	addi	a0,a0,-1650 # 14c0 <buf.1162>
...
0000000000000eb2 <barrier_alloc>:
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     ee4:	f0a080e7          	jalr	-246(ra) # dea <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
     ...
     f02:	0805c863          	bltz	a1,f92 <printint+0xa2>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f16:	57e50513          	addi	a0,a0,1406 # 1490 <digits>
     f1a:	883a                	mv	a6,a4
  ...
  if(neg)
     f3e:	00088b63          	beqz	a7,f54 <printint+0x64>
    buf[i++] = '-';
     f42:	fd040793          	addi	a5,s0,-48
  ...
  while(--i >= 0)
     f54:	02e05863          	blez	a4,f84 <printint+0x94>
     f58:	fc040793          	addi	a5,s0,-64
     f5c:	00e78933          	add	s2,a5,a4
     f60:	fff78993          	addi	s3,a5,-1
     f64:	99ba                	add	s3,s3,a4
     f66:	377d                	addiw	a4,a4,-1
     f68:	1702                	slli	a4,a4,0x20
     f6a:	9301                	srli	a4,a4,0x20
     f6c:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
     f70:	fff94583          	lbu	a1,-1(s2)
     f74:	8526                	mv	a0,s1
     f76:	00000097          	auipc	ra,0x0
     f7a:	f58080e7          	jalr	-168(ra) # ece <putc>
  while(--i >= 0)
     f7e:	197d                	addi	s2,s2,-1
     f80:	ff3918e3          	bne	s2,s3,f70 <printint+0x80>
}
     f84:	70e2                	ld	ra,56(sp)
     f86:	7442                	ld	s0,48(sp)
     f88:	74a2                	ld	s1,40(sp)
     f8a:	7902                	ld	s2,32(sp)
     f8c:	69e2                	ld	s3,24(sp)
     f8e:	6121                	addi	sp,sp,64
     f90:	8082                	ret
    x = -xx;
     f92:	40b005bb          	negw	a1,a1
    neg = 1;
     f96:	4885                	li	a7,1
    x = -xx;
     f98:	bf8d                	j	f0a <printint+0x1a>

0000000000000f9a <vprintf>:
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
     ...
     fa6:	e8d2                	sd	s4,80(sp)
     fa8:	e4d6                	sd	s5,72(sp)
     faa:	e0da                	sd	s6,64(sp)
     fac:	fc5e                	sd	s7,56(sp)
     fae:	f862                	sd	s8,48(sp)
     fb0:	f466                	sd	s9,40(sp)
     fb2:	f06a                	sd	s10,32(sp)
     fb4:	ec6e                	sd	s11,24(sp)
  ...
  for(i = 0; fmt[i]; i++){
     ...
     fbc:	18090f63          	beqz	s2,115a <vprintf+0x1c0>
     fc0:	8aaa                	mv	s5,a0
     fc2:	8b32                	mv	s6,a2
  ...
  state = 0;
     ...
     fca:	02500a13          	li	s4,37
      if(c == 'd'){
     fce:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c == 'l') {
     fd2:	06c00c93          	li	s9,108
        printint(fd, va_arg(ap, uint64), 10, 0);
      } else if(c == 'x') {
     fd6:	07800d13          	li	s10,120
        printint(fd, va_arg(ap, int), 16, 0);
      } else if(c == 'p') {
     fda:	07000d93          	li	s11,112
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     fde:	00000b97          	auipc	s7,0x0
     fe2:	4b2b8b93          	addi	s7,s7,1202 # 1490 <digits>
     fe6:	a839                	j	1004 <vprintf+0x6a>
        putc(fd, c);
     fe8:	85ca                	mv	a1,s2
     fea:	8556                	mv	a0,s5
     fec:	00000097          	auipc	ra,0x0
     ff0:	ee2080e7          	jalr	-286(ra) # ece <putc>
     ff4:	a019                	j	ffa <vprintf+0x60>
    } else if(state == '%'){
     ff6:	01498f63          	beq	s3,s4,1014 <vprintf+0x7a>
  for(i = 0; fmt[i]; i++){
     ffa:	0485                	addi	s1,s1,1
     ffc:	fff4c903          	lbu	s2,-1(s1)
    1000:	14090d63          	beqz	s2,115a <vprintf+0x1c0>
    c = fmt[i] & 0xff;
    1004:	0009079b          	sext.w	a5,s2
    if(state == 0){
    1008:	fe0997e3          	bnez	s3,ff6 <vprintf+0x5c>
      if(c == '%'){
    100c:	fd479ee3          	bne	a5,s4,fe8 <vprintf+0x4e>
        state = '%';
    1010:	89be                	mv	s3,a5
    1012:	b7e5                	j	ffa <vprintf+0x60>
      if(c == 'd'){
    1014:	05878063          	beq	a5,s8,1054 <vprintf+0xba>
      } else if(c == 'l') {
    1018:	05978c63          	beq	a5,s9,1070 <vprintf+0xd6>
      } else if(c == 'x') {
    101c:	07a78863          	beq	a5,s10,108c <vprintf+0xf2>
      } else if(c == 'p') {
    1020:	09b78463          	beq	a5,s11,10a8 <vprintf+0x10e>
        printptr(fd, va_arg(ap, uint64));
      } else if(c == 's'){
    1024:	07300713          	li	a4,115
    1028:	0ce78663          	beq	a5,a4,10f4 <vprintf+0x15a>
          s = "(null)";
        while(*s != 0){
          putc(fd, *s);
          s++;
    ...
    102c:	06300713          	li	a4,99
    1030:	0ee78e63          	beq	a5,a4,112c <vprintf+0x192>
        putc(fd, va_arg(ap, uint));
      } else if(c == '%'){
    1034:	11478863          	beq	a5,s4,1144 <vprintf+0x1aa>
        putc(fd, c);
      } else {
    ...
    1040:	e92080e7          	jalr	-366(ra) # ece <putc>
        putc(fd, c);
    1044:	85ca                	mv	a1,s2
    1046:	8556                	mv	a0,s5
    1048:	00000097          	auipc	ra,0x0
    104c:	e86080e7          	jalr	-378(ra) # ece <putc>
      }
      state = 0;
    1050:	4981                	li	s3,0
    1052:	b765                	j	ffa <vprintf+0x60>
        printint(fd, va_arg(ap, int), 10, 1);
    ...
    1066:	e8e080e7          	jalr	-370(ra) # ef0 <printint>
    106a:	8b4a                	mv	s6,s2
      state = 0;
    106c:	4981                	li	s3,0
    106e:	b771                	j	ffa <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    ...
    1082:	e72080e7          	jalr	-398(ra) # ef0 <printint>
    1086:	8b4a                	mv	s6,s2
      state = 0;
    1088:	4981                	li	s3,0
    108a:	bf85                	j	ffa <vprintf+0x60>
        printint(fd, va_arg(ap, int), 16, 0);
    ...
    109e:	e56080e7          	jalr	-426(ra) # ef0 <printint>
    10a2:	8b4a                	mv	s6,s2
      state = 0;
    10a4:	4981                	li	s3,0
    10a6:	bf91                	j	ffa <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    10a8:	008b0793          	addi	a5,s6,8
    10ac:	f8f43423          	sd	a5,-120(s0)
    10b0:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    10b4:	03000593          	li	a1,48
    10b8:	8556                	mv	a0,s5
    10ba:	00000097          	auipc	ra,0x0
    10be:	e14080e7          	jalr	-492(ra) # ece <putc>
  putc(fd, 'x');
    10c2:	85ea                	mv	a1,s10
    10c4:	8556                	mv	a0,s5
    10c6:	00000097          	auipc	ra,0x0
    10ca:	e08080e7          	jalr	-504(ra) # ece <putc>
    10ce:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    ...
    10e0:	df2080e7          	jalr	-526(ra) # ece <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    10e4:	0992                	slli	s3,s3,0x4
    10e6:	397d                	addiw	s2,s2,-1
    10e8:	fe0914e3          	bnez	s2,10d0 <vprintf+0x136>
        printptr(fd, va_arg(ap, uint64));
    10ec:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    10f0:	4981                	li	s3,0
    10f2:	b721                	j	ffa <vprintf+0x60>
        s = va_arg(ap, char*);
    10f4:	008b0993          	addi	s3,s6,8
    10f8:	000b3903          	ld	s2,0(s6)
        if(s == 0)
    10fc:	02090163          	beqz	s2,111e <vprintf+0x184>
        while(*s != 0){
    1100:	00094583          	lbu	a1,0(s2)
    1104:	c9a1                	beqz	a1,1154 <vprintf+0x1ba>
          putc(fd, *s);
    1106:	8556                	mv	a0,s5
    1108:	00000097          	auipc	ra,0x0
    110c:	dc6080e7          	jalr	-570(ra) # ece <putc>
          s++;
    1110:	0905                	addi	s2,s2,1
        while(*s != 0){
    1112:	00094583          	lbu	a1,0(s2)
    1116:	f9e5                	bnez	a1,1106 <vprintf+0x16c>
        s = va_arg(ap, char*);
    1118:	8b4e                	mv	s6,s3
      state = 0;
    111a:	4981                	li	s3,0
    111c:	bdf9                	j	ffa <vprintf+0x60>
          s = "(null)";
    111e:	00000917          	auipc	s2,0x0
    1122:	36a90913          	addi	s2,s2,874 # 1488 <malloc+0x224>
        while(*s != 0){
    1126:	02800593          	li	a1,40
    112a:	bff1                	j	1106 <vprintf+0x16c>
        putc(fd, va_arg(ap, uint));
    112c:	008b0913          	addi	s2,s6,8
    1130:	000b4583          	lbu	a1,0(s6)
    1134:	8556                	mv	a0,s5
    1136:	00000097          	auipc	ra,0x0
    113a:	d98080e7          	jalr	-616(ra) # ece <putc>
    113e:	8b4a                	mv	s6,s2
      state = 0;
    1140:	4981                	li	s3,0
    1142:	bd65                	j	ffa <vprintf+0x60>
        putc(fd, c);
    1144:	85d2                	mv	a1,s4
    1146:	8556                	mv	a0,s5
    1148:	00000097          	auipc	ra,0x0
    114c:	d86080e7          	jalr	-634(ra) # ece <putc>
      state = 0;
    1150:	4981                	li	s3,0
    1152:	b565                	j	ffa <vprintf+0x60>
        s = va_arg(ap, char*);
    1154:	8b4e                	mv	s6,s3
      state = 0;
    1156:	4981                	li	s3,0
    1158:	b54d                	j	ffa <vprintf+0x60>
    }
  }
}
    115a:	70e6                	ld	ra,120(sp)
    115c:	7446                	ld	s0,112(sp)
    115e:	74a6                	ld	s1,104(sp)
    1160:	7906                	ld	s2,96(sp)
    1162:	69e6                	ld	s3,88(sp)
    1164:	6a46                	ld	s4,80(sp)
    1166:	6aa6                	ld	s5,72(sp)
    1168:	6b06                	ld	s6,64(sp)
    116a:	7be2                	ld	s7,56(sp)
    116c:	7c42                	ld	s8,48(sp)
    116e:	7ca2                	ld	s9,40(sp)
    1170:	7d02                	ld	s10,32(sp)
    1172:	6de2                	ld	s11,24(sp)
    1174:	6109                	addi	sp,sp,128
    1176:	8082                	ret
...
fprintf(int fd, const char *fmt, ...)
{
  ...
  vprintf(fd, fmt, ap);
    ...
    119a:	e04080e7          	jalr	-508(ra) # f9a <vprintf>
}
    119e:	60e2                	ld	ra,24(sp)
    11a0:	6442                	ld	s0,16(sp)
    11a2:	6161                	addi	sp,sp,80
    11a4:	8082                	ret
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    11ea:	2d27b783          	ld	a5,722(a5) # 14b8 <freep>
    11ee:	a805                	j	121e <free+0x42>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    11f0:	4618                	lw	a4,8(a2)
    11f2:	9db9                	addw	a1,a1,a4
    11f4:	feb52c23          	sw	a1,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    11f8:	6398                	ld	a4,0(a5)
    11fa:	6318                	ld	a4,0(a4)
    11fc:	fee53823          	sd	a4,-16(a0)
    1200:	a091                	j	1244 <free+0x68>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    1202:	ff852703          	lw	a4,-8(a0)
    1206:	9e39                	addw	a2,a2,a4
    1208:	c790                	sw	a2,8(a5)
    p->s.ptr = bp->s.ptr;
    120a:	ff053703          	ld	a4,-16(a0)
    120e:	e398                	sd	a4,0(a5)
    1210:	a099                	j	1256 <free+0x7a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1212:	6398                	ld	a4,0(a5)
    1214:	00e7e463          	bltu	a5,a4,121c <free+0x40>
    1218:	00e6ea63          	bltu	a3,a4,122c <free+0x50>
{
    121c:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    121e:	fed7fae3          	bgeu	a5,a3,1212 <free+0x36>
    1222:	6398                	ld	a4,0(a5)
    1224:	00e6e463          	bltu	a3,a4,122c <free+0x50>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1228:	fee7eae3          	bltu	a5,a4,121c <free+0x40>
  if(bp + bp->s.size == p->s.ptr){
    122c:	ff852583          	lw	a1,-8(a0)
    1230:	6390                	ld	a2,0(a5)
    1232:	02059713          	slli	a4,a1,0x20
    1236:	9301                	srli	a4,a4,0x20
    1238:	0712                	slli	a4,a4,0x4
    123a:	9736                	add	a4,a4,a3
    123c:	fae60ae3          	beq	a2,a4,11f0 <free+0x14>
    bp->s.ptr = p->s.ptr;
    1240:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    1244:	4790                	lw	a2,8(a5)
    1246:	02061713          	slli	a4,a2,0x20
    124a:	9301                	srli	a4,a4,0x20
    124c:	0712                	slli	a4,a4,0x4
    124e:	973e                	add	a4,a4,a5
    1250:	fae689e3          	beq	a3,a4,1202 <free+0x26>
  } else
    p->s.ptr = bp;
    1254:	e394                	sd	a3,0(a5)
  freep = p;
    1256:	00000717          	auipc	a4,0x0
    125a:	26f73123          	sd	a5,610(a4) # 14b8 <freep>
}
    125e:	6422                	ld	s0,8(sp)
    1260:	0141                	addi	sp,sp,16
    1262:	8082                	ret

0000000000001264 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    ...
    126a:	f426                	sd	s1,40(sp)
    126c:	f04a                	sd	s2,32(sp)
    126e:	ec4e                	sd	s3,24(sp)
    1270:	e852                	sd	s4,16(sp)
    1272:	e456                	sd	s5,8(sp)
    1274:	e05a                	sd	s6,0(sp)
    1276:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1278:	02051493          	slli	s1,a0,0x20
    127c:	9081                	srli	s1,s1,0x20
    127e:	04bd                	addi	s1,s1,15
    1280:	8091                	srli	s1,s1,0x4
    1282:	0014899b          	addiw	s3,s1,1
    1286:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    1288:	00000517          	auipc	a0,0x0
    128c:	23053503          	ld	a0,560(a0) # 14b8 <freep>
    1290:	c515                	beqz	a0,12bc <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1292:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    1294:	4798                	lw	a4,8(a5)
    1296:	02977f63          	bgeu	a4,s1,12d4 <malloc+0x70>
    129a:	8a4e                	mv	s4,s3
    129c:	0009871b          	sext.w	a4,s3
    12a0:	6685                	lui	a3,0x1
    12a2:	00d77363          	bgeu	a4,a3,12a8 <malloc+0x44>
    12a6:	6a05                	lui	s4,0x1
    12a8:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    12ac:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    12b4:	20890913          	addi	s2,s2,520 # 14b8 <freep>
  if(p == (char*)-1)
    12b8:	5afd                	li	s5,-1
    12ba:	a88d                	j	132c <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
    12bc:	00000797          	auipc	a5,0x0
    12c0:	26c78793          	addi	a5,a5,620 # 1528 <base>
    12c4:	00000717          	auipc	a4,0x0
    12c8:	1ef73a23          	sd	a5,500(a4) # 14b8 <freep>
    12cc:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    12ce:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    12d2:	b7e1                	j	129a <malloc+0x36>
      if(p->s.size == nunits)
    12d4:	02e48b63          	beq	s1,a4,130a <malloc+0xa6>
        p->s.size -= nunits;
    12d8:	4137073b          	subw	a4,a4,s3
    12dc:	c798                	sw	a4,8(a5)
        p += p->s.size;
    12de:	1702                	slli	a4,a4,0x20
    ...
    12ee:	1ca73723          	sd	a0,462(a4) # 14b8 <freep>
      return (void*)(p + 1);
    ...
    130e:	bff1                	j	12ea <malloc+0x86>
  hp->s.size = nu;
    1310:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    1314:	0541                	addi	a0,a0,16
    1316:	00000097          	auipc	ra,0x0
    131a:	ec6080e7          	jalr	-314(ra) # 11dc <free>
  return freep;
    131e:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    1322:	d971                	beqz	a0,12f6 <malloc+0x92>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1324:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    1326:	4798                	lw	a4,8(a5)
    1328:	fa9776e3          	bgeu	a4,s1,12d4 <malloc+0x70>
    if(p == freep)
    132c:	00093703          	ld	a4,0(s2)
    1330:	853e                	mv	a0,a5
    1332:	fef719e3          	bne	a4,a5,1324 <malloc+0xc0>
  p = sbrk(nu * sizeof(Header));
    1336:	8552                	mv	a0,s4
    1338:	00000097          	auipc	ra,0x0
    133c:	b1a080e7          	jalr	-1254(ra) # e52 <sbrk>
  if(p == (char*)-1)
    1340:	fd5518e3          	bne	a0,s5,1310 <malloc+0xac>
        return 0;
    1344:	4501                	li	a0,0
    1346:	bf45                	j	12f6 <malloc+0x92>
