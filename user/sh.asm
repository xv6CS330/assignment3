...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "$ ");
      ...
      14:	37058593          	addi	a1,a1,880 # 1380 <malloc+0xe6>
      18:	4509                	li	a0,2
      1a:	00001097          	auipc	ra,0x1
      1e:	19a080e7          	jalr	410(ra) # 11b4 <fprintf>
  memset(buf, 0, nbuf);
      22:	864a                	mv	a2,s2
      24:	4581                	li	a1,0
      26:	8526                	mv	a0,s1
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	32a58593          	addi	a1,a1,810 # 1388 <malloc+0xee>
      66:	4509                	li	a0,2
      68:	00001097          	auipc	ra,0x1
      6c:	14c080e7          	jalr	332(ra) # 11b4 <fprintf>
  exit(1);
      70:	4505                	li	a0,1
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9c:	2f850513          	addi	a0,a0,760 # 1390 <malloc+0xf6>
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      c8:	3cc70713          	addi	a4,a4,972 # 1490 <malloc+0x1f6>
    ...
    panic("runcmd");
      ...
      e2:	2ba50513          	addi	a0,a0,698 # 1398 <malloc+0xfe>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     104:	2a058593          	addi	a1,a1,672 # 13a0 <malloc+0x106>
     108:	4509                	li	a0,2
     10a:	00001097          	auipc	ra,0x1
     10e:	0aa080e7          	jalr	170(ra) # 11b4 <fprintf>
  exit(0);
     112:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     150:	26458593          	addi	a1,a1,612 # 13b0 <malloc+0x116>
     154:	4509                	li	a0,2
     156:	00001097          	auipc	ra,0x1
     15a:	05e080e7          	jalr	94(ra) # 11b4 <fprintf>
      exit(1);
     15e:	4505                	li	a0,1
    ...
    break;
     ...
     1e6:	1de50513          	addi	a0,a0,478 # 13c0 <malloc+0x126>
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     288:	016080e7          	jalr	22(ra) # 129a <malloc>
     28c:	84aa                	mv	s1,a0
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     2d2:	fcc080e7          	jalr	-52(ra) # 129a <malloc>
     2d6:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     32c:	f72080e7          	jalr	-142(ra) # 129a <malloc>
     330:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     332:	4661                	li	a2,24
     334:	4581                	li	a1,0
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     372:	f2c080e7          	jalr	-212(ra) # 129a <malloc>
     376:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     378:	4661                	li	a2,24
     37a:	4581                	li	a1,0
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3b4:	eea080e7          	jalr	-278(ra) # 129a <malloc>
     3b8:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     3ba:	4641                	li	a2,16
     3bc:	4581                	li	a1,0
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     3fe:	14698993          	addi	s3,s3,326 # 1540 <whitespace>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     464:	0e098993          	addi	s3,s3,224 # 1540 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4d0:	07498993          	addi	s3,s3,116 # 1540 <whitespace>
     4d4:	00001a97          	auipc	s5,0x1
     4d8:	064a8a93          	addi	s5,s5,100 # 1538 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     53c:	00898993          	addi	s3,s3,8 # 1540 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5ae:	e3eb8b93          	addi	s7,s7,-450 # 13e8 <malloc+0x14e>
  ...
  while(peek(ps, es, "<>")){
     ...
     5c0:	e0c50513          	addi	a0,a0,-500 # 13c8 <malloc+0x12e>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a8:	d4c60613          	addi	a2,a2,-692 # 13f0 <malloc+0x156>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d8:	d3cb0b13          	addi	s6,s6,-708 # 1410 <malloc+0x176>
  ...
  return ret;
     ...
     712:	cea50513          	addi	a0,a0,-790 # 13f8 <malloc+0x15e>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     774:	c9050513          	addi	a0,a0,-880 # 1400 <malloc+0x166>
...
000000000000078e <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7ae:	c6e60613          	addi	a2,a2,-914 # 1418 <malloc+0x17e>
     7b2:	85ce                	mv	a1,s3
     7b4:	854a                	mv	a0,s2
...
00000000000007fc <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     81e:	c06a0a13          	addi	s4,s4,-1018 # 1420 <malloc+0x186>
  ...
  if(peek(ps, es, ";")){
     ...
     854:	bd860613          	addi	a2,a2,-1064 # 1428 <malloc+0x18e>
     858:	85ce                	mv	a1,s3
     85a:	854a                	mv	a0,s2
...
00000000000008a4 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8ba:	b3a60613          	addi	a2,a2,-1222 # 13f0 <malloc+0x156>
  ...
  if(!peek(ps, es, ")"))
     ...
     8ea:	b5a60613          	addi	a2,a2,-1190 # 1440 <malloc+0x1a6>
     8ee:	85ca                	mv	a1,s2
     8f0:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     92c:	b0850513          	addi	a0,a0,-1272 # 1430 <malloc+0x196>
     930:	fffff097          	auipc	ra,0xfffff
     934:	724080e7          	jalr	1828(ra) # 54 <panic>
    panic("syntax - missing )");
     938:	00001517          	auipc	a0,0x1
     93c:	b1050513          	addi	a0,a0,-1264 # 1448 <malloc+0x1ae>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     968:	b4470713          	addi	a4,a4,-1212 # 14a8 <malloc+0x20e>
...
00000000000009e0 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a14:	a5060613          	addi	a2,a2,-1456 # 1460 <malloc+0x1c6>
     a18:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a4a:	a2258593          	addi	a1,a1,-1502 # 1468 <malloc+0x1ce>
     a4e:	4509                	li	a0,2
     a50:	00000097          	auipc	ra,0x0
     a54:	764080e7          	jalr	1892(ra) # 11b4 <fprintf>
    panic("syntax");
     a58:	00001517          	auipc	a0,0x1
     a5c:	9a050513          	addi	a0,a0,-1632 # 13f8 <malloc+0x15e>
...
0000000000000a68 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a7e:	9fe48493          	addi	s1,s1,-1538 # 1478 <malloc+0x1de>
     a82:	4589                	li	a1,2
     a84:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     aa4:	ab048493          	addi	s1,s1,-1360 # 1550 <buf.0>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa8:	06300913          	li	s2,99
     aac:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     ab0:	00001a17          	auipc	s4,0x1
     ab4:	aa3a0a13          	addi	s4,s4,-1373 # 1553 <buf.0+0x3>
        fprintf(2, "cannot cd %s\n", buf+3);
     ab8:	00001a97          	auipc	s5,0x1
     abc:	9c8a8a93          	addi	s5,s5,-1592 # 1480 <malloc+0x1e6>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b34:	684080e7          	jalr	1668(ra) # 11b4 <fprintf>
     b38:	bf79                	j	ad6 <main+0x6e>
      runcmd(parsecmd(buf));
     b3a:	00001517          	auipc	a0,0x1
     b3e:	a1650513          	addi	a0,a0,-1514 # 1550 <buf.0>
...
0000000000000eb0 <barrier_alloc>:
...
0000000000000eb8 <barrier>:
.global barrier
barrier:
 li a7, SYS_barrier
     eb8:	02000893          	li	a7,32
 ecall
     ebc:	00000073          	ecall
 ret
     ec0:	8082                	ret

0000000000000ec2 <barrier_free>:
.global barrier_free
barrier_free:
 li a7, SYS_barrier_free
     ec2:	02100893          	li	a7,33
 ecall
     ec6:	00000073          	ecall
 ret
     eca:	8082                	ret

0000000000000ecc <buffer_cond_init>:
.global buffer_cond_init
buffer_cond_init:
 li a7, SYS_buffer_cond_init
     ecc:	02200893          	li	a7,34
 ecall
     ed0:	00000073          	ecall
 ret
     ed4:	8082                	ret

0000000000000ed6 <cond_produce>:
.global cond_produce
cond_produce:
 li a7, SYS_cond_produce
     ed6:	02300893          	li	a7,35
 ecall
     eda:	00000073          	ecall
 ret
     ede:	8082                	ret

0000000000000ee0 <cond_consume>:
.global cond_consume
cond_consume:
 li a7, SYS_cond_consume
     ee0:	02400893          	li	a7,36
 ecall
     ee4:	00000073          	ecall
 ret
     ee8:	8082                	ret

0000000000000eea <buffer_sem_init>:
.global buffer_sem_init
buffer_sem_init:
 li a7, SYS_buffer_sem_init
     eea:	02500893          	li	a7,37
 ecall
     eee:	00000073          	ecall
 ret
     ef2:	8082                	ret

0000000000000ef4 <sem_produce>:
.global sem_produce
sem_produce:
 li a7, SYS_sem_produce
     ef4:	02600893          	li	a7,38
 ecall
     ef8:	00000073          	ecall
 ret
     efc:	8082                	ret

0000000000000efe <sem_consume>:
.global sem_consume
sem_consume:
 li a7, SYS_sem_consume
     efe:	02700893          	li	a7,39
 ecall
     f02:	00000073          	ecall
 ret
     f06:	8082                	ret
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     f1e:	ece080e7          	jalr	-306(ra) # de8 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
     ...
     f3c:	0805c963          	bltz	a1,fce <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f50:	5d450513          	addi	a0,a0,1492 # 1520 <digits>
     f54:	883a                	mv	a6,a4
     ...
     f74:	fec7f0e3          	bgeu	a5,a2,f54 <printint+0x2a>
  if(neg)
     f78:	00088c63          	beqz	a7,f90 <printint+0x66>
    buf[i++] = '-';
  ...
  while(--i >= 0)
     f90:	02e05863          	blez	a4,fc0 <printint+0x96>
  ...
  while(--i >= 0)
     ...
     fc4:	74a2                	ld	s1,40(sp)
     fc6:	7902                	ld	s2,32(sp)
     fc8:	69e2                	ld	s3,24(sp)
...
{
     fd6:	7119                	addi	sp,sp,-128
     fd8:	fc86                	sd	ra,120(sp)
     fda:	f8a2                	sd	s0,112(sp)
     fdc:	f4a6                	sd	s1,104(sp)
     fde:	f0ca                	sd	s2,96(sp)
     fe0:	ecce                	sd	s3,88(sp)
     fe2:	e8d2                	sd	s4,80(sp)
     fe4:	e4d6                	sd	s5,72(sp)
     fe6:	e0da                	sd	s6,64(sp)
     fe8:	fc5e                	sd	s7,56(sp)
     fea:	f862                	sd	s8,48(sp)
     fec:	f466                	sd	s9,40(sp)
     fee:	f06a                	sd	s10,32(sp)
     ff0:	ec6e                	sd	s11,24(sp)
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
     ff4:	0005c903          	lbu	s2,0(a1)
     ff8:	18090f63          	beqz	s2,1196 <vprintf+0x1c0>
     ffc:	8aaa                	mv	s5,a0
     ffe:	8b32                	mv	s6,a2
  ...
  state = 0;
    ...
    100a:	4c55                	li	s8,21
    100c:	00000c97          	auipc	s9,0x0
    1010:	4bcc8c93          	addi	s9,s9,1212 # 14c8 <malloc+0x22e>
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
    1014:	02800d93          	li	s11,40
  putc(fd, 'x');
    1018:	4d41                	li	s10,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    101a:	00000b97          	auipc	s7,0x0
    101e:	506b8b93          	addi	s7,s7,1286 # 1520 <digits>
    1022:	a839                	j	1040 <vprintf+0x6a>
        putc(fd, c);
    1024:	85ca                	mv	a1,s2
    1026:	8556                	mv	a0,s5
    1028:	00000097          	auipc	ra,0x0
    102c:	ee0080e7          	jalr	-288(ra) # f08 <putc>
    1030:	a019                	j	1036 <vprintf+0x60>
    } else if(state == '%'){
    1032:	01498d63          	beq	s3,s4,104c <vprintf+0x76>
  for(i = 0; fmt[i]; i++){
    1036:	0485                	addi	s1,s1,1
    1038:	fff4c903          	lbu	s2,-1(s1)
    103c:	14090d63          	beqz	s2,1196 <vprintf+0x1c0>
    if(state == 0){
    1040:	fe0999e3          	bnez	s3,1032 <vprintf+0x5c>
      if(c == '%'){
    1044:	ff4910e3          	bne	s2,s4,1024 <vprintf+0x4e>
        state = '%';
    1048:	89d2                	mv	s3,s4
    104a:	b7f5                	j	1036 <vprintf+0x60>
      if(c == 'd'){
    104c:	11490c63          	beq	s2,s4,1164 <vprintf+0x18e>
    1050:	f9d9079b          	addiw	a5,s2,-99
    1054:	0ff7f793          	zext.b	a5,a5
    1058:	10fc6e63          	bltu	s8,a5,1174 <vprintf+0x19e>
    105c:	f9d9079b          	addiw	a5,s2,-99
    1060:	0ff7f713          	zext.b	a4,a5
    1064:	10ec6863          	bltu	s8,a4,1174 <vprintf+0x19e>
    1068:	00271793          	slli	a5,a4,0x2
    106c:	97e6                	add	a5,a5,s9
    106e:	439c                	lw	a5,0(a5)
    1070:	97e6                	add	a5,a5,s9
    1072:	8782                	jr	a5
    ...
    1086:	ea8080e7          	jalr	-344(ra) # f2a <printint>
    108a:	8b4a                	mv	s6,s2
      } else {
    ...
    10a2:	e8c080e7          	jalr	-372(ra) # f2a <printint>
    10a6:	8b4a                	mv	s6,s2
      state = 0;
    10a8:	4981                	li	s3,0
    10aa:	b771                	j	1036 <vprintf+0x60>
    ...
    10be:	e70080e7          	jalr	-400(ra) # f2a <printint>
    10c2:	8b4a                	mv	s6,s2
      state = 0;
    10c4:	4981                	li	s3,0
    10c6:	bf85                	j	1036 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
  ...
  putc(fd, '0');
    ...
    10de:	e2e080e7          	jalr	-466(ra) # f08 <putc>
  putc(fd, 'x');
    10e2:	07800593          	li	a1,120
    10e6:	8556                	mv	a0,s5
    10e8:	00000097          	auipc	ra,0x0
    10ec:	e20080e7          	jalr	-480(ra) # f08 <putc>
    10f0:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    ...
    1102:	e0a080e7          	jalr	-502(ra) # f08 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    1106:	0992                	slli	s3,s3,0x4
    1108:	397d                	addiw	s2,s2,-1
    110a:	fe0914e3          	bnez	s2,10f2 <vprintf+0x11c>
        printptr(fd, va_arg(ap, uint64));
    110e:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    1112:	4981                	li	s3,0
    1114:	b70d                	j	1036 <vprintf+0x60>
        s = va_arg(ap, char*);
    1116:	008b0913          	addi	s2,s6,8
    111a:	000b3983          	ld	s3,0(s6)
        if(s == 0)
    111e:	02098163          	beqz	s3,1140 <vprintf+0x16a>
        while(*s != 0){
    1122:	0009c583          	lbu	a1,0(s3)
    1126:	c5ad                	beqz	a1,1190 <vprintf+0x1ba>
          putc(fd, *s);
    1128:	8556                	mv	a0,s5
    112a:	00000097          	auipc	ra,0x0
    112e:	dde080e7          	jalr	-546(ra) # f08 <putc>
          s++;
    1132:	0985                	addi	s3,s3,1
        while(*s != 0){
    1134:	0009c583          	lbu	a1,0(s3)
    1138:	f9e5                	bnez	a1,1128 <vprintf+0x152>
        s = va_arg(ap, char*);
    113a:	8b4a                	mv	s6,s2
      state = 0;
    113c:	4981                	li	s3,0
    113e:	bde5                	j	1036 <vprintf+0x60>
          s = "(null)";
    1140:	00000997          	auipc	s3,0x0
    1144:	38098993          	addi	s3,s3,896 # 14c0 <malloc+0x226>
        while(*s != 0){
    1148:	85ee                	mv	a1,s11
    114a:	bff9                	j	1128 <vprintf+0x152>
        putc(fd, va_arg(ap, uint));
    114c:	008b0913          	addi	s2,s6,8
    1150:	000b4583          	lbu	a1,0(s6)
    1154:	8556                	mv	a0,s5
    1156:	00000097          	auipc	ra,0x0
    115a:	db2080e7          	jalr	-590(ra) # f08 <putc>
    115e:	8b4a                	mv	s6,s2
      state = 0;
    1160:	4981                	li	s3,0
    1162:	bdd1                	j	1036 <vprintf+0x60>
        putc(fd, c);
    1164:	85d2                	mv	a1,s4
    1166:	8556                	mv	a0,s5
    ...
    116c:	da0080e7          	jalr	-608(ra) # f08 <putc>
      state = 0;
    1170:	4981                	li	s3,0
    1172:	b5d1                	j	1036 <vprintf+0x60>
        putc(fd, '%');
    1174:	85d2                	mv	a1,s4
    1176:	8556                	mv	a0,s5
    1178:	00000097          	auipc	ra,0x0
    117c:	d90080e7          	jalr	-624(ra) # f08 <putc>
        putc(fd, c);
    1180:	85ca                	mv	a1,s2
    1182:	8556                	mv	a0,s5
    1184:	00000097          	auipc	ra,0x0
    1188:	d84080e7          	jalr	-636(ra) # f08 <putc>
      state = 0;
    118c:	4981                	li	s3,0
    118e:	b565                	j	1036 <vprintf+0x60>
        s = va_arg(ap, char*);
    1190:	8b4a                	mv	s6,s2
      state = 0;
    1192:	4981                	li	s3,0
    1194:	b54d                	j	1036 <vprintf+0x60>
    }
  }
}
    1196:	70e6                	ld	ra,120(sp)
    1198:	7446                	ld	s0,112(sp)
    119a:	74a6                	ld	s1,104(sp)
    119c:	7906                	ld	s2,96(sp)
    119e:	69e6                	ld	s3,88(sp)
    11a0:	6a46                	ld	s4,80(sp)
    11a2:	6aa6                	ld	s5,72(sp)
    11a4:	6b06                	ld	s6,64(sp)
    11a6:	7be2                	ld	s7,56(sp)
    11a8:	7c42                	ld	s8,48(sp)
    11aa:	7ca2                	ld	s9,40(sp)
    11ac:	7d02                	ld	s10,32(sp)
    11ae:	6de2                	ld	s11,24(sp)
    11b0:	6109                	addi	sp,sp,128
    11b2:	8082                	ret

00000000000011b4 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    11b4:	715d                	addi	sp,sp,-80
    11b6:	ec06                	sd	ra,24(sp)
    11b8:	e822                	sd	s0,16(sp)
    11ba:	1000                	addi	s0,sp,32
    11bc:	e010                	sd	a2,0(s0)
    11be:	e414                	sd	a3,8(s0)
    11c0:	e818                	sd	a4,16(s0)
    11c2:	ec1c                	sd	a5,24(s0)
    11c4:	03043023          	sd	a6,32(s0)
    11c8:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    11cc:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    11d0:	8622                	mv	a2,s0
    11d2:	00000097          	auipc	ra,0x0
    11d6:	e04080e7          	jalr	-508(ra) # fd6 <vprintf>
}
    11da:	60e2                	ld	ra,24(sp)
    11dc:	6442                	ld	s0,16(sp)
    11de:	6161                	addi	sp,sp,80
    11e0:	8082                	ret
...
{
    11e2:	711d                	addi	sp,sp,-96
    11e4:	ec06                	sd	ra,24(sp)
    11e6:	e822                	sd	s0,16(sp)
    11e8:	1000                	addi	s0,sp,32
    11ea:	e40c                	sd	a1,8(s0)
    11ec:	e810                	sd	a2,16(s0)
    11ee:	ec14                	sd	a3,24(s0)
    11f0:	f018                	sd	a4,32(s0)
    11f2:	f41c                	sd	a5,40(s0)
    11f4:	03043823          	sd	a6,48(s0)
    11f8:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    11fc:	00840613          	addi	a2,s0,8
    1200:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    1204:	85aa                	mv	a1,a0
    1206:	4505                	li	a0,1
    1208:	00000097          	auipc	ra,0x0
    120c:	dce080e7          	jalr	-562(ra) # fd6 <vprintf>
}
    1210:	60e2                	ld	ra,24(sp)
    1212:	6442                	ld	s0,16(sp)
    1214:	6125                	addi	sp,sp,96
    1216:	8082                	ret

0000000000001218 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
  ...
  bp = (Header*)ap - 1;
    121e:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1222:	00000797          	auipc	a5,0x0
    1226:	3267b783          	ld	a5,806(a5) # 1548 <freep>
    122a:	a02d                	j	1254 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    122c:	4618                	lw	a4,8(a2)
    122e:	9f2d                	addw	a4,a4,a1
    1230:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    1234:	6398                	ld	a4,0(a5)
    1236:	6310                	ld	a2,0(a4)
    1238:	a83d                	j	1276 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    123a:	ff852703          	lw	a4,-8(a0)
    123e:	9f31                	addw	a4,a4,a2
    1240:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    1242:	ff053683          	ld	a3,-16(a0)
    1246:	a091                	j	128a <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1248:	6398                	ld	a4,0(a5)
    124a:	00e7e463          	bltu	a5,a4,1252 <free+0x3a>
    124e:	00e6ea63          	bltu	a3,a4,1262 <free+0x4a>
{
    1252:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1254:	fed7fae3          	bgeu	a5,a3,1248 <free+0x30>
    1258:	6398                	ld	a4,0(a5)
    125a:	00e6e463          	bltu	a3,a4,1262 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    125e:	fee7eae3          	bltu	a5,a4,1252 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    1262:	ff852583          	lw	a1,-8(a0)
    1266:	6390                	ld	a2,0(a5)
    1268:	02059813          	slli	a6,a1,0x20
    126c:	01c85713          	srli	a4,a6,0x1c
    1270:	9736                	add	a4,a4,a3
    1272:	fae60de3          	beq	a2,a4,122c <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    1276:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    127a:	4790                	lw	a2,8(a5)
    127c:	02061593          	slli	a1,a2,0x20
    1280:	01c5d713          	srli	a4,a1,0x1c
    1284:	973e                	add	a4,a4,a5
    1286:	fae68ae3          	beq	a3,a4,123a <free+0x22>
    p->s.ptr = bp->s.ptr;
    128a:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    128c:	00000717          	auipc	a4,0x0
    1290:	2af73e23          	sd	a5,700(a4) # 1548 <freep>
}
    1294:	6422                	ld	s0,8(sp)
    1296:	0141                	addi	sp,sp,16
    1298:	8082                	ret

000000000000129a <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    129a:	7139                	addi	sp,sp,-64
    129c:	fc06                	sd	ra,56(sp)
    129e:	f822                	sd	s0,48(sp)
    12a0:	f426                	sd	s1,40(sp)
    12a2:	f04a                	sd	s2,32(sp)
    12a4:	ec4e                	sd	s3,24(sp)
    12a6:	e852                	sd	s4,16(sp)
    12a8:	e456                	sd	s5,8(sp)
    12aa:	e05a                	sd	s6,0(sp)
    12ac:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    12ae:	02051493          	slli	s1,a0,0x20
    12b2:	9081                	srli	s1,s1,0x20
    12b4:	04bd                	addi	s1,s1,15
    12b6:	8091                	srli	s1,s1,0x4
    12b8:	0014899b          	addiw	s3,s1,1
    12bc:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    12be:	00000517          	auipc	a0,0x0
    12c2:	28a53503          	ld	a0,650(a0) # 1548 <freep>
    12c6:	c515                	beqz	a0,12f2 <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    12cc:	02977f63          	bgeu	a4,s1,130a <malloc+0x70>
    12d0:	8a4e                	mv	s4,s3
    12d2:	0009871b          	sext.w	a4,s3
    12d6:	6685                	lui	a3,0x1
    12d8:	00d77363          	bgeu	a4,a3,12de <malloc+0x44>
    12dc:	6a05                	lui	s4,0x1
    12de:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    12e2:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    12e6:	00000917          	auipc	s2,0x0
    12ea:	26290913          	addi	s2,s2,610 # 1548 <freep>
  if(p == (char*)-1)
    12ee:	5afd                	li	s5,-1
    12f0:	a895                	j	1364 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    12f2:	00000797          	auipc	a5,0x0
    12f6:	2c678793          	addi	a5,a5,710 # 15b8 <base>
    12fa:	00000717          	auipc	a4,0x0
    12fe:	24f73723          	sd	a5,590(a4) # 1548 <freep>
    1302:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    1304:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    1308:	b7e1                	j	12d0 <malloc+0x36>
      if(p->s.size == nunits)
    130a:	02e48c63          	beq	s1,a4,1342 <malloc+0xa8>
        p->s.size -= nunits;
    130e:	4137073b          	subw	a4,a4,s3
    1312:	c798                	sw	a4,8(a5)
        p += p->s.size;
    1314:	02071693          	slli	a3,a4,0x20
    1318:	01c6d713          	srli	a4,a3,0x1c
    131c:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    131e:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    1322:	00000717          	auipc	a4,0x0
    1326:	22a73323          	sd	a0,550(a4) # 1548 <freep>
      return (void*)(p + 1);
    ...
    1346:	bff1                	j	1322 <malloc+0x88>
  hp->s.size = nu;
    1348:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    134c:	0541                	addi	a0,a0,16
    134e:	00000097          	auipc	ra,0x0
    1352:	eca080e7          	jalr	-310(ra) # 1218 <free>
  return freep;
    1356:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    135a:	d971                	beqz	a0,132e <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    135c:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    135e:	4798                	lw	a4,8(a5)
    1360:	fa9775e3          	bgeu	a4,s1,130a <malloc+0x70>
    if(p == freep)
    1364:	00093703          	ld	a4,0(s2)
    1368:	853e                	mv	a0,a5
    136a:	fef719e3          	bne	a4,a5,135c <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    136e:	8552                	mv	a0,s4
    1370:	00000097          	auipc	ra,0x0
    1374:	ae0080e7          	jalr	-1312(ra) # e50 <sbrk>
  if(p == (char*)-1)
    1378:	fd5518e3          	bne	a0,s5,1348 <malloc+0xae>
        return 0;
    137c:	4501                	li	a0,0
    137e:	bf45                	j	132e <malloc+0x94>
