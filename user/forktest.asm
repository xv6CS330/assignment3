...
forktest(void)
{
  ...
  3e:	49650513          	addi	a0,a0,1174 # 4d0 <sem_consume+0x10>
  ...
  68:	47c50513          	addi	a0,a0,1148 # 4e0 <sem_consume+0x20>
  ...
  b8:	47c50513          	addi	a0,a0,1148 # 530 <sem_consume+0x70>
  ...
  d4:	43050513          	addi	a0,a0,1072 # 500 <sem_consume+0x40>
  ...
  ee:	42e50513          	addi	a0,a0,1070 # 518 <sem_consume+0x58>
