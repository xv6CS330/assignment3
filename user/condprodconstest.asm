...
int produce (int index, int tid)
{
   ...
   a:	bc27a783          	lw	a5,-1086(a5) # bc8 <num_items>
...
main(int argc, char *argv[])
{
  ...
  84:	b4a7a023          	sw	a0,-1216(a5) # bc0 <num_cons>
  buffer_cond_init();
  88:	00000097          	auipc	ra,0x0
  8c:	556080e7          	jalr	1366(ra) # 5de <buffer_cond_init>
  ...
  9e:	a8650513          	addi	a0,a0,-1402 # b20 <malloc+0x174>
  ...
  b8:	b1098993          	addi	s3,s3,-1264 # bc4 <num_prods>
     if (fork() == 0) {
  ...
  d8:	aec72703          	lw	a4,-1300(a4) # bc0 <num_cons>
  dc:	4785                	li	a5,1
  de:	02e7d463          	bge	a5,a4,106 <main+0xec>
  e2:	4901                	li	s2,0
  e4:	00001997          	auipc	s3,0x1
  e8:	adc98993          	addi	s3,s3,-1316 # bc0 <num_cons>
     if (fork() == 0) {
 ...
 10a:	ac272703          	lw	a4,-1342(a4) # bc8 <num_items>
 10e:	00001797          	auipc	a5,0x1
 112:	ab67a783          	lw	a5,-1354(a5) # bc4 <num_prods>
 116:	02e787bb          	mulw	a5,a5,a4
 11a:	00001717          	auipc	a4,0x1
 11e:	aa672703          	lw	a4,-1370(a4) # bc0 <num_cons>
 122:	02e7c7bb          	divw	a5,a5,a4
 126:	04f05063          	blez	a5,166 <main+0x14c>
 12a:	4481                	li	s1,0
 12c:	00001a17          	auipc	s4,0x1
 130:	a9ca0a13          	addi	s4,s4,-1380 # bc8 <num_items>
 134:	00001997          	auipc	s3,0x1
 138:	a9098993          	addi	s3,s3,-1392 # bc4 <num_prods>
 13c:	00001917          	auipc	s2,0x1
 140:	a8490913          	addi	s2,s2,-1404 # bc0 <num_cons>
 144:	00000097          	auipc	ra,0x0
 148:	4ae080e7          	jalr	1198(ra) # 5f2 <cond_consume>
 ...
 16a:	a5e72703          	lw	a4,-1442(a4) # bc4 <num_prods>
 16e:	00001797          	auipc	a5,0x1
 172:	a527a783          	lw	a5,-1454(a5) # bc0 <num_cons>
 176:	9fb9                	addw	a5,a5,a4
 178:	4705                	li	a4,1
 17a:	02f75963          	bge	a4,a5,1ac <main+0x192>
 17e:	4481                	li	s1,0
 180:	00001997          	auipc	s3,0x1
 184:	a4498993          	addi	s3,s3,-1468 # bc4 <num_prods>
 188:	00001917          	auipc	s2,0x1
 18c:	a3890913          	addi	s2,s2,-1480 # bc0 <num_cons>
 190:	4501                	li	a0,0
 ...
 1ba:	98250513          	addi	a0,a0,-1662 # b38 <malloc+0x18c>
 ...
 1d4:	9f852503          	lw	a0,-1544(a0) # bc8 <num_items>
 1d8:	02a05263          	blez	a0,1fc <main+0x1e2>
 1dc:	00001997          	auipc	s3,0x1
 1e0:	9ec98993          	addi	s3,s3,-1556 # bc8 <num_items>
   return index+(num_items*tid);
 1e4:	0325053b          	mulw	a0,a0,s2
	for (j=0; j<num_items; j++) cond_produce(produce(j, i));
 1e8:	9d25                	addw	a0,a0,s1
 1ea:	00000097          	auipc	ra,0x0
 1ee:	3fe080e7          	jalr	1022(ra) # 5e8 <cond_produce>
 ...
 20a:	9c272703          	lw	a4,-1598(a4) # bc8 <num_items>
 20e:	00001797          	auipc	a5,0x1
 212:	9b67a783          	lw	a5,-1610(a5) # bc4 <num_prods>
 216:	02e787bb          	mulw	a5,a5,a4
 21a:	00001717          	auipc	a4,0x1
 21e:	9a672703          	lw	a4,-1626(a4) # bc0 <num_cons>
 222:	02e7c7bb          	divw	a5,a5,a4
 226:	02f05f63          	blez	a5,264 <main+0x24a>
 22a:	00001a17          	auipc	s4,0x1
 22e:	99ea0a13          	addi	s4,s4,-1634 # bc8 <num_items>
 232:	00001997          	auipc	s3,0x1
 236:	99298993          	addi	s3,s3,-1646 # bc4 <num_prods>
 23a:	00001917          	auipc	s2,0x1
 23e:	98690913          	addi	s2,s2,-1658 # bc0 <num_cons>
 242:	00000097          	auipc	ra,0x0
 246:	3b0080e7          	jalr	944(ra) # 5f2 <cond_consume>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 662:	54a50513          	addi	a0,a0,1354 # ba8 <digits>
 666:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 722:	432c8c93          	addi	s9,s9,1074 # b50 <malloc+0x1a4>
 ...
 730:	47cb8b93          	addi	s7,s7,1148 # ba8 <digits>
 ...
 856:	2f698993          	addi	s3,s3,758 # b48 <malloc+0x19c>
        while(*s != 0){
 85a:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 938:	29c7b783          	ld	a5,668(a5) # bd0 <freep>
 ...
 960:	00e6ea63          	bltu	a3,a4,974 <free+0x4a>
{
 ...
 9a2:	22f73923          	sd	a5,562(a4) # bd0 <freep>
}
 9a6:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 9d4:	20053503          	ld	a0,512(a0) # bd0 <freep>
 ...
 9fc:	1d890913          	addi	s2,s2,472 # bd0 <freep>
  if(p == (char*)-1)
 a00:	5afd                	li	s5,-1
 a02:	a895                	j	a76 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 a04:	00000797          	auipc	a5,0x0
 a08:	1d478793          	addi	a5,a5,468 # bd8 <base>
 a0c:	00000717          	auipc	a4,0x0
 a10:	1cf73223          	sd	a5,452(a4) # bd0 <freep>
 a14:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 a38:	18a73e23          	sd	a0,412(a4) # bd0 <freep>
      return (void*)(p + 1);
