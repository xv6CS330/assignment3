...
00000000000003be <barrier_alloc>:
...
putc(int fd, char c)
{
 ...
 3f0:	f0a080e7          	jalr	-246(ra) # 2f6 <write>
}
...
malloc(uint nbytes)
{
 ...
 7fa:	0aa73923          	sd	a0,178(a4) # 8a8 <freep>
      return (void*)(p + 1);
 ...
 848:	b1a080e7          	jalr	-1254(ra) # 35e <sbrk>
  if(p == (char*)-1)
