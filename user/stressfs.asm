...
main(int argc, char *argv[])
{
  ...
  1a:	94a78793          	addi	a5,a5,-1718 # 960 <malloc+0x116>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	90450513          	addi	a0,a0,-1788 # 930 <malloc+0xe6>
  34:	00000097          	auipc	ra,0x0
  38:	75e080e7          	jalr	1886(ra) # 792 <printf>
  ...
  6c:	8e050513          	addi	a0,a0,-1824 # 948 <malloc+0xfe>
  70:	00000097          	auipc	ra,0x0
  74:	722080e7          	jalr	1826(ra) # 792 <printf>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	8a250513          	addi	a0,a0,-1886 # 958 <malloc+0x10e>
  be:	00000097          	auipc	ra,0x0
  c2:	6d4080e7          	jalr	1748(ra) # 792 <printf>
...
0000000000000460 <barrier_alloc>:
...
0000000000000486 <cond_produce>:
.global cond_produce
cond_produce:
 li a7, SYS_cond_produce
 486:	02300893          	li	a7,35
 ecall
 48a:	00000073          	ecall
 ret
 48e:	8082                	ret

0000000000000490 <cond_consume>:
.global cond_consume
cond_consume:
...
00000000000004a4 <sem_produce>:
.global sem_produce
sem_produce:
 li a7, SYS_sem_produce
 4a4:	02600893          	li	a7,38
 ecall
 4a8:	00000073          	ecall
 ret
 4ac:	8082                	ret

00000000000004ae <sem_consume>:
.global sem_consume
sem_consume:
...
putc(int fd, char c)
{
 ...
 4ce:	ece080e7          	jalr	-306(ra) # 398 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 500:	4d450513          	addi	a0,a0,1236 # 9d0 <digits>
 504:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5ba:	4c55                	li	s8,21
 5bc:	00000c97          	auipc	s9,0x0
 5c0:	3bcc8c93          	addi	s9,s9,956 # 978 <malloc+0x12e>
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
 5c4:	02800d93          	li	s11,40
  putc(fd, 'x');
 5c8:	4d41                	li	s10,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 5ca:	00000b97          	auipc	s7,0x0
 5ce:	406b8b93          	addi	s7,s7,1030 # 9d0 <digits>
 ...
 5e2:	01498d63          	beq	s3,s4,5fc <vprintf+0x76>
  for(i = 0; fmt[i]; i++){
 5e6:	0485                	addi	s1,s1,1
 5e8:	fff4c903          	lbu	s2,-1(s1)
 5ec:	14090d63          	beqz	s2,746 <vprintf+0x1c0>
    if(state == 0){
 5f0:	fe0999e3          	bnez	s3,5e2 <vprintf+0x5c>
      if(c == '%'){
 5f4:	ff4910e3          	bne	s2,s4,5d4 <vprintf+0x4e>
        state = '%';
 5f8:	89d2                	mv	s3,s4
 5fa:	b7f5                	j	5e6 <vprintf+0x60>
      if(c == 'd'){
 5fc:	11490c63          	beq	s2,s4,714 <vprintf+0x18e>
 600:	f9d9079b          	addiw	a5,s2,-99
 604:	0ff7f793          	zext.b	a5,a5
 608:	10fc6e63          	bltu	s8,a5,724 <vprintf+0x19e>
 60c:	f9d9079b          	addiw	a5,s2,-99
 610:	0ff7f713          	zext.b	a4,a5
 614:	10ec6863          	bltu	s8,a4,724 <vprintf+0x19e>
 ...
 636:	ea8080e7          	jalr	-344(ra) # 4da <printint>
 63a:	8b4a                	mv	s6,s2
      } else {
 ...
 68e:	e2e080e7          	jalr	-466(ra) # 4b8 <putc>
  putc(fd, 'x');
 692:	07800593          	li	a1,120
 696:	8556                	mv	a0,s5
 698:	00000097          	auipc	ra,0x0
 69c:	e20080e7          	jalr	-480(ra) # 4b8 <putc>
 6a0:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 ...
 6b2:	e0a080e7          	jalr	-502(ra) # 4b8 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 6b6:	0992                	slli	s3,s3,0x4
 6b8:	397d                	addiw	s2,s2,-1
 6ba:	fe0914e3          	bnez	s2,6a2 <vprintf+0x11c>
        printptr(fd, va_arg(ap, uint64));
 6be:	f8843b03          	ld	s6,-120(s0)
      state = 0;
 6c2:	4981                	li	s3,0
 6c4:	b70d                	j	5e6 <vprintf+0x60>
        s = va_arg(ap, char*);
 6c6:	008b0913          	addi	s2,s6,8
 6ca:	000b3983          	ld	s3,0(s6)
        if(s == 0)
 6ce:	02098163          	beqz	s3,6f0 <vprintf+0x16a>
        while(*s != 0){
 6d2:	0009c583          	lbu	a1,0(s3)
 6d6:	c5ad                	beqz	a1,740 <vprintf+0x1ba>
          putc(fd, *s);
 6d8:	8556                	mv	a0,s5
 6da:	00000097          	auipc	ra,0x0
 6de:	dde080e7          	jalr	-546(ra) # 4b8 <putc>
          s++;
 6e2:	0985                	addi	s3,s3,1
        while(*s != 0){
 6e4:	0009c583          	lbu	a1,0(s3)
 6e8:	f9e5                	bnez	a1,6d8 <vprintf+0x152>
        s = va_arg(ap, char*);
 6ea:	8b4a                	mv	s6,s2
      state = 0;
 6ec:	4981                	li	s3,0
 6ee:	bde5                	j	5e6 <vprintf+0x60>
          s = "(null)";
 6f0:	00000997          	auipc	s3,0x0
 6f4:	28098993          	addi	s3,s3,640 # 970 <malloc+0x126>
        while(*s != 0){
 6f8:	85ee                	mv	a1,s11
 6fa:	bff9                	j	6d8 <vprintf+0x152>
        putc(fd, va_arg(ap, uint));
 6fc:	008b0913          	addi	s2,s6,8
 700:	000b4583          	lbu	a1,0(s6)
 704:	8556                	mv	a0,s5
 706:	00000097          	auipc	ra,0x0
 70a:	db2080e7          	jalr	-590(ra) # 4b8 <putc>
 70e:	8b4a                	mv	s6,s2
      state = 0;
 710:	4981                	li	s3,0
 712:	bdd1                	j	5e6 <vprintf+0x60>
        putc(fd, c);
 714:	85d2                	mv	a1,s4
 716:	8556                	mv	a0,s5
 718:	00000097          	auipc	ra,0x0
 71c:	da0080e7          	jalr	-608(ra) # 4b8 <putc>
      state = 0;
 720:	4981                	li	s3,0
 722:	b5d1                	j	5e6 <vprintf+0x60>
        putc(fd, '%');
 724:	85d2                	mv	a1,s4
 726:	8556                	mv	a0,s5
 ...
 738:	d84080e7          	jalr	-636(ra) # 4b8 <putc>
      state = 0;
 73c:	4981                	li	s3,0
...
free(void *ap)
{
 ...
 7d6:	2167b783          	ld	a5,534(a5) # 9e8 <freep>
 ...
 7fe:	00e6ea63          	bltu	a3,a4,812 <free+0x4a>
{
 ...
 840:	1af73623          	sd	a5,428(a4) # 9e8 <freep>
}
 844:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 872:	17a53503          	ld	a0,378(a0) # 9e8 <freep>
 ...
 89a:	15290913          	addi	s2,s2,338 # 9e8 <freep>
  if(p == (char*)-1)
 89e:	5afd                	li	s5,-1
 8a0:	a895                	j	914 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 8a2:	00000797          	auipc	a5,0x0
 8a6:	14e78793          	addi	a5,a5,334 # 9f0 <base>
 8aa:	00000717          	auipc	a4,0x0
 8ae:	12f73f23          	sd	a5,318(a4) # 9e8 <freep>
 8b2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 8d6:	10a73b23          	sd	a0,278(a4) # 9e8 <freep>
      return (void*)(p + 1);
 ...
 902:	eca080e7          	jalr	-310(ra) # 7c8 <free>
  return freep;
 ...
 924:	ae0080e7          	jalr	-1312(ra) # 400 <sbrk>
  if(p == (char*)-1)
