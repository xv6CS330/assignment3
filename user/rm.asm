...
00000000000003d6 <barrier_alloc>:
...
putc(int fd, char c)
{
 ...
 408:	f0a080e7          	jalr	-246(ra) # 30e <write>
}
...
malloc(uint nbytes)
{
 ...
 860:	b1a080e7          	jalr	-1254(ra) # 376 <sbrk>
  if(p == (char*)-1)
